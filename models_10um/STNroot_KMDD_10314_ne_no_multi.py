...
sectionList = [h.Section() for i in range(1937)]
...
sectionList[909].connect(sectionList[502](1),0)
...
sectionList[1163].connect(sectionList[1160](1),0)
...
sectionList[1224].connect(sectionList[1162](1),0)
...
sectionList[1233].connect(sectionList[1162](1),0)
...
sectionList[1419].connect(sectionList[1255](1),0)
...
sectionList[1473].connect(sectionList[1447](1),0)
...
sectionList[1510].connect(sectionList[1472](1),0)
...
sectionList[1533].connect(sectionList[1472](1),0)
...
sectionList[1544].connect(sectionList[1532](1),0)
...
sectionList[1636].connect(sectionList[1532](1),0)
...
sectionList[1693].connect(sectionList[1543](1),0)
...
sectionList[1730].connect(sectionList[1543](1),0)
...
sectionList[1741].connect(sectionList[1692](1),0)
...
sectionList[1766].connect(sectionList[1692](1),0)

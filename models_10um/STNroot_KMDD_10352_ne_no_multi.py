...
sectionList = [h.Section() for i in range(1843)]
...
sectionList[1054].connect(sectionList[658](1),0)
...
sectionList[1313].connect(sectionList[1310](1),0)
...
sectionList[1368].connect(sectionList[1312](1),0)
sectionList[1369].connect(sectionList[1368](1),0)
sectionList[1370].connect(sectionList[1312](1),0)
...
sectionList[1385].connect(sectionList[1369](1),0)
...
sectionList[1430].connect(sectionList[1369](1),0)
...
sectionList[1463].connect(sectionList[1460](1),0)
...
sectionList[1470].connect(sectionList[1462](1),0)
sectionList[1471].connect(sectionList[1470](1),0)
sectionList[1472].connect(sectionList[1462](1),0)
...
sectionList[1487].connect(sectionList[1471](1),0)
...
sectionList[1540].connect(sectionList[1486](1),0)
sectionList[1541].connect(sectionList[1540](1),0)
sectionList[1542].connect(sectionList[1486](1),0)
...
sectionList[1587].connect(sectionList[1541](1),0)
...
sectionList[1640].connect(sectionList[1541](1),0)

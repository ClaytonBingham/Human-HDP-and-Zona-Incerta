...
sectionList = [h.Section() for i in range(2051)]
...
sectionList[970].connect(sectionList[538](1),0)
...
sectionList[1107].connect(sectionList[1077](1),0)
...
sectionList[1114].connect(sectionList[1106](1),0)
...
sectionList[1263].connect(sectionList[1106](1),0)
...
sectionList[1286].connect(sectionList[1272](1),0)
...
sectionList[1298].connect(sectionList[1285](1),0)
sectionList[1299].connect(sectionList[1298](1),0)
sectionList[1300].connect(sectionList[1285](1),0)
...
sectionList[1355].connect(sectionList[1299](1),0)
...
sectionList[1370].connect(sectionList[1299](1),0)
...
sectionList[1417].connect(sectionList[1354](1),0)
...
sectionList[1726].connect(sectionList[1354](1),0)
...
sectionList[1909].connect(sectionList[1416](1),0)
...
sectionList[1976].connect(sectionList[1416](1),0)
...
sectionList[2000].connect(sectionList[1984](1),0)
...
sectionList[2009].connect(sectionList[1999](1),0)
...
sectionList[2044].connect(sectionList[1999](1),0)

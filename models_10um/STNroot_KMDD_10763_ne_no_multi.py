...
sectionList = [h.Section() for i in range(1799)]
...
sectionList[976].connect(sectionList[580](1),0)
...
sectionList[1127].connect(sectionList[1124](1),0)
...
sectionList[1170].connect(sectionList[1126](1),0)
...
sectionList[1213].connect(sectionList[1126](1),0)
...
sectionList[1232].connect(sectionList[1212](1),0)
sectionList[1233].connect(sectionList[1232](1),0)
sectionList[1234].connect(sectionList[1212](1),0)
...
sectionList[1267].connect(sectionList[1233](1),0)
...
sectionList[1286].connect(sectionList[1233](1),0)
...
sectionList[1349].connect(sectionList[1231](1),0)
...
sectionList[1376].connect(sectionList[1231](1),0)
...
sectionList[1383].connect(sectionList[1285](1),0)
...
sectionList[1428].connect(sectionList[1285](1),0)
...
sectionList[1436].connect(sectionList[1382](1),0)
...
sectionList[1455].connect(sectionList[1382](1),0)
...
sectionList[1470].connect(sectionList[1435](1),0)
...
sectionList[1512].connect(sectionList[1435](1),0)
...
sectionList[1557].connect(sectionList[1469](1),0)
...
sectionList[1570].connect(sectionList[1469](1),0)
...
sectionList[1624].connect(sectionList[1588](1),0)
...
sectionList[1682].connect(sectionList[1638](1),0)
...
sectionList[1735].connect(sectionList[1697](1),0)

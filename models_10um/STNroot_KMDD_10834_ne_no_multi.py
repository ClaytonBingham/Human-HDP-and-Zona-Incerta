...
sectionList = [h.Section() for i in range(1696)]
...
sectionList[963].connect(sectionList[543](1),0)
...
sectionList[1045].connect(sectionList[1042](1),0)
...
sectionList[1176].connect(sectionList[1044](1),0)
...
sectionList[1199].connect(sectionList[1044](1),0)
...
sectionList[1224].connect(sectionList[1221](1),0)
...
sectionList[1259].connect(sectionList[1223](1),0)
sectionList[1260].connect(sectionList[1259](1),0)
sectionList[1261].connect(sectionList[1223](1),0)
...
sectionList[1280].connect(sectionList[1260](1),0)
...
sectionList[1300].connect(sectionList[1260](1),0)
...
sectionList[1325].connect(sectionList[1258](1),0)
sectionList[1326].connect(sectionList[1325](1),0)
sectionList[1327].connect(sectionList[1258](1),0)
...
sectionList[1586].connect(sectionList[1326](1),0)
sectionList[1587].connect(sectionList[1586](1),0)
sectionList[1588].connect(sectionList[1326](1),0)
...
sectionList[1599].connect(sectionList[1587](1),0)
...
sectionList[1632].connect(sectionList[1587](1),0)
...
sectionList[1680].connect(sectionList[1670](1),0)
...
sectionList[1687].connect(sectionList[1670](1),0)

...
sectionList = [h.Section() for i in range(2028)]
...
sectionList[947].connect(sectionList[508](1),0)
...
sectionList[1167].connect(sectionList[1164](1),0)
...
sectionList[1212].connect(sectionList[1166](1),0)
sectionList[1213].connect(sectionList[1212](1),0)
sectionList[1214].connect(sectionList[1166](1),0)
...
sectionList[1265].connect(sectionList[1213](1),0)
sectionList[1266].connect(sectionList[1265](1),0)
sectionList[1267].connect(sectionList[1213](1),0)
...
sectionList[1326].connect(sectionList[1266](1),0)
sectionList[1327].connect(sectionList[1326](1),0)
sectionList[1328].connect(sectionList[1266](1),0)
...
sectionList[1397].connect(sectionList[1327](1),0)
...
sectionList[1544].connect(sectionList[1327](1),0)
...
sectionList[1590].connect(sectionList[1396](1),0)
...
sectionList[1615].connect(sectionList[1396](1),0)
...
sectionList[1632].connect(sectionList[1589](1),0)
...
sectionList[1725].connect(sectionList[1589](1),0)
...
sectionList[1760].connect(sectionList[1631](1),0)
...
sectionList[1865].connect(sectionList[1631](1),0)

...
sectionList = [h.Section() for i in range(1831)]
...
sectionList[1036].connect(sectionList[616](1),0)
...
sectionList[1390].connect(sectionList[1086](1),0)
...
sectionList[1520].connect(sectionList[1414](1),0)
...
sectionList[1642].connect(sectionList[1556](1),0)

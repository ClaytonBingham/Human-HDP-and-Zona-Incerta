...
sectionList = [h.Section() for i in range(2186)]
...
sectionList[988].connect(sectionList[556](1),0)
...
sectionList[1657].connect(sectionList[1381](1),0)
...
sectionList[1961].connect(sectionList[1667](1),0)

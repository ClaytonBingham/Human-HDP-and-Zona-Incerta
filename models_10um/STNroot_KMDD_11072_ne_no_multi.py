...
sectionList = [h.Section() for i in range(2004)]
...
sectionList[952].connect(sectionList[520](1),0)
...
sectionList[1438].connect(sectionList[1080](1),0)
...
sectionList[1465].connect(sectionList[1455](1),0)
sectionList[1466].connect(sectionList[1465](1),0)
sectionList[1467].connect(sectionList[1455](1),0)
...
sectionList[1482].connect(sectionList[1466](1),0)
sectionList[1483].connect(sectionList[1482](1),0)
sectionList[1484].connect(sectionList[1466](1),0)
...
sectionList[1493].connect(sectionList[1483](1),0)
sectionList[1494].connect(sectionList[1493](1),0)
sectionList[1495].connect(sectionList[1483](1),0)
...
sectionList[1506].connect(sectionList[1494](1),0)
sectionList[1507].connect(sectionList[1506](1),0)
sectionList[1508].connect(sectionList[1494](1),0)
...
sectionList[1523].connect(sectionList[1507](1),0)
sectionList[1524].connect(sectionList[1523](1),0)
sectionList[1525].connect(sectionList[1507](1),0)
...
sectionList[1544].connect(sectionList[1524](1),0)
...
sectionList[1759].connect(sectionList[1575](1),0)
...
sectionList[1977].connect(sectionList[1789](1),0)

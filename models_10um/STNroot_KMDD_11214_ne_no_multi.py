...
sectionList = [h.Section() for i in range(2274)]
...
sectionList[904].connect(sectionList[502](1),0)
...
sectionList[1185].connect(sectionList[1182](1),0)
...
sectionList[1567].connect(sectionList[1184](1),0)
...
sectionList[1692].connect(sectionList[1184](1),0)
...
sectionList[1770].connect(sectionList[1691](1),0)
...
sectionList[2189].connect(sectionList[1691](1),0)

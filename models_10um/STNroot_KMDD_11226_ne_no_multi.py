...
sectionList = [h.Section() for i in range(2249)]
...
sectionList[946].connect(sectionList[544](1),0)
...
sectionList[1252].connect(sectionList[1080](1),0)
...
sectionList[1520].connect(sectionList[1334](1),0)
...
sectionList[1571].connect(sectionList[1568](1),0)
...
sectionList[1782].connect(sectionList[1570](1),0)
sectionList[1783].connect(sectionList[1782](1),0)
sectionList[1784].connect(sectionList[1570](1),0)
...
sectionList[1792].connect(sectionList[1783](1),0)
...
sectionList[2079].connect(sectionList[1783](1),0)

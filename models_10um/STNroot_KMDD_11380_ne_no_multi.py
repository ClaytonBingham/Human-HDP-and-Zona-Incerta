...
sectionList = [h.Section() for i in range(2246)]
...
sectionList[439].connect(sectionList[436](1),0)
...
sectionList[870].connect(sectionList[438](1),0)
...
sectionList[1167].connect(sectionList[438](1),0)
...
sectionList[1602].connect(sectionList[1595](1),0)
...
sectionList[1629].connect(sectionList[1601](1),0)
...
sectionList[1714].connect(sectionList[1601](1),0)
...
sectionList[1842].connect(sectionList[1628](1),0)
...
sectionList[1893].connect(sectionList[1628](1),0)
...
sectionList[1926].connect(sectionList[1841](1),0)
...
sectionList[1969].connect(sectionList[1841](1),0)
...
sectionList[2014].connect(sectionList[1968](1),0)
...
sectionList[2041].connect(sectionList[1968](1),0)
...
sectionList[2223].connect(sectionList[2081](1),0)

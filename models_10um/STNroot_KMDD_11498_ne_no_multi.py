...
sectionList = [h.Section() for i in range(1988)]
...
sectionList[922].connect(sectionList[502](1),0)
...
sectionList[959].connect(sectionList[956](1),0)
...
sectionList[1487].connect(sectionList[1476](1),0)
sectionList[1488].connect(sectionList[1487](1),0)
sectionList[1489].connect(sectionList[1476](1),0)
...
sectionList[1500].connect(sectionList[1488](1),0)
...
sectionList[1539].connect(sectionList[1488](1),0)
...
sectionList[1585].connect(sectionList[1582](1),0)
...
sectionList[1778].connect(sectionList[1584](1),0)
sectionList[1779].connect(sectionList[1778](1),0)
sectionList[1780].connect(sectionList[1584](1),0)
...
sectionList[1809].connect(sectionList[1779](1),0)
...
sectionList[1830].connect(sectionList[1779](1),0)
...
sectionList[1876].connect(sectionList[1850](1),0)
...
sectionList[1923].connect(sectionList[1850](1),0)

...
sectionList = [h.Section() for i in range(1909)]
...
sectionList[535].connect(sectionList[532](1),0)
...
sectionList[960].connect(sectionList[534](1),0)
...
sectionList[1015].connect(sectionList[534](1),0)
...
sectionList[1116].connect(sectionList[1014](1),0)
...
sectionList[1374].connect(sectionList[1014](1),0)

...
sectionList = [h.Section() for i in range(1868)]
...
sectionList[935].connect(sectionList[509](1),0)
...
sectionList[1122].connect(sectionList[1119](1),0)
...
sectionList[1205].connect(sectionList[1121](1),0)
...
sectionList[1231].connect(sectionList[1121](1),0)
...
sectionList[1252].connect(sectionList[1230](1),0)
sectionList[1253].connect(sectionList[1252](1),0)
sectionList[1254].connect(sectionList[1230](1),0)
...
sectionList[1287].connect(sectionList[1253](1),0)
sectionList[1288].connect(sectionList[1287](1),0)
sectionList[1289].connect(sectionList[1253](1),0)
...
sectionList[1304].connect(sectionList[1288](1),0)
...
sectionList[1377].connect(sectionList[1288](1),0)
...
sectionList[1388].connect(sectionList[1251](1),0)
...
sectionList[1419].connect(sectionList[1251](1),0)
...
sectionList[1456].connect(sectionList[1303](1),0)
...
sectionList[1475].connect(sectionList[1303](1),0)
...
sectionList[1490].connect(sectionList[1387](1),0)
...
sectionList[1676].connect(sectionList[1387](1),0)

...
sectionList = [h.Section() for i in range(1947)]
...
sectionList[1064].connect(sectionList[632](1),0)
...
sectionList[1119].connect(sectionList[1116](1),0)
...
sectionList[1360].connect(sectionList[1118](1),0)
sectionList[1361].connect(sectionList[1360](1),0)
sectionList[1362].connect(sectionList[1118](1),0)
...
sectionList[1376].connect(sectionList[1361](1),0)
sectionList[1377].connect(sectionList[1376](1),0)
sectionList[1378].connect(sectionList[1361](1),0)
...
sectionList[1409].connect(sectionList[1377](1),0)
sectionList[1410].connect(sectionList[1409](1),0)
sectionList[1411].connect(sectionList[1377](1),0)
...
sectionList[1436].connect(sectionList[1410](1),0)
sectionList[1437].connect(sectionList[1436](1),0)
sectionList[1438].connect(sectionList[1410](1),0)
...
sectionList[1465].connect(sectionList[1437](1),0)
sectionList[1466].connect(sectionList[1465](1),0)
sectionList[1467].connect(sectionList[1437](1),0)
...
sectionList[1496].connect(sectionList[1466](1),0)
...
sectionList[1527].connect(sectionList[1497](1),0)
sectionList[1528].connect(sectionList[1527](1),0)
sectionList[1529].connect(sectionList[1497](1),0)
...
sectionList[1558].connect(sectionList[1528](1),0)
sectionList[1559].connect(sectionList[1558](1),0)
sectionList[1560].connect(sectionList[1528](1),0)
...
sectionList[1590].connect(sectionList[1559](1),0)
sectionList[1591].connect(sectionList[1590](1),0)
sectionList[1592].connect(sectionList[1559](1),0)
...
sectionList[1625].connect(sectionList[1591](1),0)
...
sectionList[1658].connect(sectionList[1591](1),0)

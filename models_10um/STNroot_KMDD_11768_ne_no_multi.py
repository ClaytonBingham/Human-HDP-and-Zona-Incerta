...
sectionList = [h.Section() for i in range(1772)]
...
sectionList[886].connect(sectionList[454](1),0)
...
sectionList[1138].connect(sectionList[1126](1),0)
sectionList[1139].connect(sectionList[1138](1),0)
sectionList[1140].connect(sectionList[1126](1),0)
...
sectionList[1155].connect(sectionList[1139](1),0)
...
sectionList[1168].connect(sectionList[1139](1),0)
...
sectionList[1175].connect(sectionList[1172](1),0)
...
sectionList[1180].connect(sectionList[1174](1),0)
...
sectionList[1185].connect(sectionList[1174](1),0)
...
sectionList[1200].connect(sectionList[1179](1),0)
...
sectionList[1237].connect(sectionList[1179](1),0)
...
sectionList[1300].connect(sectionList[1184](1),0)
sectionList[1301].connect(sectionList[1300](1),0)
sectionList[1302].connect(sectionList[1184](1),0)
...
sectionList[1355].connect(sectionList[1301](1),0)
sectionList[1356].connect(sectionList[1355](1),0)
sectionList[1357].connect(sectionList[1301](1),0)
...
sectionList[1372].connect(sectionList[1356](1),0)
sectionList[1373].connect(sectionList[1372](1),0)
sectionList[1374].connect(sectionList[1356](1),0)
...
sectionList[1407].connect(sectionList[1373](1),0)
...
sectionList[1494].connect(sectionList[1373](1),0)
...
sectionList[1575].connect(sectionList[1406](1),0)
...
sectionList[1727].connect(sectionList[1406](1),0)

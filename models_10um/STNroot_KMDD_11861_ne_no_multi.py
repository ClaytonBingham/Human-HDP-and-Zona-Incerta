...
sectionList = [h.Section() for i in range(2243)]
...
sectionList[994].connect(sectionList[592](1),0)
...
sectionList[1037].connect(sectionList[1034](1),0)
...
sectionList[1548].connect(sectionList[1036](1),0)
...
sectionList[1569].connect(sectionList[1036](1),0)
...
sectionList[1719].connect(sectionList[1583](1),0)
...
sectionList[1732].connect(sectionList[1729](1),0)
...
sectionList[1881].connect(sectionList[1731](1),0)
sectionList[1882].connect(sectionList[1881](1),0)
sectionList[1883].connect(sectionList[1731](1),0)
...
sectionList[1904].connect(sectionList[1882](1),0)
...
sectionList[1929].connect(sectionList[1882](1),0)
...
sectionList[2030].connect(sectionList[2006](1),0)

...
sectionList = [h.Section() for i in range(1655)]
...
sectionList[982].connect(sectionList[586](1),0)
...
sectionList[1046].connect(sectionList[1043](1),0)
...
sectionList[1081].connect(sectionList[1045](1),0)
...
sectionList[1097].connect(sectionList[1045](1),0)
...
sectionList[1126].connect(sectionList[1080](1),0)
...
sectionList[1177].connect(sectionList[1080](1),0)
...
sectionList[1280].connect(sectionList[1277](1),0)
...
sectionList[1330].connect(sectionList[1279](1),0)
sectionList[1331].connect(sectionList[1330](1),0)
sectionList[1332].connect(sectionList[1279](1),0)
...
sectionList[1345].connect(sectionList[1331](1),0)
...
sectionList[1366].connect(sectionList[1331](1),0)
...
sectionList[1486].connect(sectionList[1384](1),0)
...
sectionList[1522].connect(sectionList[1490](1),0)

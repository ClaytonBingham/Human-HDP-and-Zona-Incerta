...
sectionList = [h.Section() for i in range(2286)]
...
sectionList[469].connect(sectionList[466](1),0)
...
sectionList[871].connect(sectionList[468](1),0)
sectionList[872].connect(sectionList[871](1),0)
sectionList[873].connect(sectionList[468](1),0)
...
sectionList[1050].connect(sectionList[872](1),0)
...
sectionList[1235].connect(sectionList[872](1),0)
...
sectionList[1745].connect(sectionList[1423](1),0)
...
sectionList[1815].connect(sectionList[1787](1),0)
...
sectionList[2215].connect(sectionList[1851](1),0)

...
sectionList = [h.Section() for i in range(1777)]
...
sectionList[946].connect(sectionList[532](1),0)
...
sectionList[1115].connect(sectionList[1112](1),0)
...
sectionList[1262].connect(sectionList[1114](1),0)
sectionList[1263].connect(sectionList[1262](1),0)
sectionList[1264].connect(sectionList[1114](1),0)
...
sectionList[1343].connect(sectionList[1263](1),0)
sectionList[1344].connect(sectionList[1343](1),0)
sectionList[1345].connect(sectionList[1263](1),0)
...
sectionList[1404].connect(sectionList[1344](1),0)
...
sectionList[1445].connect(sectionList[1344](1),0)
...
sectionList[1501].connect(sectionList[1444](1),0)
sectionList[1502].connect(sectionList[1501](1),0)
sectionList[1503].connect(sectionList[1444](1),0)
...
sectionList[1520].connect(sectionList[1502](1),0)
sectionList[1521].connect(sectionList[1520](1),0)
sectionList[1522].connect(sectionList[1502](1),0)
...
sectionList[1536].connect(sectionList[1521](1),0)
...
sectionList[1557].connect(sectionList[1521](1),0)

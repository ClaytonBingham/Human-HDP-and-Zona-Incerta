...
sectionList = [h.Section() for i in range(2046)]
...
sectionList[1018].connect(sectionList[634](1),0)
...
sectionList[1116].connect(sectionList[1048](1),0)
...
sectionList[1186].connect(sectionList[1115](1),0)
...
sectionList[1195].connect(sectionList[1115](1),0)
...
sectionList[1208].connect(sectionList[1185](1),0)
...
sectionList[1546].connect(sectionList[1185](1),0)
...
sectionList[1901].connect(sectionList[1194](1),0)
...
sectionList[2036].connect(sectionList[1194](1),0)

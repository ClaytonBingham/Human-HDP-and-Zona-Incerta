...
sectionList = [h.Section() for i in range(1915)]
...
sectionList[536].connect(sectionList[533](1),0)
...
sectionList[949].connect(sectionList[535](1),0)
...
sectionList[1128].connect(sectionList[535](1),0)
...
sectionList[1371].connect(sectionList[1127](1),0)
...
sectionList[1386].connect(sectionList[1127](1),0)
...
sectionList[1708].connect(sectionList[1402](1),0)

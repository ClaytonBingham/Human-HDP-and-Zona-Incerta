...
sectionList = [h.Section() for i in range(2183)]
...
sectionList[1078].connect(sectionList[652](1),0)
...
sectionList[1270].connect(sectionList[1258](1),0)
...
sectionList[1281].connect(sectionList[1269](1),0)
...
sectionList[1664].connect(sectionList[1269](1),0)
...
sectionList[1689].connect(sectionList[1280](1),0)
...
sectionList[1782].connect(sectionList[1280](1),0)
...
sectionList[1820].connect(sectionList[1788](1),0)
...
sectionList[1833].connect(sectionList[1819](1),0)
...
sectionList[1898].connect(sectionList[1819](1),0)
sectionList[1899].connect(sectionList[1898](1),0)
sectionList[1900].connect(sectionList[1899](1),0)
sectionList[1901].connect(sectionList[1832](1),0)
sectionList[1902].connect(sectionList[1901](1),0)
sectionList[1903].connect(sectionList[1832](1),0)
...
sectionList[1916].connect(sectionList[1902](1),0)
sectionList[1917].connect(sectionList[1916](1),0)
sectionList[1918].connect(sectionList[1902](1),0)
...
sectionList[1929].connect(sectionList[1917](1),0)
...
sectionList[1940].connect(sectionList[1917](1),0)
...
sectionList[1956].connect(sectionList[1900](1),0)
...
sectionList[1995].connect(sectionList[1900](1),0)
...
sectionList[2042].connect(sectionList[1994](1),0)
...
sectionList[2055].connect(sectionList[1994](1),0)
...
sectionList[2128].connect(sectionList[2086](1),0)

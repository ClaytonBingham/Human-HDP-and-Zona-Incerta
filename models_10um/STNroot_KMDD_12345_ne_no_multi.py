...
sectionList = [h.Section() for i in range(1742)]
...
sectionList[941].connect(sectionList[514](1),0)
...
sectionList[1221].connect(sectionList[1067](1),0)
...
sectionList[1256].connect(sectionList[1253](1),0)
...
sectionList[1273].connect(sectionList[1255](1),0)
...
sectionList[1286].connect(sectionList[1255](1),0)
...
sectionList[1303].connect(sectionList[1272](1),0)
sectionList[1304].connect(sectionList[1303](1),0)
sectionList[1305].connect(sectionList[1272](1),0)
...
sectionList[1312].connect(sectionList[1304](1),0)
...
sectionList[1324].connect(sectionList[1304](1),0)
...
sectionList[1333].connect(sectionList[1323](1),0)
...
sectionList[1446].connect(sectionList[1323](1),0)
...
sectionList[1464].connect(sectionList[1461](1),0)
...
sectionList[1569].connect(sectionList[1463](1),0)
...
sectionList[1578].connect(sectionList[1463](1),0)
...
sectionList[1703].connect(sectionList[1588](1),0)

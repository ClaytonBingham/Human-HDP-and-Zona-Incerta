...
sectionList[951].connect(sectionList[537](1),0)
...
sectionList[1031].connect(sectionList[1028](1),0)
...
sectionList[1236].connect(sectionList[1030](1),0)
sectionList[1237].connect(sectionList[1236](1),0)
sectionList[1238].connect(sectionList[1030](1),0)
...
sectionList[1265].connect(sectionList[1237](1),0)
sectionList[1266].connect(sectionList[1265](1),0)
sectionList[1267].connect(sectionList[1237](1),0)
...
sectionList[1294].connect(sectionList[1266](1),0)
...
sectionList[1329].connect(sectionList[1266](1),0)
...
sectionList[1356].connect(sectionList[1353](1),0)
...
sectionList[1377].connect(sectionList[1355](1),0)
sectionList[1378].connect(sectionList[1377](1),0)
sectionList[1379].connect(sectionList[1355](1),0)
...
sectionList[1389].connect(sectionList[1378](1),0)
sectionList[1390].connect(sectionList[1389](1),0)
sectionList[1391].connect(sectionList[1378](1),0)
...
sectionList[1402].connect(sectionList[1390](1),0)
sectionList[1403].connect(sectionList[1402](1),0)
sectionList[1404].connect(sectionList[1390](1),0)
...
sectionList[1411].connect(sectionList[1403](1),0)
sectionList[1412].connect(sectionList[1411](1),0)
sectionList[1413].connect(sectionList[1403](1),0)
...
sectionList[1444].connect(sectionList[1412](1),0)
...
sectionList[1721].connect(sectionList[1412](1),0)

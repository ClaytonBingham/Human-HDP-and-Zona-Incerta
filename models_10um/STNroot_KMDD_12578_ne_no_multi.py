...
sectionList = [h.Section() for i in range(2501)]
...
sectionList[1038].connect(sectionList[618](1),0)
sectionList[1039].connect(sectionList[1038](1),0)
sectionList[1040].connect(sectionList[618](1),0)
...
sectionList[1199].connect(sectionList[1039](1),0)
sectionList[1200].connect(sectionList[1199](1),0)
sectionList[1201].connect(sectionList[1039](1),0)
...
sectionList[1361].connect(sectionList[1200](1),0)
sectionList[1362].connect(sectionList[1361](1),0)
sectionList[1363].connect(sectionList[1200](1),0)
...
sectionList[1524].connect(sectionList[1362](1),0)
...
sectionList[1685].connect(sectionList[1362](1),0)
...
sectionList[1850].connect(sectionList[1684](1),0)
sectionList[1851].connect(sectionList[1850](1),0)
sectionList[1852].connect(sectionList[1684](1),0)
...
sectionList[1873].connect(sectionList[1851](1),0)
...
sectionList[1938].connect(sectionList[1851](1),0)
...
sectionList[1953].connect(sectionList[1937](1),0)
sectionList[1954].connect(sectionList[1953](1),0)
sectionList[1955].connect(sectionList[1937](1),0)
...
sectionList[1972].connect(sectionList[1954](1),0)
...
sectionList[2001].connect(sectionList[1954](1),0)
...
sectionList[2029].connect(sectionList[2000](1),0)
...
sectionList[2060].connect(sectionList[2000](1),0)
...
sectionList[2074].connect(sectionList[2068](1),0)
...
sectionList[2089].connect(sectionList[2086](1),0)
...
sectionList[2328].connect(sectionList[2088](1),0)
sectionList[2329].connect(sectionList[2328](1),0)
sectionList[2330].connect(sectionList[2088](1),0)
...
sectionList[2355].connect(sectionList[2329](1),0)
sectionList[2356].connect(sectionList[2355](1),0)
sectionList[2357].connect(sectionList[2329](1),0)
...
sectionList[2391].connect(sectionList[2356](1),0)
...
sectionList[2432].connect(sectionList[2356](1),0)

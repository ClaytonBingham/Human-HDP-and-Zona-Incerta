...
sectionList = [h.Section() for i in range(1995)]
...
sectionList[952].connect(sectionList[538](1),0)
...
sectionList[1143].connect(sectionList[1140](1),0)
...
sectionList[1168].connect(sectionList[1142](1),0)
sectionList[1169].connect(sectionList[1168](1),0)
sectionList[1170].connect(sectionList[1142](1),0)
...
sectionList[1190].connect(sectionList[1169](1),0)
sectionList[1191].connect(sectionList[1190](1),0)
sectionList[1192].connect(sectionList[1169](1),0)
...
sectionList[1217].connect(sectionList[1191](1),0)
sectionList[1218].connect(sectionList[1217](1),0)
sectionList[1219].connect(sectionList[1191](1),0)
...
sectionList[1244].connect(sectionList[1218](1),0)
sectionList[1245].connect(sectionList[1244](1),0)
sectionList[1246].connect(sectionList[1218](1),0)
...
sectionList[1273].connect(sectionList[1245](1),0)
...
sectionList[1303].connect(sectionList[1274](1),0)
sectionList[1304].connect(sectionList[1303](1),0)
sectionList[1305].connect(sectionList[1274](1),0)
...
sectionList[1334].connect(sectionList[1304](1),0)
sectionList[1335].connect(sectionList[1334](1),0)
sectionList[1336].connect(sectionList[1304](1),0)
...
sectionList[1364].connect(sectionList[1335](1),0)
...
sectionList[1397].connect(sectionList[1335](1),0)
...
sectionList[1475].connect(sectionList[1472](1),0)
...
sectionList[1500].connect(sectionList[1474](1),0)
sectionList[1501].connect(sectionList[1500](1),0)
sectionList[1502].connect(sectionList[1474](1),0)
...
sectionList[1517].connect(sectionList[1501](1),0)
sectionList[1518].connect(sectionList[1517](1),0)
sectionList[1519].connect(sectionList[1501](1),0)
...
sectionList[1534].connect(sectionList[1518](1),0)
sectionList[1535].connect(sectionList[1534](1),0)
sectionList[1536].connect(sectionList[1518](1),0)
...
sectionList[1550].connect(sectionList[1535](1),0)
sectionList[1551].connect(sectionList[1550](1),0)
sectionList[1552].connect(sectionList[1535](1),0)
...
sectionList[1575].connect(sectionList[1551](1),0)
sectionList[1576].connect(sectionList[1575](1),0)
sectionList[1577].connect(sectionList[1551](1),0)
...
sectionList[1626].connect(sectionList[1576](1),0)
sectionList[1627].connect(sectionList[1626](1),0)
sectionList[1628].connect(sectionList[1576](1),0)
...
sectionList[1665].connect(sectionList[1627](1),0)
...
sectionList[1717].connect(sectionList[1627](1),0)
...
sectionList[1768].connect(sectionList[1499](1),0)
sectionList[1769].connect(sectionList[1768](1),0)
sectionList[1770].connect(sectionList[1499](1),0)
...
sectionList[1779].connect(sectionList[1769](1),0)
sectionList[1780].connect(sectionList[1779](1),0)
sectionList[1781].connect(sectionList[1769](1),0)
...
sectionList[1793].connect(sectionList[1780](1),0)
...
sectionList[1812].connect(sectionList[1780](1),0)
...
sectionList[1827].connect(sectionList[1792](1),0)
sectionList[1828].connect(sectionList[1827](1),0)
sectionList[1829].connect(sectionList[1792](1),0)
...
sectionList[1842].connect(sectionList[1828](1),0)
...
sectionList[1846].connect(sectionList[1828](1),0)
...
sectionList[1851].connect(sectionList[1848](1),0)
...
sectionList[1894].connect(sectionList[1850](1),0)
sectionList[1895].connect(sectionList[1894](1),0)
sectionList[1896].connect(sectionList[1850](1),0)
...
sectionList[1935].connect(sectionList[1895](1),0)
...
sectionList[1964].connect(sectionList[1895](1),0)

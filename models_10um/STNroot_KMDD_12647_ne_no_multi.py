...
sectionList = [h.Section() for i in range(1902)]
...
sectionList[965].connect(sectionList[556](1),0)
...
sectionList[1085].connect(sectionList[1082](1),0)
...
sectionList[1122].connect(sectionList[1084](1),0)
...
sectionList[1139].connect(sectionList[1084](1),0)
...
sectionList[1154].connect(sectionList[1151](1),0)
...
sectionList[1171].connect(sectionList[1153](1),0)
...
sectionList[1268].connect(sectionList[1153](1),0)
...
sectionList[1335].connect(sectionList[1267](1),0)
...
sectionList[1396].connect(sectionList[1267](1),0)
...
sectionList[1468].connect(sectionList[1436](1),0)
...
sectionList[1541].connect(sectionList[1495](1),0)
...
sectionList[1658].connect(sectionList[1540](1),0)
...
sectionList[1869].connect(sectionList[1540](1),0)

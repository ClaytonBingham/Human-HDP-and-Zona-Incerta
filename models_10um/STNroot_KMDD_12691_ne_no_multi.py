...
sectionList = [h.Section() for i in range(1907)]
...
sectionList[946].connect(sectionList[514](1),0)
...
sectionList[1178].connect(sectionList[1175](1),0)
...
sectionList[1199].connect(sectionList[1177](1),0)
...
sectionList[1243].connect(sectionList[1177](1),0)
...
sectionList[1268].connect(sectionList[1198](1),0)
...
sectionList[1502].connect(sectionList[1198](1),0)
...
sectionList[1705].connect(sectionList[1267](1),0)
sectionList[1706].connect(sectionList[1705](1),0)
sectionList[1707].connect(sectionList[1267](1),0)
...
sectionList[1811].connect(sectionList[1706](1),0)
...
sectionList[1848].connect(sectionList[1706](1),0)

...
sectionList = [h.Section() for i in range(1975)]
...
sectionList[445].connect(sectionList[442](1),0)
...
sectionList[846].connect(sectionList[444](1),0)
sectionList[847].connect(sectionList[846](1),0)
sectionList[848].connect(sectionList[444](1),0)
...
sectionList[973].connect(sectionList[847](1),0)
sectionList[974].connect(sectionList[973](1),0)
sectionList[975].connect(sectionList[847](1),0)
...
sectionList[1256].connect(sectionList[974](1),0)
...
sectionList[1523].connect(sectionList[974](1),0)

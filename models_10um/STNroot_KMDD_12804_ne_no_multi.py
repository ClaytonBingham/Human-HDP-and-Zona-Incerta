...
sectionList = [h.Section() for i in range(1787)]
...
sectionList[964].connect(sectionList[574](1),0)
...
sectionList[1388].connect(sectionList[1092](1),0)
...
sectionList[1421].connect(sectionList[1092](1),0)
...
sectionList[1450].connect(sectionList[1420](1),0)
sectionList[1451].connect(sectionList[1450](1),0)
sectionList[1452].connect(sectionList[1420](1),0)
...
sectionList[1477].connect(sectionList[1451](1),0)
...
sectionList[1492].connect(sectionList[1451](1),0)
...
sectionList[1519].connect(sectionList[1449](1),0)
...
sectionList[1556].connect(sectionList[1449](1),0)
...
sectionList[1601].connect(sectionList[1476](1),0)
...
sectionList[1610].connect(sectionList[1476](1),0)
...
sectionList[1617].connect(sectionList[1491](1),0)
sectionList[1618].connect(sectionList[1617](1),0)
sectionList[1619].connect(sectionList[1491](1),0)
...
sectionList[1684].connect(sectionList[1618](1),0)
sectionList[1685].connect(sectionList[1684](1),0)
sectionList[1686].connect(sectionList[1618](1),0)
...
sectionList[1694].connect(sectionList[1685](1),0)
...
sectionList[1723].connect(sectionList[1685](1),0)
...
sectionList[1762].connect(sectionList[1609](1),0)
...
sectionList[1773].connect(sectionList[1609](1),0)

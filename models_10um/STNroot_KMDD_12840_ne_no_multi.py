...
sectionList = [h.Section() for i in range(1733)]
...
sectionList[1420].connect(sectionList[1134](1),0)
...
sectionList[1443].connect(sectionList[1440](1),0)
...
sectionList[1488].connect(sectionList[1442](1),0)
...
sectionList[1503].connect(sectionList[1442](1),0)
...
sectionList[1516].connect(sectionList[1487](1),0)
sectionList[1517].connect(sectionList[1516](1),0)
sectionList[1518].connect(sectionList[1487](1),0)
...
sectionList[1553].connect(sectionList[1517](1),0)
...
sectionList[1662].connect(sectionList[1517](1),0)

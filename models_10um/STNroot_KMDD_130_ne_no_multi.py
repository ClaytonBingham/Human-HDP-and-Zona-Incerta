...
sectionList = [h.Section() for i in range(2800)]
...
sectionList[529].connect(sectionList[526](1),0)
...
sectionList[936].connect(sectionList[528](1),0)
sectionList[937].connect(sectionList[936](1),0)
sectionList[938].connect(sectionList[528](1),0)
...
sectionList[1257].connect(sectionList[937](1),0)
...
sectionList[1576].connect(sectionList[937](1),0)
...
sectionList[2106].connect(sectionList[1908](1),0)
...
sectionList[2302].connect(sectionList[2128](1),0)
...
sectionList[2345].connect(sectionList[2308](1),0)
...
sectionList[2453].connect(sectionList[2403](1),0)
...
sectionList[2482].connect(sectionList[2452](1),0)
...
sectionList[2515].connect(sectionList[2452](1),0)
...
sectionList[2583].connect(sectionList[2545](1),0)
...
sectionList[2671].connect(sectionList[2635](1),0)

...
sectionList = [h.Section() for i in range(1854)]
...
sectionList[862].connect(sectionList[442](1),0)
...
sectionList[1072].connect(sectionList[968](1),0)
...
sectionList[1111].connect(sectionList[1108](1),0)
...
sectionList[1126].connect(sectionList[1110](1),0)
sectionList[1127].connect(sectionList[1126](1),0)
sectionList[1128].connect(sectionList[1110](1),0)
...
sectionList[1150].connect(sectionList[1127](1),0)
sectionList[1151].connect(sectionList[1150](1),0)
sectionList[1152].connect(sectionList[1127](1),0)
...
sectionList[1169].connect(sectionList[1151](1),0)
sectionList[1170].connect(sectionList[1169](1),0)
sectionList[1171].connect(sectionList[1151](1),0)
...
sectionList[1186].connect(sectionList[1170](1),0)
...
sectionList[1203].connect(sectionList[1170](1),0)
...
sectionList[1476].connect(sectionList[1202](1),0)
...
sectionList[1779].connect(sectionList[1202](1),0)
...
sectionList[1837].connect(sectionList[1793](1),0)

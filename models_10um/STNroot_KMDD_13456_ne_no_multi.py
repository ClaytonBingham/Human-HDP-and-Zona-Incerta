...
sectionList = [h.Section() for i in range(1911)]
...
sectionList[892].connect(sectionList[478](1),0)
...
sectionList[1117].connect(sectionList[930](1),0)
sectionList[1118].connect(sectionList[1117](1),0)
sectionList[1119].connect(sectionList[930](1),0)
...
sectionList[1136].connect(sectionList[1118](1),0)
sectionList[1137].connect(sectionList[1136](1),0)
sectionList[1138].connect(sectionList[1118](1),0)
...
sectionList[1143].connect(sectionList[1137](1),0)
sectionList[1144].connect(sectionList[1143](1),0)
sectionList[1145].connect(sectionList[1137](1),0)
...
sectionList[1160].connect(sectionList[1144](1),0)
...
sectionList[1187].connect(sectionList[1144](1),0)
...
sectionList[1210].connect(sectionList[1159](1),0)
sectionList[1211].connect(sectionList[1210](1),0)
sectionList[1212].connect(sectionList[1159](1),0)
...
sectionList[1289].connect(sectionList[1211](1),0)
sectionList[1290].connect(sectionList[1289](1),0)
sectionList[1291].connect(sectionList[1211](1),0)
...
sectionList[1306].connect(sectionList[1290](1),0)
sectionList[1307].connect(sectionList[1306](1),0)
sectionList[1308].connect(sectionList[1290](1),0)
...
sectionList[1336].connect(sectionList[1307](1),0)
sectionList[1337].connect(sectionList[1336](1),0)
sectionList[1338].connect(sectionList[1307](1),0)
...
sectionList[1361].connect(sectionList[1337](1),0)
...
sectionList[1746].connect(sectionList[1337](1),0)

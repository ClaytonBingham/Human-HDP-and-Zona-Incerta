...
sectionList = [h.Section() for i in range(2058)]
...
sectionList[1086].connect(sectionList[690](1),0)
...
sectionList[1259].connect(sectionList[690](1),0)
...
sectionList[1381].connect(sectionList[1285](1),0)
...
sectionList[1398].connect(sectionList[1285](1),0)
...
sectionList[1685].connect(sectionList[1397](1),0)
sectionList[1686].connect(sectionList[1685](1),0)
sectionList[1687].connect(sectionList[1397](1),0)
...
sectionList[1711].connect(sectionList[1686](1),0)
...
sectionList[1756].connect(sectionList[1686](1),0)
...
sectionList[1785].connect(sectionList[1770](1),0)
...
sectionList[1802].connect(sectionList[1784](1),0)
sectionList[1803].connect(sectionList[1802](1),0)
sectionList[1804].connect(sectionList[1784](1),0)
...
sectionList[1843].connect(sectionList[1803](1),0)
sectionList[1844].connect(sectionList[1843](1),0)
sectionList[1845].connect(sectionList[1803](1),0)
...
sectionList[1860].connect(sectionList[1844](1),0)
...
sectionList[1876].connect(sectionList[1844](1),0)
...
sectionList[1948].connect(sectionList[1880](1),0)
...
sectionList[2011].connect(sectionList[1954](1),0)

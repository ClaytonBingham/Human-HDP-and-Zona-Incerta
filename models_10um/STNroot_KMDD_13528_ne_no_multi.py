...
sectionList = [h.Section() for i in range(2367)]
...
sectionList[673].connect(sectionList[670](1),0)
...
sectionList[1074].connect(sectionList[672](1),0)
...
sectionList[1258].connect(sectionList[672](1),0)
...
sectionList[1460].connect(sectionList[1457](1),0)
...
sectionList[1507].connect(sectionList[1459](1),0)
...
sectionList[1533].connect(sectionList[1459](1),0)
...
sectionList[1556].connect(sectionList[1532](1),0)
...
sectionList[1595].connect(sectionList[1532](1),0)
...
sectionList[1600].connect(sectionList[1555](1),0)
...
sectionList[1677].connect(sectionList[1555](1),0)
...
sectionList[1784].connect(sectionList[1594](1),0)
...
sectionList[1821].connect(sectionList[1594](1),0)
...
sectionList[1908].connect(sectionList[1599](1),0)
...
sectionList[1955].connect(sectionList[1599](1),0)
...
sectionList[1986].connect(sectionList[1954](1),0)
...
sectionList[1993].connect(sectionList[1954](1),0)
...
sectionList[2008].connect(sectionList[1992](1),0)
...
sectionList[2021].connect(sectionList[1992](1),0)
...
sectionList[2038].connect(sectionList[2007](1),0)
...
sectionList[2087].connect(sectionList[2007](1),0)
...
sectionList[2155].connect(sectionList[2037](1),0)
sectionList[2156].connect(sectionList[2155](1),0)
sectionList[2157].connect(sectionList[2037](1),0)
...
sectionList[2202].connect(sectionList[2156](1),0)
...
sectionList[2215].connect(sectionList[2201](1),0)
...
sectionList[2230].connect(sectionList[2201](1),0)
...
sectionList[2246].connect(sectionList[2199](1),0)
sectionList[2247].connect(sectionList[2246](1),0)
sectionList[2248].connect(sectionList[2199](1),0)
...
sectionList[2275].connect(sectionList[2247](1),0)
sectionList[2276].connect(sectionList[2275](1),0)
sectionList[2277].connect(sectionList[2247](1),0)
...
sectionList[2290].connect(sectionList[2276](1),0)
...
sectionList[2306].connect(sectionList[2276](1),0)

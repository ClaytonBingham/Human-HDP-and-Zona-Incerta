...
sectionList = [h.Section() for i in range(1837)]
...
sectionList[964].connect(sectionList[544](1),0)
...
sectionList[1163].connect(sectionList[1098](1),0)
...
sectionList[1186].connect(sectionList[1183](1),0)
...
sectionList[1407].connect(sectionList[1185](1),0)
sectionList[1408].connect(sectionList[1407](1),0)
sectionList[1409].connect(sectionList[1185](1),0)
...
sectionList[1428].connect(sectionList[1408](1),0)
sectionList[1429].connect(sectionList[1428](1),0)
sectionList[1430].connect(sectionList[1408](1),0)
...
sectionList[1455].connect(sectionList[1429](1),0)
...
sectionList[1485].connect(sectionList[1429](1),0)
...
sectionList[1538].connect(sectionList[1535](1),0)
...
sectionList[1545].connect(sectionList[1537](1),0)
sectionList[1546].connect(sectionList[1545](1),0)
sectionList[1547].connect(sectionList[1537](1),0)
...
sectionList[1552].connect(sectionList[1546](1),0)
sectionList[1553].connect(sectionList[1552](1),0)
sectionList[1554].connect(sectionList[1546](1),0)
...
sectionList[1564].connect(sectionList[1553](1),0)
sectionList[1565].connect(sectionList[1564](1),0)
sectionList[1566].connect(sectionList[1553](1),0)
...
sectionList[1575].connect(sectionList[1565](1),0)
...
sectionList[1586].connect(sectionList[1565](1),0)
...
sectionList[1615].connect(sectionList[1585](1),0)
...
sectionList[1672].connect(sectionList[1585](1),0)

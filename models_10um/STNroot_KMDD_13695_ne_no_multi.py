...
sectionList = [h.Section() for i in range(1750)]
...
sectionList[1000].connect(sectionList[586](1),0)
...
sectionList[1132].connect(sectionList[1129](1),0)
...
sectionList[1216].connect(sectionList[1131](1),0)
...
sectionList[1223].connect(sectionList[1131](1),0)
...
sectionList[1232].connect(sectionList[1229](1),0)
...
sectionList[1253].connect(sectionList[1231](1),0)
sectionList[1254].connect(sectionList[1253](1),0)
sectionList[1255].connect(sectionList[1231](1),0)
...
sectionList[1264].connect(sectionList[1254](1),0)
...
sectionList[1287].connect(sectionList[1254](1),0)
...
sectionList[1330].connect(sectionList[1327](1),0)
...
sectionList[1361].connect(sectionList[1329](1),0)
...
sectionList[1396].connect(sectionList[1329](1),0)
...
sectionList[1469].connect(sectionList[1466](1),0)
...
sectionList[1572].connect(sectionList[1468](1),0)
sectionList[1573].connect(sectionList[1572](1),0)
sectionList[1574].connect(sectionList[1468](1),0)
...
sectionList[1595].connect(sectionList[1573](1),0)
sectionList[1596].connect(sectionList[1595](1),0)
sectionList[1597].connect(sectionList[1573](1),0)
...
sectionList[1632].connect(sectionList[1596](1),0)
sectionList[1633].connect(sectionList[1632](1),0)
sectionList[1634].connect(sectionList[1596](1),0)
...
sectionList[1673].connect(sectionList[1633](1),0)
...
sectionList[1710].connect(sectionList[1633](1),0)

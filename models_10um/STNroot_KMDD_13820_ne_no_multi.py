...
sectionList = [h.Section() for i in range(2083)]
...
sectionList[1217].connect(sectionList[1087](1),0)
...
sectionList[1249].connect(sectionList[1246](1),0)
...
sectionList[1569].connect(sectionList[1248](1),0)
...
sectionList[1590].connect(sectionList[1248](1),0)
...
sectionList[1605].connect(sectionList[1602](1),0)
...
sectionList[1612].connect(sectionList[1604](1),0)
sectionList[1613].connect(sectionList[1612](1),0)
sectionList[1614].connect(sectionList[1604](1),0)
...
sectionList[1630].connect(sectionList[1613](1),0)
...
sectionList[1647].connect(sectionList[1613](1),0)
...
sectionList[1677].connect(sectionList[1657](1),0)
...
sectionList[1686].connect(sectionList[1683](1),0)
...
sectionList[1719].connect(sectionList[1685](1),0)
sectionList[1720].connect(sectionList[1719](1),0)
sectionList[1721].connect(sectionList[1685](1),0)
...
sectionList[1730].connect(sectionList[1720](1),0)
sectionList[1731].connect(sectionList[1730](1),0)
sectionList[1732].connect(sectionList[1720](1),0)
...
sectionList[1739].connect(sectionList[1731](1),0)
sectionList[1740].connect(sectionList[1739](1),0)
sectionList[1741].connect(sectionList[1731](1),0)
...
sectionList[1760].connect(sectionList[1740](1),0)
sectionList[1761].connect(sectionList[1760](1),0)
sectionList[1762].connect(sectionList[1740](1),0)
...
sectionList[1791].connect(sectionList[1761](1),0)
...
sectionList[1890].connect(sectionList[1761](1),0)

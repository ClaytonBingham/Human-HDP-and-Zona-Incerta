...
sectionList = [h.Section() for i in range(1919)]
...
sectionList[457].connect(sectionList[454](1),0)
...
sectionList[870].connect(sectionList[456](1),0)
...
sectionList[923].connect(sectionList[456](1),0)
...
sectionList[1000].connect(sectionList[922](1),0)
sectionList[1001].connect(sectionList[1000](1),0)
sectionList[1002].connect(sectionList[922](1),0)
...
sectionList[1405].connect(sectionList[1001](1),0)
...
sectionList[1433].connect(sectionList[1001](1),0)
...
sectionList[1473].connect(sectionList[1470](1),0)
...
sectionList[1711].connect(sectionList[1472](1),0)
...
sectionList[1766].connect(sectionList[1472](1),0)
...
sectionList[1820].connect(sectionList[1780](1),0)
sectionList[1821].connect(sectionList[1820](1),0)
sectionList[1822].connect(sectionList[1780](1),0)
...
sectionList[1847].connect(sectionList[1821](1),0)
...
sectionList[1876].connect(sectionList[1821](1),0)

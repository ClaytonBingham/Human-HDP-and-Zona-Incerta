...
sectionList = [h.Section() for i in range(1839)]
...
sectionList[976].connect(sectionList[550](1),0)
...
sectionList[1084].connect(sectionList[1081](1),0)
...
sectionList[1265].connect(sectionList[1083](1),0)
sectionList[1266].connect(sectionList[1265](1),0)
sectionList[1267].connect(sectionList[1083](1),0)
...
sectionList[1771].connect(sectionList[1266](1),0)
...
sectionList[1802].connect(sectionList[1266](1),0)

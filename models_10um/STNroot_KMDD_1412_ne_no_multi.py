...
sectionList = [h.Section() for i in range(2808)]
...
sectionList[880].connect(sectionList[478](1),0)
...
sectionList[1028].connect(sectionList[968](1),0)
...
sectionList[1065].connect(sectionList[1027](1),0)
...
sectionList[1219].connect(sectionList[1027](1),0)
...
sectionList[1231].connect(sectionList[1064](1),0)
...
sectionList[1252].connect(sectionList[1064](1),0)
...
sectionList[1285].connect(sectionList[1230](1),0)
...
sectionList[1318].connect(sectionList[1230](1),0)
...
sectionList[1355].connect(sectionList[1251](1),0)
...
sectionList[1566].connect(sectionList[1251](1),0)
...
sectionList[1605].connect(sectionList[1354](1),0)
sectionList[1606].connect(sectionList[1605](1),0)
sectionList[1607].connect(sectionList[1354](1),0)
...
sectionList[1617].connect(sectionList[1606](1),0)
...
sectionList[1636].connect(sectionList[1606](1),0)
...
sectionList[1695].connect(sectionList[1604](1),0)
...
sectionList[1919].connect(sectionList[1604](1),0)
...
sectionList[2361].connect(sectionList[1929](1),0)
...
sectionList[2508].connect(sectionList[1616](1),0)
...
sectionList[2665].connect(sectionList[1616](1),0)

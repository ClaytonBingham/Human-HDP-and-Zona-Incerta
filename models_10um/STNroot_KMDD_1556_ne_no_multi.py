...
sectionList = [h.Section() for i in range(2027)]
...
sectionList[958].connect(sectionList[532](1),0)
...
sectionList[1084].connect(sectionList[1054](1),0)
...
sectionList[1174].connect(sectionList[1118](1),0)
...
sectionList[1265].connect(sectionList[1262](1),0)
...
sectionList[1312].connect(sectionList[1264](1),0)
...
sectionList[1334].connect(sectionList[1264](1),0)
...
sectionList[1369].connect(sectionList[1311](1),0)
sectionList[1370].connect(sectionList[1369](1),0)
sectionList[1371].connect(sectionList[1311](1),0)
...
sectionList[1423].connect(sectionList[1370](1),0)
sectionList[1424].connect(sectionList[1423](1),0)
sectionList[1425].connect(sectionList[1370](1),0)
...
sectionList[1444].connect(sectionList[1424](1),0)
sectionList[1445].connect(sectionList[1444](1),0)
sectionList[1446].connect(sectionList[1424](1),0)
...
sectionList[1493].connect(sectionList[1445](1),0)
...
sectionList[1540].connect(sectionList[1445](1),0)
...
sectionList[1605].connect(sectionList[1422](1),0)
...
sectionList[1766].connect(sectionList[1422](1),0)
...
sectionList[2014].connect(sectionList[1788](1),0)

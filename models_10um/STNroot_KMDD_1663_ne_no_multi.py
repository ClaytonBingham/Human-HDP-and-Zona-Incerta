...
sectionList = [h.Section() for i in range(2606)]
...
sectionList[548].connect(sectionList[545](1),0)
...
sectionList[953].connect(sectionList[547](1),0)
sectionList[954].connect(sectionList[953](1),0)
sectionList[955].connect(sectionList[547](1),0)
...
sectionList[1142].connect(sectionList[954](1),0)
sectionList[1143].connect(sectionList[1142](1),0)
sectionList[1144].connect(sectionList[954](1),0)
...
sectionList[1333].connect(sectionList[1143](1),0)
...
sectionList[1530].connect(sectionList[1143](1),0)
...
sectionList[1737].connect(sectionList[1332](1),0)
sectionList[1738].connect(sectionList[1737](1),0)
sectionList[1739].connect(sectionList[1332](1),0)
...
sectionList[1784].connect(sectionList[1738](1),0)
...
sectionList[1811].connect(sectionList[1738](1),0)
...
sectionList[2066].connect(sectionList[1736](1),0)
sectionList[2067].connect(sectionList[2066](1),0)
sectionList[2068].connect(sectionList[1736](1),0)
...
sectionList[2389].connect(sectionList[2067](1),0)
...
sectionList[2418].connect(sectionList[2067](1),0)

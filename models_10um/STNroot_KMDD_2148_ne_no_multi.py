...
sectionList = [h.Section() for i in range(3563)]
...
sectionList[917].connect(sectionList[490](1),0)
...
sectionList[1068].connect(sectionList[1038](1),0)
...
sectionList[1083].connect(sectionList[1067](1),0)
...
sectionList[1634].connect(sectionList[1067](1),0)
...
sectionList[2190].connect(sectionList[1662](1),0)
...
sectionList[2764].connect(sectionList[2214](1),0)
...
sectionList[2827].connect(sectionList[2824](1),0)
...
sectionList[3288].connect(sectionList[2826](1),0)
sectionList[3289].connect(sectionList[3288](1),0)
sectionList[3290].connect(sectionList[2826](1),0)
...
sectionList[3313].connect(sectionList[3289](1),0)
...
sectionList[3352].connect(sectionList[3289](1),0)

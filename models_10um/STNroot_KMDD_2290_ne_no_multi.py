...
sectionList = [h.Section() for i in range(1885)]
...
sectionList[851].connect(sectionList[438](1),0)
...
sectionList[1093].connect(sectionList[438](1),0)
...
sectionList[1740].connect(sectionList[1237](1),0)
...
sectionList[1840].connect(sectionList[1776](1),0)

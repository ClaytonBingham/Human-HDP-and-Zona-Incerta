...
sectionList = [h.Section() for i in range(1494)]
...
sectionList[856].connect(sectionList[448](1),0)
...
sectionList[1051].connect(sectionList[907](1),0)
...
sectionList[1437].connect(sectionList[1073](1),0)

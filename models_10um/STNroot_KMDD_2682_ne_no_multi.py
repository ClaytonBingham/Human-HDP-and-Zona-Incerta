...
sectionList = [h.Section() for i in range(1876)]
...
sectionList[961].connect(sectionList[541](1),0)
...
sectionList[1619].connect(sectionList[1099](1),0)
...
sectionList[1644].connect(sectionList[1641](1),0)
...
sectionList[1681].connect(sectionList[1643](1),0)
sectionList[1682].connect(sectionList[1681](1),0)
sectionList[1683].connect(sectionList[1643](1),0)
...
sectionList[1732].connect(sectionList[1682](1),0)
...
sectionList[1773].connect(sectionList[1682](1),0)

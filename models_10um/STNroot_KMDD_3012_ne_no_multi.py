...
sectionList = [h.Section() for i in range(1848)]
...
sectionList[583].connect(sectionList[580](1),0)
...
sectionList[995].connect(sectionList[582](1),0)
...
sectionList[1102].connect(sectionList[582](1),0)
...
sectionList[1381].connect(sectionList[1237](1),0)
sectionList[1382].connect(sectionList[1381](1),0)
sectionList[1383].connect(sectionList[1237](1),0)
...
sectionList[1406].connect(sectionList[1382](1),0)
sectionList[1407].connect(sectionList[1406](1),0)
sectionList[1408].connect(sectionList[1382](1),0)
...
sectionList[1438].connect(sectionList[1407](1),0)
...
sectionList[1643].connect(sectionList[1407](1),0)
...
sectionList[1694].connect(sectionList[1691](1),0)
...
sectionList[1718].connect(sectionList[1693](1),0)
sectionList[1719].connect(sectionList[1718](1),0)
sectionList[1720].connect(sectionList[1693](1),0)
...
sectionList[1730].connect(sectionList[1719](1),0)
sectionList[1731].connect(sectionList[1730](1),0)
sectionList[1732].connect(sectionList[1719](1),0)
...
sectionList[1783].connect(sectionList[1731](1),0)
...
sectionList[1811].connect(sectionList[1731](1),0)

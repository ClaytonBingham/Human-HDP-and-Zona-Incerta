...
sectionList = [h.Section() for i in range(2418)]
...
sectionList[1090].connect(sectionList[670](1),0)
...
sectionList[1263].connect(sectionList[1245](1),0)
...
sectionList[1460].connect(sectionList[1287](1),0)
...
sectionList[1496].connect(sectionList[1493](1),0)
...
sectionList[1536].connect(sectionList[1495](1),0)
sectionList[1537].connect(sectionList[1536](1),0)
sectionList[1538].connect(sectionList[1495](1),0)
...
sectionList[1569].connect(sectionList[1537](1),0)
sectionList[1570].connect(sectionList[1569](1),0)
sectionList[1571].connect(sectionList[1537](1),0)
...
sectionList[1604].connect(sectionList[1570](1),0)
sectionList[1605].connect(sectionList[1604](1),0)
sectionList[1606].connect(sectionList[1570](1),0)
...
sectionList[1649].connect(sectionList[1605](1),0)
sectionList[1650].connect(sectionList[1649](1),0)
sectionList[1651].connect(sectionList[1605](1),0)
...
sectionList[1698].connect(sectionList[1650](1),0)
...
sectionList[1775].connect(sectionList[1650](1),0)
...
sectionList[1824].connect(sectionList[1535](1),0)
...
sectionList[1891].connect(sectionList[1535](1),0)
...
sectionList[2065].connect(sectionList[1697](1),0)
...
sectionList[2078].connect(sectionList[1697](1),0)
...
sectionList[2101].connect(sectionList[1823](1),0)
...
sectionList[2202].connect(sectionList[1823](1),0)
...
sectionList[2229].connect(sectionList[2100](1),0)
...
sectionList[2292].connect(sectionList[2100](1),0)

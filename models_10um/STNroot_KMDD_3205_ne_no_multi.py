...
sectionList = [h.Section() for i in range(2368)]
...
sectionList[928].connect(sectionList[514](1),0)
...
sectionList[1438].connect(sectionList[1320](1),0)
...
sectionList[1489].connect(sectionList[1320](1),0)
...
sectionList[1522].connect(sectionList[1488](1),0)
...
sectionList[1632].connect(sectionList[1488](1),0)
...
sectionList[1695].connect(sectionList[1521](1),0)
...
sectionList[1718].connect(sectionList[1521](1),0)
...
sectionList[1739].connect(sectionList[1694](1),0)
...
sectionList[1754].connect(sectionList[1694](1),0)
...
sectionList[1829].connect(sectionList[1717](1),0)
...
sectionList[1890].connect(sectionList[1717](1),0)
...
sectionList[1963].connect(sectionList[1738](1),0)
...
sectionList[2109].connect(sectionList[1738](1),0)

...
sectionList = [h.Section() for i in range(1980)]
...
sectionList[958].connect(sectionList[562](1),0)
...
sectionList[1105].connect(sectionList[1072](1),0)
...
sectionList[1121].connect(sectionList[1104](1),0)
sectionList[1122].connect(sectionList[1121](1),0)
sectionList[1123].connect(sectionList[1104](1),0)
...
sectionList[1188].connect(sectionList[1122](1),0)
sectionList[1189].connect(sectionList[1188](1),0)
sectionList[1190].connect(sectionList[1122](1),0)
...
sectionList[1209].connect(sectionList[1189](1),0)
sectionList[1210].connect(sectionList[1209](1),0)
sectionList[1211].connect(sectionList[1189](1),0)
...
sectionList[1236].connect(sectionList[1210](1),0)
...
sectionList[1275].connect(sectionList[1210](1),0)
...
sectionList[1338].connect(sectionList[1187](1),0)
...
sectionList[1371].connect(sectionList[1187](1),0)
...
sectionList[1384].connect(sectionList[1274](1),0)
...
sectionList[1437].connect(sectionList[1274](1),0)
...
sectionList[1460].connect(sectionList[1436](1),0)
...
sectionList[1667].connect(sectionList[1436](1),0)
...
sectionList[1700].connect(sectionList[1459](1),0)
...
sectionList[1757].connect(sectionList[1459](1),0)
...
sectionList[1778].connect(sectionList[1699](1),0)
...
sectionList[1817].connect(sectionList[1699](1),0)
...
sectionList[1872].connect(sectionList[1756](1),0)
...
sectionList[1949].connect(sectionList[1756](1),0)

...
sectionList = [h.Section() for i in range(1666)]
...
sectionList[1025].connect(sectionList[1022](1),0)
...
sectionList[1537].connect(sectionList[1024](1),0)
sectionList[1538].connect(sectionList[1537](1),0)
sectionList[1539].connect(sectionList[1024](1),0)
...
sectionList[1564].connect(sectionList[1538](1),0)
...
sectionList[1619].connect(sectionList[1538](1),0)

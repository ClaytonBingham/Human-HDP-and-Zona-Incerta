...
sectionList = [h.Section() for i in range(1747)]
...
sectionList[1568].connect(sectionList[1074](1),0)
...
sectionList[1593].connect(sectionList[1074](1),0)
...
sectionList[1645].connect(sectionList[1619](1),0)
sectionList[1646].connect(sectionList[1645](1),0)
sectionList[1647].connect(sectionList[1619](1),0)
...
sectionList[1665].connect(sectionList[1646](1),0)
...
sectionList[1694].connect(sectionList[1646](1),0)

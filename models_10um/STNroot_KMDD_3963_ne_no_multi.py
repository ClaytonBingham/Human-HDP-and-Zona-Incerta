...
sectionList = [h.Section() for i in range(3495)]
...
sectionList[1162].connect(sectionList[748](1),0)
...
sectionList[1449].connect(sectionList[1391](1),0)
...
sectionList[1474].connect(sectionList[1471](1),0)
...
sectionList[1845].connect(sectionList[1473](1),0)
sectionList[1846].connect(sectionList[1845](1),0)
sectionList[1847].connect(sectionList[1473](1),0)
...
sectionList[1883].connect(sectionList[1846](1),0)
...
sectionList[1922].connect(sectionList[1846](1),0)
...
sectionList[1973].connect(sectionList[1921](1),0)
...
sectionList[2090].connect(sectionList[1921](1),0)
...
sectionList[2125].connect(sectionList[2122](1),0)
...
sectionList[2422].connect(sectionList[2124](1),0)
...
sectionList[2505].connect(sectionList[2124](1),0)
...
sectionList[2540].connect(sectionList[2504](1),0)
...
sectionList[2787].connect(sectionList[2504](1),0)
...
sectionList[2806].connect(sectionList[2539](1),0)
sectionList[2807].connect(sectionList[2806](1),0)
sectionList[2808].connect(sectionList[2539](1),0)
...
sectionList[3189].connect(sectionList[2807](1),0)
...
sectionList[3276].connect(sectionList[2807](1),0)
...
sectionList[3340].connect(sectionList[3326](1),0)
...
sectionList[3416].connect(sectionList[3372](1),0)
...
sectionList[3460].connect(sectionList[3420](1),0)

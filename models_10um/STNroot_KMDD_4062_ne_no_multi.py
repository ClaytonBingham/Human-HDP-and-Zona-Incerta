...
sectionList = [h.Section() for i in range(2041)]
...
sectionList[874].connect(sectionList[460](1),0)
...
sectionList[1077].connect(sectionList[1074](1),0)
...
sectionList[1130].connect(sectionList[1076](1),0)
...
sectionList[1167].connect(sectionList[1076](1),0)
...
sectionList[1364].connect(sectionList[1166](1),0)
sectionList[1365].connect(sectionList[1364](1),0)
sectionList[1366].connect(sectionList[1166](1),0)
...
sectionList[1741].connect(sectionList[1365](1),0)
...
sectionList[1908].connect(sectionList[1365](1),0)

...
sectionList = [h.Section() for i in range(2077)]
...
sectionList[1090].connect(sectionList[660](1),0)
...
sectionList[1181].connect(sectionList[660](1),0)
...
sectionList[1544].connect(sectionList[1180](1),0)
sectionList[1545].connect(sectionList[1544](1),0)
sectionList[1546].connect(sectionList[1180](1),0)
...
sectionList[1981].connect(sectionList[1545](1),0)
...
sectionList[2010].connect(sectionList[1545](1),0)

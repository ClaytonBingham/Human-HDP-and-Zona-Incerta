...
sectionList = [h.Section() for i in range(3320)]
...
sectionList[475].connect(sectionList[472](1),0)
...
sectionList[900].connect(sectionList[474](1),0)
...
sectionList[971].connect(sectionList[474](1),0)
...
sectionList[1044].connect(sectionList[970](1),0)
...
sectionList[1337].connect(sectionList[970](1),0)
...
sectionList[1872].connect(sectionList[1043](1),0)
sectionList[1873].connect(sectionList[1872](1),0)
sectionList[1874].connect(sectionList[1043](1),0)
...
sectionList[2175].connect(sectionList[1873](1),0)
sectionList[2176].connect(sectionList[2175](1),0)
sectionList[2177].connect(sectionList[1873](1),0)
...
sectionList[2236].connect(sectionList[2176](1),0)
...
sectionList[2295].connect(sectionList[2176](1),0)
...
sectionList[2369].connect(sectionList[2349](1),0)
...
sectionList[2590].connect(sectionList[2368](1),0)
...
sectionList[3265].connect(sectionList[2368](1),0)

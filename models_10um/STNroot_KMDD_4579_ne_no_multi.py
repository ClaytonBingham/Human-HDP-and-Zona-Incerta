...
sectionList = [h.Section() for i in range(1846)]
...
sectionList[1024].connect(sectionList[598](1),0)
...
sectionList[1259].connect(sectionList[1256](1),0)
...
sectionList[1366].connect(sectionList[1258](1),0)
sectionList[1367].connect(sectionList[1366](1),0)
sectionList[1368].connect(sectionList[1258](1),0)
...
sectionList[1385].connect(sectionList[1367](1),0)
...
sectionList[1455].connect(sectionList[1367](1),0)

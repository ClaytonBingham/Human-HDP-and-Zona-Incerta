...
sectionList = [h.Section() for i in range(3296)]
...
sectionList[965].connect(sectionList[545](1),0)
...
sectionList[1064].connect(sectionList[1061](1),0)
...
sectionList[1244].connect(sectionList[1063](1),0)
sectionList[1245].connect(sectionList[1244](1),0)
sectionList[1246].connect(sectionList[1063](1),0)
...
sectionList[1275].connect(sectionList[1245](1),0)
sectionList[1276].connect(sectionList[1275](1),0)
sectionList[1277].connect(sectionList[1245](1),0)
...
sectionList[1319].connect(sectionList[1276](1),0)
sectionList[1320].connect(sectionList[1319](1),0)
sectionList[1321].connect(sectionList[1276](1),0)
...
sectionList[1368].connect(sectionList[1320](1),0)
sectionList[1369].connect(sectionList[1368](1),0)
sectionList[1370].connect(sectionList[1320](1),0)
...
sectionList[1399].connect(sectionList[1369](1),0)
...
sectionList[1444].connect(sectionList[1369](1),0)
...
sectionList[1487].connect(sectionList[1443](1),0)
sectionList[1488].connect(sectionList[1487](1),0)
sectionList[1489].connect(sectionList[1443](1),0)
...
sectionList[2140].connect(sectionList[1488](1),0)
...
sectionList[2159].connect(sectionList[1488](1),0)
...
sectionList[2194].connect(sectionList[1486](1),0)
sectionList[2195].connect(sectionList[2194](1),0)
sectionList[2196].connect(sectionList[1486](1),0)
...
sectionList[2881].connect(sectionList[2195](1),0)
...
sectionList[2924].connect(sectionList[2195](1),0)
...
sectionList[2987].connect(sectionList[2193](1),0)
sectionList[2988].connect(sectionList[2987](1),0)
sectionList[2989].connect(sectionList[2193](1),0)
...
sectionList[3216].connect(sectionList[2988](1),0)
...
sectionList[3255].connect(sectionList[2988](1),0)

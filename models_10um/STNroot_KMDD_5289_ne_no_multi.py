...
sectionList = [h.Section() for i in range(3078)]
...
sectionList[964].connect(sectionList[526](1),0)
...
sectionList[1586].connect(sectionList[1327](1),0)
...
sectionList[1700].connect(sectionList[1646](1),0)
...
sectionList[1739].connect(sectionList[1699](1),0)
...
sectionList[1790].connect(sectionList[1699](1),0)
...
sectionList[1871].connect(sectionList[1738](1),0)
sectionList[1872].connect(sectionList[1871](1),0)
sectionList[1873].connect(sectionList[1738](1),0)
...
sectionList[1924].connect(sectionList[1872](1),0)
...
sectionList[2129].connect(sectionList[1872](1),0)
...
sectionList[2156].connect(sectionList[1870](1),0)
...
sectionList[2275].connect(sectionList[1870](1),0)
...
sectionList[2382].connect(sectionList[2155](1),0)
...
sectionList[2469].connect(sectionList[2155](1),0)
...
sectionList[2516].connect(sectionList[2381](1),0)
...
sectionList[2637].connect(sectionList[2381](1),0)
...
sectionList[2963].connect(sectionList[2679](1),0)

...
sectionList = [h.Section() for i in range(1746)]
...
sectionList[994].connect(sectionList[580](1),0)
...
sectionList[1051].connect(sectionList[1048](1),0)
...
sectionList[1672].connect(sectionList[1050](1),0)
...
sectionList[1709].connect(sectionList[1050](1),0)

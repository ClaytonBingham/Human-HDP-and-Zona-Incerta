...
sectionList = [h.Section() for i in range(1611)]
...
sectionList[1044].connect(sectionList[992](1),0)
...
sectionList[1165].connect(sectionList[1162](1),0)
...
sectionList[1276].connect(sectionList[1164](1),0)
...
sectionList[1295].connect(sectionList[1164](1),0)
...
sectionList[1342].connect(sectionList[1316](1),0)
...
sectionList[1372].connect(sectionList[1368](1),0)

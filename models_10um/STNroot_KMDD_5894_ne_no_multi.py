...
sectionList = [h.Section() for i in range(2115)]
...
sectionList[1000].connect(sectionList[574](1),0)
...
sectionList[1283].connect(sectionList[1280](1),0)
...
sectionList[1540].connect(sectionList[1282](1),0)
...
sectionList[1569].connect(sectionList[1282](1),0)
...
sectionList[1614].connect(sectionList[1568](1),0)
sectionList[1615].connect(sectionList[1614](1),0)
sectionList[1616].connect(sectionList[1568](1),0)
...
sectionList[1637].connect(sectionList[1615](1),0)
...
sectionList[1652].connect(sectionList[1615](1),0)
...
sectionList[1685].connect(sectionList[1651](1),0)
sectionList[1686].connect(sectionList[1685](1),0)
sectionList[1687].connect(sectionList[1651](1),0)
...
sectionList[1752].connect(sectionList[1686](1),0)
sectionList[1753].connect(sectionList[1752](1),0)
sectionList[1754].connect(sectionList[1686](1),0)
...
sectionList[1780].connect(sectionList[1753](1),0)
sectionList[1781].connect(sectionList[1780](1),0)
sectionList[1782].connect(sectionList[1753](1),0)
...
sectionList[1813].connect(sectionList[1781](1),0)
sectionList[1814].connect(sectionList[1813](1),0)
sectionList[1815].connect(sectionList[1781](1),0)
...
sectionList[1840].connect(sectionList[1814](1),0)
...
sectionList[1884].connect(sectionList[1814](1),0)
...
sectionList[1985].connect(sectionList[1839](1),0)
sectionList[1986].connect(sectionList[1985](1),0)
sectionList[1987].connect(sectionList[1839](1),0)
...
sectionList[1996].connect(sectionList[1986](1),0)
sectionList[1997].connect(sectionList[1996](1),0)
sectionList[1998].connect(sectionList[1986](1),0)
...
sectionList[2011].connect(sectionList[1997](1),0)
...
sectionList[2068].connect(sectionList[1997](1),0)

...
sectionList = [h.Section() for i in range(1954)]
...
sectionList[885].connect(sectionList[472](1),0)
...
sectionList[1097].connect(sectionList[1063](1),0)
...
sectionList[1267].connect(sectionList[1063](1),0)
...
sectionList[1308].connect(sectionList[1305](1),0)
...
sectionList[1331].connect(sectionList[1307](1),0)
...
sectionList[1364].connect(sectionList[1307](1),0)
...
sectionList[1383].connect(sectionList[1330](1),0)
...
sectionList[1458].connect(sectionList[1330](1),0)
...
sectionList[1485].connect(sectionList[1382](1),0)
...
sectionList[1535].connect(sectionList[1382](1),0)
...
sectionList[1610].connect(sectionList[1484](1),0)
...
sectionList[1737].connect(sectionList[1484](1),0)
...
sectionList[1758].connect(sectionList[1534](1),0)
...
sectionList[1837].connect(sectionList[1534](1),0)

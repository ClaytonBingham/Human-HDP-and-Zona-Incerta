...
sectionList = [h.Section() for i in range(1793)]
...
sectionList[989].connect(sectionList[568](1),0)
...
sectionList[1148].connect(sectionList[1084](1),0)
...
sectionList[1185].connect(sectionList[1084](1),0)
...
sectionList[1214].connect(sectionList[1211](1),0)
...
sectionList[1311].connect(sectionList[1213](1),0)
sectionList[1312].connect(sectionList[1311](1),0)
sectionList[1313].connect(sectionList[1213](1),0)
...
sectionList[1340].connect(sectionList[1312](1),0)
sectionList[1341].connect(sectionList[1340](1),0)
sectionList[1342].connect(sectionList[1312](1),0)
...
sectionList[1395].connect(sectionList[1341](1),0)
...
sectionList[1440].connect(sectionList[1341](1),0)

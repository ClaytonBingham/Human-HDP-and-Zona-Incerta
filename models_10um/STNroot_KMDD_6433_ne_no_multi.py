...
sectionList = [h.Section() for i in range(2733)]
...
sectionList[936].connect(sectionList[520](1),0)
...
sectionList[1033].connect(sectionList[1030](1),0)
...
sectionList[1216].connect(sectionList[1032](1),0)
...
sectionList[1235].connect(sectionList[1032](1),0)
...
sectionList[1278].connect(sectionList[1215](1),0)
...
sectionList[1435].connect(sectionList[1215](1),0)
...
sectionList[1446].connect(sectionList[1277](1),0)
...
sectionList[1637].connect(sectionList[1277](1),0)
...
sectionList[1682].connect(sectionList[1445](1),0)
...
sectionList[1867].connect(sectionList[1445](1),0)
...
sectionList[1939].connect(sectionList[1681](1),0)
...
sectionList[2179].connect(sectionList[1681](1),0)
...
sectionList[2604].connect(sectionList[2218](1),0)
...
sectionList[2718].connect(sectionList[2648](1),0)

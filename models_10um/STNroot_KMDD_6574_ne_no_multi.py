...
sectionList = [h.Section() for i in range(1595)]
...
sectionList[922].connect(sectionList[520](1),0)
...
sectionList[1008].connect(sectionList[962](1),0)
...
sectionList[1087].connect(sectionList[1084](1),0)
...
sectionList[1112].connect(sectionList[1086](1),0)
sectionList[1113].connect(sectionList[1112](1),0)
sectionList[1114].connect(sectionList[1086](1),0)
...
sectionList[1175].connect(sectionList[1113](1),0)
...
sectionList[1274].connect(sectionList[1113](1),0)
...
sectionList[1387].connect(sectionList[1273](1),0)
...
sectionList[1558].connect(sectionList[1273](1),0)

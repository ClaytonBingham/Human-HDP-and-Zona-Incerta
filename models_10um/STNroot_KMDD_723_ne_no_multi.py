...
sectionList = [h.Section() for i in range(2766)]
...
sectionList[541].connect(sectionList[538](1),0)
...
sectionList[972].connect(sectionList[540](1),0)
sectionList[973].connect(sectionList[972](1),0)
sectionList[974].connect(sectionList[540](1),0)
...
sectionList[1343].connect(sectionList[973](1),0)
...
sectionList[1727].connect(sectionList[973](1),0)
...
sectionList[2117].connect(sectionList[2114](1),0)
...
sectionList[2568].connect(sectionList[2116](1),0)
...
sectionList[2589].connect(sectionList[2116](1),0)

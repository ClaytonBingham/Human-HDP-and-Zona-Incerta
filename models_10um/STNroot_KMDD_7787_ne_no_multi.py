...
sectionList = [h.Section() for i in range(2377)]
...
sectionList[1023].connect(sectionList[609](1),0)
...
sectionList[1279].connect(sectionList[1276](1),0)
...
sectionList[1327].connect(sectionList[1278](1),0)
sectionList[1328].connect(sectionList[1327](1),0)
sectionList[1329].connect(sectionList[1278](1),0)
...
sectionList[1360].connect(sectionList[1328](1),0)
sectionList[1361].connect(sectionList[1360](1),0)
sectionList[1362].connect(sectionList[1328](1),0)
...
sectionList[1407].connect(sectionList[1361](1),0)
sectionList[1408].connect(sectionList[1407](1),0)
sectionList[1409].connect(sectionList[1361](1),0)
...
sectionList[1436].connect(sectionList[1408](1),0)
...
sectionList[1469].connect(sectionList[1408](1),0)
...
sectionList[1573].connect(sectionList[1468](1),0)
sectionList[1574].connect(sectionList[1573](1),0)
sectionList[1575].connect(sectionList[1468](1),0)
...
sectionList[1816].connect(sectionList[1574](1),0)
sectionList[1817].connect(sectionList[1816](1),0)
sectionList[1818].connect(sectionList[1574](1),0)
...
sectionList[2035].connect(sectionList[1817](1),0)
...
sectionList[2145].connect(sectionList[1817](1),0)

...
sectionList = [h.Section() for i in range(1723)]
...
sectionList[1018].connect(sectionList[616](1),0)
...
sectionList[1109].connect(sectionList[1106](1),0)
...
sectionList[1144].connect(sectionList[1108](1),0)
sectionList[1145].connect(sectionList[1144](1),0)
sectionList[1146].connect(sectionList[1108](1),0)
...
sectionList[1183].connect(sectionList[1145](1),0)
sectionList[1184].connect(sectionList[1183](1),0)
sectionList[1185].connect(sectionList[1145](1),0)
...
sectionList[1228].connect(sectionList[1184](1),0)
sectionList[1229].connect(sectionList[1228](1),0)
sectionList[1230].connect(sectionList[1184](1),0)
...
sectionList[1279].connect(sectionList[1229](1),0)
sectionList[1280].connect(sectionList[1279](1),0)
sectionList[1281].connect(sectionList[1229](1),0)
...
sectionList[1328].connect(sectionList[1280](1),0)
...
sectionList[1413].connect(sectionList[1280](1),0)
...
sectionList[1526].connect(sectionList[1523](1),0)
...
sectionList[1553].connect(sectionList[1525](1),0)
sectionList[1554].connect(sectionList[1553](1),0)
sectionList[1555].connect(sectionList[1525](1),0)
...
sectionList[1571].connect(sectionList[1554](1),0)
sectionList[1572].connect(sectionList[1571](1),0)
sectionList[1573].connect(sectionList[1554](1),0)
...
sectionList[1608].connect(sectionList[1572](1),0)
...
sectionList[1644].connect(sectionList[1572](1),0)

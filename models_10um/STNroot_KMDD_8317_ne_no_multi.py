...
sectionList[988].connect(sectionList[538](1),0)
...
sectionList[1303].connect(sectionList[1300](1),0)
...
sectionList[1322].connect(sectionList[1302](1),0)
sectionList[1323].connect(sectionList[1322](1),0)
sectionList[1324].connect(sectionList[1302](1),0)
...
sectionList[1411].connect(sectionList[1323](1),0)
...
sectionList[1439].connect(sectionList[1323](1),0)
...
sectionList[1474].connect(sectionList[1438](1),0)
...
sectionList[1659].connect(sectionList[1438](1),0)
...
sectionList[1688].connect(sectionList[1685](1),0)
...
sectionList[1713].connect(sectionList[1687](1),0)
...
sectionList[1891].connect(sectionList[1687](1),0)

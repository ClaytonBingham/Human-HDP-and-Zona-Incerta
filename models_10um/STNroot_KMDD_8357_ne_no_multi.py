...
sectionList = [h.Section() for i in range(2108)]
...
sectionList[1044].connect(sectionList[642](1),0)
...
sectionList[1161].connect(sectionList[642](1),0)
...
sectionList[1304].connect(sectionList[1268](1),0)
...
sectionList[1411].connect(sectionList[1342](1),0)
...
sectionList[1475].connect(sectionList[1439](1),0)
...
sectionList[1486].connect(sectionList[1474](1),0)
...
sectionList[1527].connect(sectionList[1474](1),0)
...
sectionList[1652].connect(sectionList[1485](1),0)
sectionList[1653].connect(sectionList[1652](1),0)
sectionList[1654].connect(sectionList[1485](1),0)
...
sectionList[1685].connect(sectionList[1653](1),0)
sectionList[1686].connect(sectionList[1685](1),0)
sectionList[1687].connect(sectionList[1653](1),0)
...
sectionList[1733].connect(sectionList[1686](1),0)
...
sectionList[1769].connect(sectionList[1686](1),0)
...
sectionList[1812].connect(sectionList[1768](1),0)
...
sectionList[1891].connect(sectionList[1768](1),0)
...
sectionList[2002].connect(sectionList[1811](1),0)
...
sectionList[2069].connect(sectionList[1811](1),0)

...
sectionList = [h.Section() for i in range(1827)]
...
sectionList[1054].connect(sectionList[616](1),0)
...
sectionList[1153].connect(sectionList[1150](1),0)
...
sectionList[1318].connect(sectionList[1152](1),0)
sectionList[1319].connect(sectionList[1318](1),0)
sectionList[1320].connect(sectionList[1152](1),0)
...
sectionList[1356].connect(sectionList[1319](1),0)
...
sectionList[1403].connect(sectionList[1355](1),0)
sectionList[1404].connect(sectionList[1403](1),0)
sectionList[1405].connect(sectionList[1355](1),0)
...
sectionList[1622].connect(sectionList[1404](1),0)
...
sectionList[1645].connect(sectionList[1404](1),0)

...
sectionList[1005].connect(sectionList[609](1),0)
...
sectionList[1096].connect(sectionList[1093](1),0)
...
sectionList[1137].connect(sectionList[1095](1),0)
sectionList[1138].connect(sectionList[1137](1),0)
sectionList[1139].connect(sectionList[1095](1),0)
...
sectionList[1155].connect(sectionList[1138](1),0)
sectionList[1156].connect(sectionList[1155](1),0)
sectionList[1157].connect(sectionList[1138](1),0)
...
sectionList[1176].connect(sectionList[1156](1),0)
...
sectionList[1201].connect(sectionList[1156](1),0)
...
sectionList[1232].connect(sectionList[1136](1),0)
...
sectionList[1431].connect(sectionList[1136](1),0)
...
sectionList[1492].connect(sectionList[1231](1),0)
...
sectionList[1793].connect(sectionList[1231](1),0)

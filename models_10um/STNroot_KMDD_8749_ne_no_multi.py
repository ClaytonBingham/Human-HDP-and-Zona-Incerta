...
sectionList = [h.Section() for i in range(1981)]
...
sectionList[1102].connect(sectionList[688](1),0)
...
sectionList[1450].connect(sectionList[1298](1),0)
...
sectionList[1529].connect(sectionList[1484](1),0)
...
sectionList[1577].connect(sectionList[1484](1),0)
...
sectionList[1626].connect(sectionList[1528](1),0)
...
sectionList[1715].connect(sectionList[1528](1),0)

...
sectionList = [h.Section() for i in range(1690)]
...
sectionList[844].connect(sectionList[442](1),0)
...
sectionList[1009].connect(sectionList[1006](1),0)
...
sectionList[1027].connect(sectionList[1008](1),0)
...
sectionList[1050].connect(sectionList[1008](1),0)
...
sectionList[1166].connect(sectionList[1026](1),0)
...
sectionList[1173].connect(sectionList[1026](1),0)

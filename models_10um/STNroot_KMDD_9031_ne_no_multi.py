...
sectionList = [h.Section() for i in range(2251)]
...
sectionList[547].connect(sectionList[544](1),0)
...
sectionList[966].connect(sectionList[546](1),0)
sectionList[967].connect(sectionList[966](1),0)
sectionList[968].connect(sectionList[546](1),0)
...
sectionList[1661].connect(sectionList[967](1),0)
...
sectionList[1998].connect(sectionList[967](1),0)

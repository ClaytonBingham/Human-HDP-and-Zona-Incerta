...
sectionList = [h.Section() for i in range(1976)]
...
sectionList[880].connect(sectionList[472](1),0)
...
sectionList[1161].connect(sectionList[1158](1),0)
...
sectionList[1188].connect(sectionList[1160](1),0)
sectionList[1189].connect(sectionList[1188](1),0)
sectionList[1190].connect(sectionList[1160](1),0)
...
sectionList[1262].connect(sectionList[1189](1),0)
...
sectionList[1279].connect(sectionList[1189](1),0)
...
sectionList[1416].connect(sectionList[1278](1),0)
...
sectionList[1432].connect(sectionList[1278](1),0)
...
sectionList[1459].connect(sectionList[1456](1),0)
...
sectionList[1493].connect(sectionList[1458](1),0)
...
sectionList[1568].connect(sectionList[1458](1),0)
...
sectionList[1625].connect(sectionList[1567](1),0)
sectionList[1626].connect(sectionList[1625](1),0)
sectionList[1627].connect(sectionList[1567](1),0)
...
sectionList[1640].connect(sectionList[1626](1),0)
...
sectionList[1663].connect(sectionList[1626](1),0)
...
sectionList[1712].connect(sectionList[1624](1),0)
...
sectionList[1737].connect(sectionList[1624](1),0)
...
sectionList[1814].connect(sectionList[1662](1),0)
...
sectionList[1857].connect(sectionList[1662](1),0)
...
sectionList[1919].connect(sectionList[1881](1),0)

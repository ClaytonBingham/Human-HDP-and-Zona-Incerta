...
sectionList = [h.Section() for i in range(2111)]
...
sectionList[505].connect(sectionList[502](1),0)
...
sectionList[942].connect(sectionList[504](1),0)
sectionList[943].connect(sectionList[942](1),0)
sectionList[944].connect(sectionList[504](1),0)
...
sectionList[1112].connect(sectionList[943](1),0)
...
sectionList[1295].connect(sectionList[943](1),0)
...
sectionList[1545].connect(sectionList[1485](1),0)
...
sectionList[2065].connect(sectionList[1577](1),0)

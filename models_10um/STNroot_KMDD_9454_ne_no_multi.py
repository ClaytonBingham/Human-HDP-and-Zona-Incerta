...
sectionList = [h.Section() for i in range(1623)]
...
sectionList[909].connect(sectionList[495](1),0)
...
sectionList[996].connect(sectionList[993](1),0)
...
sectionList[1083].connect(sectionList[995](1),0)
sectionList[1084].connect(sectionList[1083](1),0)
sectionList[1085].connect(sectionList[995](1),0)
...
sectionList[1199].connect(sectionList[1084](1),0)
...
sectionList[1398].connect(sectionList[1259](1),0)

...
sectionList = [h.Section() for i in range(1780)]
...
sectionList[844].connect(sectionList[400](1),0)
...
sectionList[1464].connect(sectionList[1114](1),0)
...
sectionList[1485].connect(sectionList[1482](1),0)
...
sectionList[1558].connect(sectionList[1484](1),0)
sectionList[1559].connect(sectionList[1558](1),0)
sectionList[1560].connect(sectionList[1484](1),0)
...
sectionList[1585].connect(sectionList[1559](1),0)
...
sectionList[1613].connect(sectionList[1559](1),0)
...
sectionList[1733].connect(sectionList[1645](1),0)

...
sectionList = [h.Section() for i in range(5777)]
...
sectionList[4749].connect(sectionList[2637](1),0)
...
sectionList[5003].connect(sectionList[5000](1),0)
...
sectionList[5064].connect(sectionList[5002](1),0)
...
sectionList[5073].connect(sectionList[5002](1),0)
...
sectionList[5259].connect(sectionList[5095](1),0)
...
sectionList[5313].connect(sectionList[5287](1),0)
...
sectionList[5373].connect(sectionList[5312](1),0)
...
sectionList[5384].connect(sectionList[5372](1),0)
...
sectionList[5476].connect(sectionList[5372](1),0)
...
sectionList[5533].connect(sectionList[5383](1),0)
...
sectionList[5570].connect(sectionList[5383](1),0)
...
sectionList[5581].connect(sectionList[5532](1),0)
...
sectionList[5606].connect(sectionList[5532](1),0)

...
sectionList = [h.Section() for i in range(5908)]
...
sectionList[5085].connect(sectionList[3028](1),0)
...
sectionList[5236].connect(sectionList[5233](1),0)
...
sectionList[5279].connect(sectionList[5235](1),0)
...
sectionList[5322].connect(sectionList[5235](1),0)
...
sectionList[5341].connect(sectionList[5321](1),0)
sectionList[5342].connect(sectionList[5341](1),0)
sectionList[5343].connect(sectionList[5321](1),0)
...
sectionList[5376].connect(sectionList[5342](1),0)
...
sectionList[5395].connect(sectionList[5342](1),0)
...
sectionList[5458].connect(sectionList[5340](1),0)
...
sectionList[5485].connect(sectionList[5340](1),0)
...
sectionList[5492].connect(sectionList[5394](1),0)
...
sectionList[5537].connect(sectionList[5394](1),0)
...
sectionList[5545].connect(sectionList[5491](1),0)
...
sectionList[5564].connect(sectionList[5491](1),0)
...
sectionList[5579].connect(sectionList[5544](1),0)
...
sectionList[5621].connect(sectionList[5544](1),0)
...
sectionList[5666].connect(sectionList[5578](1),0)
...
sectionList[5679].connect(sectionList[5578](1),0)
...
sectionList[5733].connect(sectionList[5697](1),0)
...
sectionList[5791].connect(sectionList[5747](1),0)
...
sectionList[5844].connect(sectionList[5806](1),0)

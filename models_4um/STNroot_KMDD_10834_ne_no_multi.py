...
sectionList = [h.Section() for i in range(5746)]
...
sectionList[5013].connect(sectionList[2835](1),0)
...
sectionList[5095].connect(sectionList[5092](1),0)
...
sectionList[5226].connect(sectionList[5094](1),0)
...
sectionList[5249].connect(sectionList[5094](1),0)
...
sectionList[5274].connect(sectionList[5271](1),0)
...
sectionList[5309].connect(sectionList[5273](1),0)
sectionList[5310].connect(sectionList[5309](1),0)
sectionList[5311].connect(sectionList[5273](1),0)
...
sectionList[5330].connect(sectionList[5310](1),0)
...
sectionList[5350].connect(sectionList[5310](1),0)
...
sectionList[5375].connect(sectionList[5308](1),0)
sectionList[5376].connect(sectionList[5375](1),0)
sectionList[5377].connect(sectionList[5308](1),0)
...
sectionList[5636].connect(sectionList[5376](1),0)
sectionList[5637].connect(sectionList[5636](1),0)
sectionList[5638].connect(sectionList[5376](1),0)
...
sectionList[5649].connect(sectionList[5637](1),0)
...
sectionList[5682].connect(sectionList[5637](1),0)
...
sectionList[5721].connect(sectionList[5718](1),0)
...
sectionList[5730].connect(sectionList[5720](1),0)
...
sectionList[5737].connect(sectionList[5720](1),0)

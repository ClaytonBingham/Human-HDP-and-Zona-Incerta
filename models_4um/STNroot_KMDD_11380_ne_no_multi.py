...
sectionList = [h.Section() for i in range(5901)]
...
sectionList[2287].connect(sectionList[2284](1),0)
...
sectionList[4525].connect(sectionList[2286](1),0)
...
sectionList[4822].connect(sectionList[2286](1),0)
...
sectionList[5257].connect(sectionList[5250](1),0)
...
sectionList[5284].connect(sectionList[5256](1),0)
...
sectionList[5369].connect(sectionList[5256](1),0)
...
sectionList[5497].connect(sectionList[5283](1),0)
...
sectionList[5548].connect(sectionList[5283](1),0)
...
sectionList[5581].connect(sectionList[5496](1),0)
...
sectionList[5624].connect(sectionList[5496](1),0)
...
sectionList[5669].connect(sectionList[5623](1),0)
...
sectionList[5696].connect(sectionList[5623](1),0)
...
sectionList[5878].connect(sectionList[5736](1),0)

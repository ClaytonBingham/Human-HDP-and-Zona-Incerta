...
sectionList = [h.Section() for i in range(5869)]
...
sectionList[4803].connect(sectionList[2619](1),0)
...
sectionList[4840].connect(sectionList[4837](1),0)
...
sectionList[5351].connect(sectionList[4839](1),0)
sectionList[5352].connect(sectionList[5351](1),0)
sectionList[5353].connect(sectionList[4839](1),0)
sectionList[5354].connect(sectionList[5353](1),0)
sectionList[5355].connect(sectionList[5354](1),0)
sectionList[5356].connect(sectionList[5352](1),0)
sectionList[5357].connect(sectionList[5356](1),0)
sectionList[5358].connect(sectionList[5352](1),0)
...
sectionList[5368].connect(sectionList[5357](1),0)
sectionList[5369].connect(sectionList[5368](1),0)
sectionList[5370].connect(sectionList[5357](1),0)
...
sectionList[5381].connect(sectionList[5369](1),0)
...
sectionList[5420].connect(sectionList[5369](1),0)
...
sectionList[5466].connect(sectionList[5463](1),0)
...
sectionList[5659].connect(sectionList[5465](1),0)
sectionList[5660].connect(sectionList[5659](1),0)
sectionList[5661].connect(sectionList[5465](1),0)
...
sectionList[5690].connect(sectionList[5660](1),0)
...
sectionList[5711].connect(sectionList[5660](1),0)
...
sectionList[5732].connect(sectionList[5729](1),0)
...
sectionList[5757].connect(sectionList[5731](1),0)
...
sectionList[5804].connect(sectionList[5731](1),0)

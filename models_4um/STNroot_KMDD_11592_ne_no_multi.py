...
sectionList = [h.Section() for i in range(5966)]
...
sectionList[2787].connect(sectionList[2784](1),0)
...
sectionList[5017].connect(sectionList[2786](1),0)
...
sectionList[5072].connect(sectionList[2786](1),0)
...
sectionList[5173].connect(sectionList[5071](1),0)
...
sectionList[5431].connect(sectionList[5071](1),0)

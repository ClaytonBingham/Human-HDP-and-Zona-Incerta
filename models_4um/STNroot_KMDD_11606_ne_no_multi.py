...
sectionList = [h.Section() for i in range(5838)]
...
sectionList[4905].connect(sectionList[2674](1),0)
...
sectionList[5092].connect(sectionList[5089](1),0)
...
sectionList[5175].connect(sectionList[5091](1),0)
...
sectionList[5201].connect(sectionList[5091](1),0)
...
sectionList[5222].connect(sectionList[5200](1),0)
sectionList[5223].connect(sectionList[5222](1),0)
sectionList[5224].connect(sectionList[5200](1),0)
...
sectionList[5257].connect(sectionList[5223](1),0)
sectionList[5258].connect(sectionList[5257](1),0)
sectionList[5259].connect(sectionList[5223](1),0)
...
sectionList[5274].connect(sectionList[5258](1),0)
...
sectionList[5347].connect(sectionList[5258](1),0)
...
sectionList[5358].connect(sectionList[5221](1),0)
...
sectionList[5389].connect(sectionList[5221](1),0)
...
sectionList[5426].connect(sectionList[5273](1),0)
...
sectionList[5445].connect(sectionList[5273](1),0)
...
sectionList[5460].connect(sectionList[5357](1),0)
...
sectionList[5646].connect(sectionList[5357](1),0)

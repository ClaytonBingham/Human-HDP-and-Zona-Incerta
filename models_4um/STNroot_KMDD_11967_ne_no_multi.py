...
sectionList = [h.Section() for i in range(5806)]
...
sectionList[5133].connect(sectionList[3057](1),0)
...
sectionList[5197].connect(sectionList[5194](1),0)
...
sectionList[5232].connect(sectionList[5196](1),0)
...
sectionList[5248].connect(sectionList[5196](1),0)
...
sectionList[5277].connect(sectionList[5231](1),0)
...
sectionList[5328].connect(sectionList[5231](1),0)
...
sectionList[5431].connect(sectionList[5428](1),0)
...
sectionList[5481].connect(sectionList[5430](1),0)
sectionList[5482].connect(sectionList[5481](1),0)
sectionList[5483].connect(sectionList[5430](1),0)
...
sectionList[5496].connect(sectionList[5482](1),0)
...
sectionList[5517].connect(sectionList[5482](1),0)
...
sectionList[5637].connect(sectionList[5535](1),0)
...
sectionList[5673].connect(sectionList[5641](1),0)

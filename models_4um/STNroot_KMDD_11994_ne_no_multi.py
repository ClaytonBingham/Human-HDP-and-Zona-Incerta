...
sectionList = [h.Section() for i in range(5956)]
...
sectionList[2431].connect(sectionList[2428](1),0)
...
sectionList[4541].connect(sectionList[2430](1),0)
sectionList[4542].connect(sectionList[4541](1),0)
sectionList[4543].connect(sectionList[2430](1),0)
...
sectionList[4720].connect(sectionList[4542](1),0)
...
sectionList[4905].connect(sectionList[4542](1),0)
...
sectionList[5415].connect(sectionList[5093](1),0)
...
sectionList[5485].connect(sectionList[5457](1),0)
...
sectionList[5885].connect(sectionList[5521](1),0)

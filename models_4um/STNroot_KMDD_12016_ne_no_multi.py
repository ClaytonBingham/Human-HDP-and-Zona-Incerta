...
sectionList = [h.Section() for i in range(5765)]
...
sectionList[4934].connect(sectionList[2789](1),0)
...
sectionList[5103].connect(sectionList[5100](1),0)
...
sectionList[5250].connect(sectionList[5102](1),0)
sectionList[5251].connect(sectionList[5250](1),0)
sectionList[5252].connect(sectionList[5102](1),0)
...
sectionList[5331].connect(sectionList[5251](1),0)
sectionList[5332].connect(sectionList[5331](1),0)
sectionList[5333].connect(sectionList[5251](1),0)
...
sectionList[5392].connect(sectionList[5332](1),0)
...
sectionList[5433].connect(sectionList[5332](1),0)
...
sectionList[5489].connect(sectionList[5432](1),0)
sectionList[5490].connect(sectionList[5489](1),0)
sectionList[5491].connect(sectionList[5432](1),0)
...
sectionList[5508].connect(sectionList[5490](1),0)
sectionList[5509].connect(sectionList[5508](1),0)
sectionList[5510].connect(sectionList[5490](1),0)
...
sectionList[5524].connect(sectionList[5509](1),0)
...
sectionList[5545].connect(sectionList[5509](1),0)

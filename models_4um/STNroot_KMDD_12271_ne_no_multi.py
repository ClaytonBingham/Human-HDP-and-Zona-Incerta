...
sectionList = [h.Section() for i in range(5922)]
...
sectionList[2803].connect(sectionList[2800](1),0)
...
sectionList[4956].connect(sectionList[2802](1),0)
...
sectionList[5135].connect(sectionList[2802](1),0)
...
sectionList[5378].connect(sectionList[5134](1),0)
...
sectionList[5393].connect(sectionList[5134](1),0)
...
sectionList[5715].connect(sectionList[5409](1),0)

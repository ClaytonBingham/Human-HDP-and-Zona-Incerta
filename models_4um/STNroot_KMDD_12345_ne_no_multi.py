...
sectionList = [h.Section() for i in range(5718)]
...
sectionList[4917].connect(sectionList[2680](1),0)
...
sectionList[5197].connect(sectionList[5043](1),0)
...
sectionList[5232].connect(sectionList[5229](1),0)
...
sectionList[5249].connect(sectionList[5231](1),0)
...
sectionList[5262].connect(sectionList[5231](1),0)
...
sectionList[5279].connect(sectionList[5248](1),0)
sectionList[5280].connect(sectionList[5279](1),0)
sectionList[5281].connect(sectionList[5248](1),0)
...
sectionList[5288].connect(sectionList[5280](1),0)
...
sectionList[5300].connect(sectionList[5280](1),0)
...
sectionList[5309].connect(sectionList[5299](1),0)
...
sectionList[5422].connect(sectionList[5299](1),0)
...
sectionList[5440].connect(sectionList[5437](1),0)
...
sectionList[5545].connect(sectionList[5439](1),0)
...
sectionList[5554].connect(sectionList[5439](1),0)
...
sectionList[5679].connect(sectionList[5564](1),0)

...
sectionList = [h.Section() for i in range(5982)]
...
sectionList[5045].connect(sectionList[2903](1),0)
...
sectionList[5165].connect(sectionList[5162](1),0)
...
sectionList[5202].connect(sectionList[5164](1),0)
...
sectionList[5219].connect(sectionList[5164](1),0)
...
sectionList[5234].connect(sectionList[5231](1),0)
...
sectionList[5251].connect(sectionList[5233](1),0)
...
sectionList[5348].connect(sectionList[5233](1),0)
...
sectionList[5415].connect(sectionList[5347](1),0)
...
sectionList[5476].connect(sectionList[5347](1),0)
...
sectionList[5548].connect(sectionList[5516](1),0)
...
sectionList[5621].connect(sectionList[5575](1),0)
...
sectionList[5738].connect(sectionList[5620](1),0)
...
sectionList[5949].connect(sectionList[5620](1),0)

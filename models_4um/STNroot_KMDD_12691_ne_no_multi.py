...
sectionList = [h.Section() for i in range(5907)]
...
sectionList[4946].connect(sectionList[2697](1),0)
...
sectionList[5178].connect(sectionList[5175](1),0)
...
sectionList[5199].connect(sectionList[5177](1),0)
...
sectionList[5243].connect(sectionList[5177](1),0)
...
sectionList[5268].connect(sectionList[5198](1),0)
...
sectionList[5502].connect(sectionList[5198](1),0)
...
sectionList[5705].connect(sectionList[5267](1),0)
sectionList[5706].connect(sectionList[5705](1),0)
sectionList[5707].connect(sectionList[5267](1),0)
...
sectionList[5811].connect(sectionList[5706](1),0)
...
sectionList[5848].connect(sectionList[5706](1),0)

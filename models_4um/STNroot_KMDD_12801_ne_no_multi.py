...
sectionList = [h.Section() for i in range(5549)]
...
sectionList[2322].connect(sectionList[2319](1),0)
...
sectionList[4420].connect(sectionList[2321](1),0)
sectionList[4421].connect(sectionList[4420](1),0)
sectionList[4422].connect(sectionList[2321](1),0)
...
sectionList[4547].connect(sectionList[4421](1),0)
sectionList[4548].connect(sectionList[4547](1),0)
sectionList[4549].connect(sectionList[4421](1),0)
...
sectionList[4830].connect(sectionList[4548](1),0)
...
sectionList[5097].connect(sectionList[4548](1),0)

...
sectionList = [h.Section() for i in range(5675)]
...
sectionList[4870].connect(sectionList[2704](1),0)
...
sectionList[5362].connect(sectionList[5076](1),0)
...
sectionList[5385].connect(sectionList[5382](1),0)
...
sectionList[5430].connect(sectionList[5384](1),0)
...
sectionList[5445].connect(sectionList[5384](1),0)
...
sectionList[5458].connect(sectionList[5429](1),0)
sectionList[5459].connect(sectionList[5458](1),0)
sectionList[5460].connect(sectionList[5429](1),0)
...
sectionList[5495].connect(sectionList[5459](1),0)
...
sectionList[5604].connect(sectionList[5459](1),0)

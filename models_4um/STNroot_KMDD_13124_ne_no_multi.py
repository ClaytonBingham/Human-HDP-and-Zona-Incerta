...
sectionList = [h.Section() for i in range(5497)]
...
sectionList[4505].connect(sectionList[2320](1),0)
...
sectionList[4715].connect(sectionList[4611](1),0)
...
sectionList[4754].connect(sectionList[4751](1),0)
...
sectionList[4769].connect(sectionList[4753](1),0)
sectionList[4770].connect(sectionList[4769](1),0)
sectionList[4771].connect(sectionList[4753](1),0)
...
sectionList[4793].connect(sectionList[4770](1),0)
sectionList[4794].connect(sectionList[4793](1),0)
sectionList[4795].connect(sectionList[4770](1),0)
...
sectionList[4812].connect(sectionList[4794](1),0)
sectionList[4813].connect(sectionList[4812](1),0)
sectionList[4814].connect(sectionList[4794](1),0)
...
sectionList[4829].connect(sectionList[4813](1),0)
...
sectionList[4846].connect(sectionList[4813](1),0)
...
sectionList[5119].connect(sectionList[4845](1),0)
...
sectionList[5422].connect(sectionList[4845](1),0)
...
sectionList[5480].connect(sectionList[5436](1),0)

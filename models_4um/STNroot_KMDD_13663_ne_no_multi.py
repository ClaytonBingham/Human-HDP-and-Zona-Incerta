...
sectionList = [h.Section() for i in range(5918)]
...
sectionList[5045].connect(sectionList[2854](1),0)
...
sectionList[5244].connect(sectionList[5179](1),0)
...
sectionList[5267].connect(sectionList[5264](1),0)
...
sectionList[5488].connect(sectionList[5266](1),0)
sectionList[5489].connect(sectionList[5488](1),0)
sectionList[5490].connect(sectionList[5266](1),0)
...
sectionList[5509].connect(sectionList[5489](1),0)
sectionList[5510].connect(sectionList[5509](1),0)
sectionList[5511].connect(sectionList[5489](1),0)
...
sectionList[5536].connect(sectionList[5510](1),0)
...
sectionList[5566].connect(sectionList[5510](1),0)
...
sectionList[5626].connect(sectionList[5618](1),0)
sectionList[5627].connect(sectionList[5626](1),0)
sectionList[5628].connect(sectionList[5618](1),0)
...
sectionList[5633].connect(sectionList[5627](1),0)
sectionList[5634].connect(sectionList[5633](1),0)
sectionList[5635].connect(sectionList[5627](1),0)
...
sectionList[5645].connect(sectionList[5634](1),0)
sectionList[5646].connect(sectionList[5645](1),0)
sectionList[5647].connect(sectionList[5634](1),0)
...
sectionList[5656].connect(sectionList[5646](1),0)
...
sectionList[5667].connect(sectionList[5646](1),0)
...
sectionList[5696].connect(sectionList[5666](1),0)
...
sectionList[5753].connect(sectionList[5666](1),0)

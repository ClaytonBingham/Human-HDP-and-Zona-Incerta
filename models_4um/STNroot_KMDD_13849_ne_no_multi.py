...
sectionList = [h.Section() for i in range(5586)]
...
sectionList[2384].connect(sectionList[2381](1),0)
...
sectionList[4537].connect(sectionList[2383](1),0)
...
sectionList[4590].connect(sectionList[2383](1),0)
...
sectionList[4667].connect(sectionList[4589](1),0)
sectionList[4668].connect(sectionList[4667](1),0)
sectionList[4669].connect(sectionList[4589](1),0)
...
sectionList[5072].connect(sectionList[4668](1),0)
...
sectionList[5100].connect(sectionList[4668](1),0)
...
sectionList[5140].connect(sectionList[5137](1),0)
...
sectionList[5378].connect(sectionList[5139](1),0)
...
sectionList[5433].connect(sectionList[5139](1),0)
...
sectionList[5448].connect(sectionList[5445](1),0)
...
sectionList[5487].connect(sectionList[5447](1),0)
sectionList[5488].connect(sectionList[5487](1),0)
sectionList[5489].connect(sectionList[5447](1),0)
...
sectionList[5514].connect(sectionList[5488](1),0)
...
sectionList[5543].connect(sectionList[5488](1),0)

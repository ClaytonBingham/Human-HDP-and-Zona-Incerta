...
sectionList = [h.Section() for i in range(5962)]
...
sectionList[5099].connect(sectionList[2884](1),0)
...
sectionList[5207].connect(sectionList[5204](1),0)
...
sectionList[5388].connect(sectionList[5206](1),0)
sectionList[5389].connect(sectionList[5388](1),0)
sectionList[5390].connect(sectionList[5206](1),0)
...
sectionList[5894].connect(sectionList[5389](1),0)
...
sectionList[5925].connect(sectionList[5389](1),0)

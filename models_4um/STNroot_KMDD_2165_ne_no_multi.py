...
sectionList = [h.Section() for i in range(5276)]
...
sectionList[4421].connect(sectionList[2321](1),0)
...
sectionList[4608].connect(sectionList[4605](1),0)
...
sectionList[4749].connect(sectionList[4607](1),0)
...
sectionList[4937].connect(sectionList[4607](1),0)

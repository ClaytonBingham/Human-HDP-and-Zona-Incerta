...
sectionList = [h.Section() for i in range(5451)]
...
sectionList[2276].connect(sectionList[2273](1),0)
...
sectionList[4417].connect(sectionList[2275](1),0)
...
sectionList[4659].connect(sectionList[2275](1),0)
...
sectionList[5306].connect(sectionList[4803](1),0)
...
sectionList[5406].connect(sectionList[5342](1),0)

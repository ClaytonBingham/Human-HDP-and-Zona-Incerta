...
sectionList = [h.Section() for i in range(5124)]
...
sectionList[4486].connect(sectionList[2356](1),0)
...
sectionList[4681].connect(sectionList[4537](1),0)
...
sectionList[5067].connect(sectionList[4703](1),0)

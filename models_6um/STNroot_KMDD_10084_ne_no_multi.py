...
sectionList = [h.Section() for i in range(2802)]
...
sectionList[1690].connect(sectionList[868](1),0)
...
sectionList[1758].connect(sectionList[1742](1),0)
...
sectionList[1767].connect(sectionList[1757](1),0)
...
sectionList[1796].connect(sectionList[1757](1),0)
...
sectionList[1825].connect(sectionList[1822](1),0)
...
sectionList[1894].connect(sectionList[1824](1),0)
sectionList[1895].connect(sectionList[1894](1),0)
sectionList[1896].connect(sectionList[1824](1),0)
...
sectionList[1906].connect(sectionList[1895](1),0)
sectionList[1907].connect(sectionList[1906](1),0)
sectionList[1908].connect(sectionList[1895](1),0)
...
sectionList[1919].connect(sectionList[1907](1),0)
sectionList[1920].connect(sectionList[1919](1),0)
sectionList[1921].connect(sectionList[1907](1),0)
...
sectionList[1936].connect(sectionList[1920](1),0)
...
sectionList[1950].connect(sectionList[1920](1),0)
...
sectionList[2002].connect(sectionList[1964](1),0)
...
sectionList[2044].connect(sectionList[2041](1),0)
...
sectionList[2073].connect(sectionList[2043](1),0)
...
sectionList[2100].connect(sectionList[2043](1),0)
...
sectionList[2129].connect(sectionList[2072](1),0)
sectionList[2130].connect(sectionList[2129](1),0)
sectionList[2131].connect(sectionList[2072](1),0)
...
sectionList[2138].connect(sectionList[2130](1),0)
sectionList[2139].connect(sectionList[2138](1),0)
sectionList[2140].connect(sectionList[2130](1),0)
...
sectionList[2174].connect(sectionList[2139](1),0)
sectionList[2175].connect(sectionList[2174](1),0)
sectionList[2176].connect(sectionList[2139](1),0)
...
sectionList[2229].connect(sectionList[2175](1),0)
...
sectionList[2288].connect(sectionList[2175](1),0)
...
sectionList[2350].connect(sectionList[2287](1),0)
sectionList[2351].connect(sectionList[2350](1),0)
sectionList[2352].connect(sectionList[2287](1),0)
...
sectionList[2387].connect(sectionList[2351](1),0)
...
sectionList[2398].connect(sectionList[2351](1),0)
...
sectionList[2412].connect(sectionList[2409](1),0)
...
sectionList[2490].connect(sectionList[2411](1),0)
sectionList[2491].connect(sectionList[2490](1),0)
sectionList[2492].connect(sectionList[2411](1),0)
...
sectionList[2531].connect(sectionList[2491](1),0)
sectionList[2532].connect(sectionList[2531](1),0)
sectionList[2533].connect(sectionList[2491](1),0)
...
sectionList[2574].connect(sectionList[2532](1),0)
sectionList[2575].connect(sectionList[2574](1),0)
sectionList[2576].connect(sectionList[2532](1),0)
...
sectionList[2625].connect(sectionList[2575](1),0)
...
sectionList[2742].connect(sectionList[2575](1),0)

...
sectionList = [h.Section() for i in range(2849)]
...
sectionList[1821].connect(sectionList[1011](1),0)
...
sectionList[2075].connect(sectionList[2072](1),0)
...
sectionList[2136].connect(sectionList[2074](1),0)
...
sectionList[2145].connect(sectionList[2074](1),0)
...
sectionList[2331].connect(sectionList[2167](1),0)
...
sectionList[2385].connect(sectionList[2359](1),0)
...
sectionList[2422].connect(sectionList[2384](1),0)
...
sectionList[2445].connect(sectionList[2384](1),0)
...
sectionList[2456].connect(sectionList[2444](1),0)
...
sectionList[2548].connect(sectionList[2444](1),0)
...
sectionList[2605].connect(sectionList[2455](1),0)
...
sectionList[2642].connect(sectionList[2455](1),0)
...
sectionList[2653].connect(sectionList[2604](1),0)
...
sectionList[2678].connect(sectionList[2604](1),0)

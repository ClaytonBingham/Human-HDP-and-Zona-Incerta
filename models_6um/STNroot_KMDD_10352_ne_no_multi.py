...
sectionList = [h.Section() for i in range(2898)]
...
sectionList[2109].connect(sectionList[1318](1),0)
...
sectionList[2368].connect(sectionList[2365](1),0)
...
sectionList[2423].connect(sectionList[2367](1),0)
sectionList[2424].connect(sectionList[2423](1),0)
sectionList[2425].connect(sectionList[2367](1),0)
...
sectionList[2440].connect(sectionList[2424](1),0)
...
sectionList[2485].connect(sectionList[2424](1),0)
...
sectionList[2518].connect(sectionList[2515](1),0)
...
sectionList[2525].connect(sectionList[2517](1),0)
sectionList[2526].connect(sectionList[2525](1),0)
sectionList[2527].connect(sectionList[2517](1),0)
...
sectionList[2542].connect(sectionList[2526](1),0)
...
sectionList[2595].connect(sectionList[2541](1),0)
sectionList[2596].connect(sectionList[2595](1),0)
sectionList[2597].connect(sectionList[2541](1),0)
...
sectionList[2642].connect(sectionList[2596](1),0)
...
sectionList[2695].connect(sectionList[2596](1),0)

...
sectionList = [h.Section() for i in range(3016)]
...
sectionList[1935].connect(sectionList[1072](1),0)
...
sectionList[2072].connect(sectionList[2042](1),0)
...
sectionList[2079].connect(sectionList[2071](1),0)
...
sectionList[2228].connect(sectionList[2071](1),0)
...
sectionList[2251].connect(sectionList[2237](1),0)
...
sectionList[2263].connect(sectionList[2250](1),0)
sectionList[2264].connect(sectionList[2263](1),0)
sectionList[2265].connect(sectionList[2250](1),0)
...
sectionList[2320].connect(sectionList[2264](1),0)
...
sectionList[2335].connect(sectionList[2264](1),0)
...
sectionList[2382].connect(sectionList[2319](1),0)
...
sectionList[2691].connect(sectionList[2319](1),0)
...
sectionList[2874].connect(sectionList[2381](1),0)
...
sectionList[2941].connect(sectionList[2381](1),0)
...
sectionList[2965].connect(sectionList[2949](1),0)
...
sectionList[2974].connect(sectionList[2964](1),0)
...
sectionList[3009].connect(sectionList[2964](1),0)

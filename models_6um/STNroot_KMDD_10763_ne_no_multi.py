...
sectionList = [h.Section() for i in range(2771)]
...
sectionList[1948].connect(sectionList[1161](1),0)
...
sectionList[2099].connect(sectionList[2096](1),0)
...
sectionList[2142].connect(sectionList[2098](1),0)
...
sectionList[2185].connect(sectionList[2098](1),0)
...
sectionList[2204].connect(sectionList[2184](1),0)
sectionList[2205].connect(sectionList[2204](1),0)
sectionList[2206].connect(sectionList[2184](1),0)
...
sectionList[2239].connect(sectionList[2205](1),0)
...
sectionList[2258].connect(sectionList[2205](1),0)
...
sectionList[2321].connect(sectionList[2203](1),0)
...
sectionList[2348].connect(sectionList[2203](1),0)
...
sectionList[2355].connect(sectionList[2257](1),0)
...
sectionList[2400].connect(sectionList[2257](1),0)
...
sectionList[2408].connect(sectionList[2354](1),0)
...
sectionList[2427].connect(sectionList[2354](1),0)
...
sectionList[2442].connect(sectionList[2407](1),0)
...
sectionList[2484].connect(sectionList[2407](1),0)
...
sectionList[2529].connect(sectionList[2441](1),0)
...
sectionList[2542].connect(sectionList[2441](1),0)
...
sectionList[2596].connect(sectionList[2560](1),0)
...
sectionList[2654].connect(sectionList[2610](1),0)
...
sectionList[2707].connect(sectionList[2669](1),0)

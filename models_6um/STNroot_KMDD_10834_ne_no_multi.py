...
sectionList = [h.Section() for i in range(2651)]
...
sectionList[1918].connect(sectionList[1084](1),0)
...
sectionList[2000].connect(sectionList[1997](1),0)
...
sectionList[2131].connect(sectionList[1999](1),0)
...
sectionList[2154].connect(sectionList[1999](1),0)
...
sectionList[2179].connect(sectionList[2176](1),0)
...
sectionList[2214].connect(sectionList[2178](1),0)
sectionList[2215].connect(sectionList[2214](1),0)
sectionList[2216].connect(sectionList[2178](1),0)
...
sectionList[2235].connect(sectionList[2215](1),0)
...
sectionList[2255].connect(sectionList[2215](1),0)
...
sectionList[2280].connect(sectionList[2213](1),0)
sectionList[2281].connect(sectionList[2280](1),0)
sectionList[2282].connect(sectionList[2213](1),0)
...
sectionList[2541].connect(sectionList[2281](1),0)
sectionList[2542].connect(sectionList[2541](1),0)
sectionList[2543].connect(sectionList[2281](1),0)
...
sectionList[2554].connect(sectionList[2542](1),0)
...
sectionList[2587].connect(sectionList[2542](1),0)
...
sectionList[2626].connect(sectionList[2623](1),0)
...
sectionList[2635].connect(sectionList[2625](1),0)
...
sectionList[2642].connect(sectionList[2625](1),0)

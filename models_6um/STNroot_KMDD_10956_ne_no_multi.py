...
sectionList = [h.Section() for i in range(2975)]
...
sectionList[1894].connect(sectionList[1012](1),0)
...
sectionList[2114].connect(sectionList[2111](1),0)
...
sectionList[2159].connect(sectionList[2113](1),0)
sectionList[2160].connect(sectionList[2159](1),0)
sectionList[2161].connect(sectionList[2113](1),0)
...
sectionList[2214].connect(sectionList[2160](1),0)
...
sectionList[2273].connect(sectionList[2213](1),0)
sectionList[2274].connect(sectionList[2273](1),0)
sectionList[2275].connect(sectionList[2213](1),0)
...
sectionList[2344].connect(sectionList[2274](1),0)
...
sectionList[2491].connect(sectionList[2274](1),0)
...
sectionList[2537].connect(sectionList[2343](1),0)
...
sectionList[2562].connect(sectionList[2343](1),0)
...
sectionList[2579].connect(sectionList[2536](1),0)
...
sectionList[2672].connect(sectionList[2536](1),0)
...
sectionList[2707].connect(sectionList[2578](1),0)
...
sectionList[2812].connect(sectionList[2578](1),0)

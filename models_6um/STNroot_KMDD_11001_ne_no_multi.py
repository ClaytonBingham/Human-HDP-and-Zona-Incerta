...
sectionList = [h.Section() for i in range(2869)]
...
sectionList[2074].connect(sectionList[1234](1),0)
...
sectionList[2428].connect(sectionList[2124](1),0)
...
sectionList[2558].connect(sectionList[2452](1),0)
...
sectionList[2680].connect(sectionList[2594](1),0)

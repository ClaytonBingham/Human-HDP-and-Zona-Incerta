...
sectionList = [h.Section() for i in range(3181)]
...
sectionList[1983].connect(sectionList[1120](1),0)
...
sectionList[2652].connect(sectionList[2376](1),0)
...
sectionList[2956].connect(sectionList[2662](1),0)

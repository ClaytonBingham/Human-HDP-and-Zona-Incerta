...
sectionList = [h.Section() for i in range(2963)]
...
sectionList[1911].connect(sectionList[1041](1),0)
...
sectionList[2397].connect(sectionList[2039](1),0)
...
sectionList[2415].connect(sectionList[2412](1),0)
...
sectionList[2424].connect(sectionList[2414](1),0)
sectionList[2425].connect(sectionList[2424](1),0)
sectionList[2426].connect(sectionList[2414](1),0)
...
sectionList[2441].connect(sectionList[2425](1),0)
sectionList[2442].connect(sectionList[2441](1),0)
sectionList[2443].connect(sectionList[2425](1),0)
...
sectionList[2452].connect(sectionList[2442](1),0)
sectionList[2453].connect(sectionList[2452](1),0)
sectionList[2454].connect(sectionList[2442](1),0)
...
sectionList[2465].connect(sectionList[2453](1),0)
sectionList[2466].connect(sectionList[2465](1),0)
sectionList[2467].connect(sectionList[2453](1),0)
...
sectionList[2482].connect(sectionList[2466](1),0)
sectionList[2483].connect(sectionList[2482](1),0)
sectionList[2484].connect(sectionList[2466](1),0)
...
sectionList[2503].connect(sectionList[2483](1),0)
...
sectionList[2520].connect(sectionList[2483](1),0)
...
sectionList[2718].connect(sectionList[2534](1),0)
...
sectionList[2936].connect(sectionList[2748](1),0)

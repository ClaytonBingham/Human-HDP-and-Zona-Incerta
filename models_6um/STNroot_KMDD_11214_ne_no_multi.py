...
sectionList = [h.Section() for i in range(3180)]
...
sectionList[1810].connect(sectionList[1006](1),0)
...
sectionList[2091].connect(sectionList[2088](1),0)
...
sectionList[2473].connect(sectionList[2090](1),0)
...
sectionList[2598].connect(sectionList[2090](1),0)
...
sectionList[2676].connect(sectionList[2597](1),0)
...
sectionList[3095].connect(sectionList[2597](1),0)

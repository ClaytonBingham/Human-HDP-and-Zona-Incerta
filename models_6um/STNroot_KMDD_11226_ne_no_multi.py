...
sectionList = [h.Section() for i in range(3198)]
...
sectionList[1895].connect(sectionList[1090](1),0)
...
sectionList[2201].connect(sectionList[2029](1),0)
...
sectionList[2469].connect(sectionList[2283](1),0)
...
sectionList[2520].connect(sectionList[2517](1),0)
...
sectionList[2731].connect(sectionList[2519](1),0)
sectionList[2732].connect(sectionList[2731](1),0)
sectionList[2733].connect(sectionList[2519](1),0)
...
sectionList[2741].connect(sectionList[2732](1),0)
...
sectionList[3028].connect(sectionList[2732](1),0)

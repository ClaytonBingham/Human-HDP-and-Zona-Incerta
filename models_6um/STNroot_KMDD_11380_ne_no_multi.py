...
sectionList = [h.Section() for i in range(3110)]
...
sectionList[877].connect(sectionList[874](1),0)
...
sectionList[1734].connect(sectionList[876](1),0)
...
sectionList[2031].connect(sectionList[876](1),0)
...
sectionList[2466].connect(sectionList[2459](1),0)
...
sectionList[2493].connect(sectionList[2465](1),0)
...
sectionList[2578].connect(sectionList[2465](1),0)
...
sectionList[2706].connect(sectionList[2492](1),0)
...
sectionList[2757].connect(sectionList[2492](1),0)
...
sectionList[2790].connect(sectionList[2705](1),0)
...
sectionList[2833].connect(sectionList[2705](1),0)
...
sectionList[2878].connect(sectionList[2832](1),0)
...
sectionList[2905].connect(sectionList[2832](1),0)
...
sectionList[3087].connect(sectionList[2945](1),0)

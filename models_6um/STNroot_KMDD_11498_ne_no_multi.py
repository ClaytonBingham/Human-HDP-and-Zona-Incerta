...
sectionList = [h.Section() for i in range(2906)]
...
sectionList[1840].connect(sectionList[1001](1),0)
...
sectionList[1877].connect(sectionList[1874](1),0)
...
sectionList[2388].connect(sectionList[1876](1),0)
sectionList[2389].connect(sectionList[2388](1),0)
sectionList[2390].connect(sectionList[1876](1),0)
sectionList[2391].connect(sectionList[2390](1),0)
sectionList[2392].connect(sectionList[2391](1),0)
sectionList[2393].connect(sectionList[2389](1),0)
sectionList[2394].connect(sectionList[2393](1),0)
sectionList[2395].connect(sectionList[2389](1),0)
...
sectionList[2405].connect(sectionList[2394](1),0)
sectionList[2406].connect(sectionList[2405](1),0)
sectionList[2407].connect(sectionList[2394](1),0)
...
sectionList[2418].connect(sectionList[2406](1),0)
...
sectionList[2457].connect(sectionList[2406](1),0)
...
sectionList[2503].connect(sectionList[2500](1),0)
...
sectionList[2696].connect(sectionList[2502](1),0)
sectionList[2697].connect(sectionList[2696](1),0)
sectionList[2698].connect(sectionList[2502](1),0)
...
sectionList[2727].connect(sectionList[2697](1),0)
...
sectionList[2748].connect(sectionList[2697](1),0)
...
sectionList[2769].connect(sectionList[2766](1),0)
...
sectionList[2794].connect(sectionList[2768](1),0)
...
sectionList[2841].connect(sectionList[2768](1),0)

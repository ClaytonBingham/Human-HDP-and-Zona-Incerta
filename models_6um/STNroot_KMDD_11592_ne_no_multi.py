...
sectionList = [h.Section() for i in range(2873)]
...
sectionList[1069].connect(sectionList[1066](1),0)
...
sectionList[1924].connect(sectionList[1068](1),0)
...
sectionList[1979].connect(sectionList[1068](1),0)
...
sectionList[2080].connect(sectionList[1978](1),0)
...
sectionList[2338].connect(sectionList[1978](1),0)

...
sectionList = [h.Section() for i in range(2814)]
...
sectionList[1881].connect(sectionList[1024](1),0)
...
sectionList[2068].connect(sectionList[2065](1),0)
...
sectionList[2151].connect(sectionList[2067](1),0)
...
sectionList[2177].connect(sectionList[2067](1),0)
...
sectionList[2198].connect(sectionList[2176](1),0)
sectionList[2199].connect(sectionList[2198](1),0)
sectionList[2200].connect(sectionList[2176](1),0)
...
sectionList[2233].connect(sectionList[2199](1),0)
sectionList[2234].connect(sectionList[2233](1),0)
sectionList[2235].connect(sectionList[2199](1),0)
...
sectionList[2250].connect(sectionList[2234](1),0)
...
sectionList[2323].connect(sectionList[2234](1),0)
...
sectionList[2334].connect(sectionList[2197](1),0)
...
sectionList[2365].connect(sectionList[2197](1),0)
...
sectionList[2402].connect(sectionList[2249](1),0)
...
sectionList[2421].connect(sectionList[2249](1),0)
...
sectionList[2436].connect(sectionList[2333](1),0)
...
sectionList[2622].connect(sectionList[2333](1),0)

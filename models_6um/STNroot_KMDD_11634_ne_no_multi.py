...
sectionList = [h.Section() for i in range(3005)]
...
sectionList[2122].connect(sectionList[1264](1),0)
...
sectionList[2177].connect(sectionList[2174](1),0)
...
sectionList[2418].connect(sectionList[2176](1),0)
sectionList[2419].connect(sectionList[2418](1),0)
sectionList[2420].connect(sectionList[2176](1),0)
...
sectionList[2434].connect(sectionList[2419](1),0)
...
sectionList[2467].connect(sectionList[2435](1),0)
sectionList[2468].connect(sectionList[2467](1),0)
sectionList[2469].connect(sectionList[2435](1),0)
...
sectionList[2494].connect(sectionList[2468](1),0)
sectionList[2495].connect(sectionList[2494](1),0)
sectionList[2496].connect(sectionList[2468](1),0)
...
sectionList[2523].connect(sectionList[2495](1),0)
sectionList[2524].connect(sectionList[2523](1),0)
sectionList[2525].connect(sectionList[2495](1),0)
...
sectionList[2554].connect(sectionList[2524](1),0)
sectionList[2555].connect(sectionList[2554](1),0)
sectionList[2556].connect(sectionList[2524](1),0)
...
sectionList[2585].connect(sectionList[2555](1),0)
sectionList[2586].connect(sectionList[2585](1),0)
sectionList[2587].connect(sectionList[2555](1),0)
...
sectionList[2616].connect(sectionList[2586](1),0)
sectionList[2617].connect(sectionList[2616](1),0)
sectionList[2618].connect(sectionList[2586](1),0)
...
sectionList[2648].connect(sectionList[2617](1),0)
sectionList[2649].connect(sectionList[2648](1),0)
sectionList[2650].connect(sectionList[2617](1),0)
...
sectionList[2683].connect(sectionList[2649](1),0)
...
sectionList[2716].connect(sectionList[2649](1),0)

...
sectionList = [h.Section() for i in range(3137)]
...
sectionList[1238].connect(sectionList[1235](1),0)
...
sectionList[2077].connect(sectionList[1237](1),0)
...
sectionList[2908].connect(sectionList[1237](1),0)

...
sectionList = [h.Section() for i in range(2666)]
...
sectionList[1780].connect(sectionList[916](1),0)
...
sectionList[2032].connect(sectionList[2020](1),0)
sectionList[2033].connect(sectionList[2032](1),0)
sectionList[2034].connect(sectionList[2020](1),0)
...
sectionList[2049].connect(sectionList[2033](1),0)
...
sectionList[2062].connect(sectionList[2033](1),0)
...
sectionList[2069].connect(sectionList[2066](1),0)
...
sectionList[2079].connect(sectionList[2068](1),0)
...
sectionList[2094].connect(sectionList[2073](1),0)
...
sectionList[2131].connect(sectionList[2073](1),0)
...
sectionList[2194].connect(sectionList[2078](1),0)
sectionList[2195].connect(sectionList[2194](1),0)
sectionList[2196].connect(sectionList[2078](1),0)
...
sectionList[2249].connect(sectionList[2195](1),0)
sectionList[2250].connect(sectionList[2249](1),0)
sectionList[2251].connect(sectionList[2195](1),0)
...
sectionList[2266].connect(sectionList[2250](1),0)
sectionList[2267].connect(sectionList[2266](1),0)
sectionList[2268].connect(sectionList[2250](1),0)
...
sectionList[2301].connect(sectionList[2267](1),0)
...
sectionList[2388].connect(sectionList[2267](1),0)
...
sectionList[2469].connect(sectionList[2300](1),0)
...
sectionList[2621].connect(sectionList[2300](1),0)

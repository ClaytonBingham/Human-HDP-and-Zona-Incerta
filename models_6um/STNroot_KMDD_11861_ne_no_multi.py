...
sectionList = [h.Section() for i in range(3240)]
...
sectionList[1991].connect(sectionList[1186](1),0)
...
sectionList[2034].connect(sectionList[2031](1),0)
...
sectionList[2545].connect(sectionList[2033](1),0)
...
sectionList[2566].connect(sectionList[2033](1),0)
...
sectionList[2716].connect(sectionList[2580](1),0)
...
sectionList[2729].connect(sectionList[2726](1),0)
...
sectionList[2878].connect(sectionList[2728](1),0)
sectionList[2879].connect(sectionList[2878](1),0)
sectionList[2880].connect(sectionList[2728](1),0)
...
sectionList[2901].connect(sectionList[2879](1),0)
...
sectionList[2926].connect(sectionList[2879](1),0)
...
sectionList[2977].connect(sectionList[2943](1),0)
...
sectionList[3027].connect(sectionList[3003](1),0)

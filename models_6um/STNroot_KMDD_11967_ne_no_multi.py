...
sectionList = [h.Section() for i in range(2639)]
...
sectionList[1966].connect(sectionList[1168](1),0)
...
sectionList[2030].connect(sectionList[2027](1),0)
...
sectionList[2065].connect(sectionList[2029](1),0)
...
sectionList[2081].connect(sectionList[2029](1),0)
...
sectionList[2110].connect(sectionList[2064](1),0)
...
sectionList[2161].connect(sectionList[2064](1),0)
...
sectionList[2264].connect(sectionList[2261](1),0)
...
sectionList[2314].connect(sectionList[2263](1),0)
sectionList[2315].connect(sectionList[2314](1),0)
sectionList[2316].connect(sectionList[2263](1),0)
...
sectionList[2329].connect(sectionList[2315](1),0)
...
sectionList[2350].connect(sectionList[2315](1),0)
...
sectionList[2470].connect(sectionList[2368](1),0)
...
sectionList[2506].connect(sectionList[2474](1),0)

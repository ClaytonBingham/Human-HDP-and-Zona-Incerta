...
sectionList = [h.Section() for i in range(3155)]
...
sectionList[931].connect(sectionList[928](1),0)
...
sectionList[1740].connect(sectionList[930](1),0)
sectionList[1741].connect(sectionList[1740](1),0)
sectionList[1742].connect(sectionList[930](1),0)
...
sectionList[1919].connect(sectionList[1741](1),0)
...
sectionList[2104].connect(sectionList[1741](1),0)
...
sectionList[2614].connect(sectionList[2292](1),0)
...
sectionList[2684].connect(sectionList[2656](1),0)
...
sectionList[3084].connect(sectionList[2720](1),0)

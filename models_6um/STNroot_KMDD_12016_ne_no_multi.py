...
sectionList = [h.Section() for i in range(2720)]
...
sectionList[1889].connect(sectionList[1067](1),0)
...
sectionList[2058].connect(sectionList[2055](1),0)
...
sectionList[2205].connect(sectionList[2057](1),0)
sectionList[2206].connect(sectionList[2205](1),0)
sectionList[2207].connect(sectionList[2057](1),0)
...
sectionList[2286].connect(sectionList[2206](1),0)
sectionList[2287].connect(sectionList[2286](1),0)
sectionList[2288].connect(sectionList[2206](1),0)
...
sectionList[2347].connect(sectionList[2287](1),0)
...
sectionList[2388].connect(sectionList[2287](1),0)
...
sectionList[2444].connect(sectionList[2387](1),0)
sectionList[2445].connect(sectionList[2444](1),0)
sectionList[2446].connect(sectionList[2387](1),0)
...
sectionList[2463].connect(sectionList[2445](1),0)
sectionList[2464].connect(sectionList[2463](1),0)
sectionList[2465].connect(sectionList[2445](1),0)
...
sectionList[2479].connect(sectionList[2464](1),0)
...
sectionList[2500].connect(sectionList[2464](1),0)

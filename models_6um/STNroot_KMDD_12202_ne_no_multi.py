...
sectionList = [h.Section() for i in range(3066)]
...
sectionList[2038].connect(sectionList[1276](1),0)
...
sectionList[2136].connect(sectionList[2068](1),0)
...
sectionList[2206].connect(sectionList[2135](1),0)
...
sectionList[2215].connect(sectionList[2135](1),0)
...
sectionList[2228].connect(sectionList[2205](1),0)
...
sectionList[2566].connect(sectionList[2205](1),0)
...
sectionList[2921].connect(sectionList[2214](1),0)
...
sectionList[3056].connect(sectionList[2214](1),0)

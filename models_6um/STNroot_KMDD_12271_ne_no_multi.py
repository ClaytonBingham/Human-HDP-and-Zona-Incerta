...
sectionList = [h.Section() for i in range(2867)]
...
sectionList[1075].connect(sectionList[1072](1),0)
...
sectionList[1901].connect(sectionList[1074](1),0)
...
sectionList[2080].connect(sectionList[1074](1),0)
...
sectionList[2323].connect(sectionList[2079](1),0)
...
sectionList[2338].connect(sectionList[2079](1),0)
...
sectionList[2660].connect(sectionList[2354](1),0)

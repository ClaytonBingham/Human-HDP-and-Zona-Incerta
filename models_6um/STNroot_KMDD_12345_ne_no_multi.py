...
sectionList[1883].connect(sectionList[1025](1),0)
...
sectionList[2163].connect(sectionList[2009](1),0)
...
sectionList[2198].connect(sectionList[2195](1),0)
...
sectionList[2215].connect(sectionList[2197](1),0)
...
sectionList[2228].connect(sectionList[2197](1),0)
...
sectionList[2245].connect(sectionList[2214](1),0)
sectionList[2246].connect(sectionList[2245](1),0)
sectionList[2247].connect(sectionList[2214](1),0)
...
sectionList[2266].connect(sectionList[2246](1),0)
...
sectionList[2275].connect(sectionList[2265](1),0)
...
sectionList[2388].connect(sectionList[2265](1),0)
...
sectionList[2406].connect(sectionList[2403](1),0)
...
sectionList[2511].connect(sectionList[2405](1),0)
...
sectionList[2520].connect(sectionList[2405](1),0)
...
sectionList[2645].connect(sectionList[2530](1),0)

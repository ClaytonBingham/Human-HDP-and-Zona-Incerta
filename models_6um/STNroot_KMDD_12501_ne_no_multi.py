...
sectionList = [h.Section() for i in range(2721)]
...
sectionList[1900].connect(sectionList[1072](1),0)
...
sectionList[1980].connect(sectionList[1977](1),0)
...
sectionList[2185].connect(sectionList[1979](1),0)
sectionList[2186].connect(sectionList[2185](1),0)
sectionList[2187].connect(sectionList[1979](1),0)
...
sectionList[2243].connect(sectionList[2215](1),0)
...
sectionList[2278].connect(sectionList[2215](1),0)
...
sectionList[2305].connect(sectionList[2302](1),0)
...
sectionList[2326].connect(sectionList[2304](1),0)
sectionList[2327].connect(sectionList[2326](1),0)
sectionList[2328].connect(sectionList[2304](1),0)
...
sectionList[2338].connect(sectionList[2327](1),0)
sectionList[2339].connect(sectionList[2338](1),0)
sectionList[2340].connect(sectionList[2327](1),0)
...
sectionList[2351].connect(sectionList[2339](1),0)
sectionList[2352].connect(sectionList[2351](1),0)
sectionList[2353].connect(sectionList[2339](1),0)
...
sectionList[2360].connect(sectionList[2352](1),0)
sectionList[2361].connect(sectionList[2360](1),0)
sectionList[2362].connect(sectionList[2352](1),0)
...
sectionList[2393].connect(sectionList[2361](1),0)
...
sectionList[2670].connect(sectionList[2361](1),0)

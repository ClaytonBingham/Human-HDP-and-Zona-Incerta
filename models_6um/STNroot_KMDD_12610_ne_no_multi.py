...
sectionList = [h.Section() for i in range(2950)]
...
sectionList[1907].connect(sectionList[1078](1),0)
...
sectionList[2098].connect(sectionList[2095](1),0)
...
sectionList[2123].connect(sectionList[2097](1),0)
sectionList[2124].connect(sectionList[2123](1),0)
sectionList[2125].connect(sectionList[2097](1),0)
...
sectionList[2145].connect(sectionList[2124](1),0)
sectionList[2146].connect(sectionList[2145](1),0)
sectionList[2147].connect(sectionList[2124](1),0)
...
sectionList[2172].connect(sectionList[2146](1),0)
sectionList[2173].connect(sectionList[2172](1),0)
sectionList[2174].connect(sectionList[2146](1),0)
...
sectionList[2199].connect(sectionList[2173](1),0)
sectionList[2200].connect(sectionList[2199](1),0)
sectionList[2201].connect(sectionList[2173](1),0)
...
sectionList[2228].connect(sectionList[2200](1),0)
sectionList[2229].connect(sectionList[2228](1),0)
sectionList[2230].connect(sectionList[2200](1),0)
...
sectionList[2258].connect(sectionList[2229](1),0)
sectionList[2259].connect(sectionList[2258](1),0)
sectionList[2260].connect(sectionList[2229](1),0)
...
sectionList[2289].connect(sectionList[2259](1),0)
sectionList[2290].connect(sectionList[2289](1),0)
sectionList[2291].connect(sectionList[2259](1),0)
...
sectionList[2319].connect(sectionList[2290](1),0)
...
sectionList[2352].connect(sectionList[2290](1),0)
...
sectionList[2430].connect(sectionList[2427](1),0)
...
sectionList[2455].connect(sectionList[2429](1),0)
...
sectionList[2472].connect(sectionList[2456](1),0)
sectionList[2473].connect(sectionList[2472](1),0)
sectionList[2474].connect(sectionList[2456](1),0)
...
sectionList[2489].connect(sectionList[2473](1),0)
sectionList[2490].connect(sectionList[2489](1),0)
sectionList[2491].connect(sectionList[2473](1),0)
...
sectionList[2505].connect(sectionList[2490](1),0)
sectionList[2506].connect(sectionList[2505](1),0)
sectionList[2507].connect(sectionList[2490](1),0)
...
sectionList[2530].connect(sectionList[2506](1),0)
sectionList[2531].connect(sectionList[2530](1),0)
sectionList[2532].connect(sectionList[2506](1),0)
...
sectionList[2581].connect(sectionList[2531](1),0)
sectionList[2582].connect(sectionList[2581](1),0)
sectionList[2583].connect(sectionList[2531](1),0)
...
sectionList[2620].connect(sectionList[2582](1),0)
...
sectionList[2672].connect(sectionList[2582](1),0)
...
sectionList[2723].connect(sectionList[2454](1),0)
sectionList[2724].connect(sectionList[2723](1),0)
sectionList[2725].connect(sectionList[2454](1),0)
...
sectionList[2734].connect(sectionList[2724](1),0)
sectionList[2735].connect(sectionList[2734](1),0)
sectionList[2736].connect(sectionList[2724](1),0)
...
sectionList[2748].connect(sectionList[2735](1),0)
...
sectionList[2767].connect(sectionList[2735](1),0)
...
sectionList[2782].connect(sectionList[2747](1),0)
sectionList[2783].connect(sectionList[2782](1),0)
sectionList[2784].connect(sectionList[2747](1),0)
...
sectionList[2797].connect(sectionList[2783](1),0)
...
sectionList[2801].connect(sectionList[2783](1),0)
...
sectionList[2806].connect(sectionList[2803](1),0)
...
sectionList[2849].connect(sectionList[2805](1),0)
sectionList[2850].connect(sectionList[2849](1),0)
sectionList[2851].connect(sectionList[2805](1),0)
...
sectionList[2890].connect(sectionList[2850](1),0)
...
sectionList[2919].connect(sectionList[2850](1),0)

...
sectionList = [h.Section() for i in range(2872)]
...
sectionList[1935].connect(sectionList[1113](1),0)
...
sectionList[2055].connect(sectionList[2052](1),0)
...
sectionList[2092].connect(sectionList[2054](1),0)
...
sectionList[2109].connect(sectionList[2054](1),0)
...
sectionList[2141].connect(sectionList[2123](1),0)
...
sectionList[2238].connect(sectionList[2123](1),0)
...
sectionList[2305].connect(sectionList[2237](1),0)
...
sectionList[2366].connect(sectionList[2237](1),0)
...
sectionList[2438].connect(sectionList[2406](1),0)
...
sectionList[2511].connect(sectionList[2465](1),0)
...
sectionList[2628].connect(sectionList[2510](1),0)
...
sectionList[2839].connect(sectionList[2510](1),0)

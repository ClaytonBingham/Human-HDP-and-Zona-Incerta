...
sectionList = [h.Section() for i in range(2855)]
...
sectionList[1894].connect(sectionList[1030](1),0)
...
sectionList[2147].connect(sectionList[2125](1),0)
...
sectionList[2191].connect(sectionList[2125](1),0)
...
sectionList[2216].connect(sectionList[2146](1),0)
...
sectionList[2450].connect(sectionList[2146](1),0)
...
sectionList[2653].connect(sectionList[2215](1),0)
sectionList[2654].connect(sectionList[2653](1),0)
sectionList[2655].connect(sectionList[2215](1),0)
...
sectionList[2759].connect(sectionList[2654](1),0)
...
sectionList[2796].connect(sectionList[2654](1),0)

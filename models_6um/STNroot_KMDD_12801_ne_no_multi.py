...
sectionList = [h.Section() for i in range(2821)]
...
sectionList[889].connect(sectionList[886](1),0)
...
sectionList[1692].connect(sectionList[888](1),0)
sectionList[1693].connect(sectionList[1692](1),0)
sectionList[1694].connect(sectionList[888](1),0)
...
sectionList[1819].connect(sectionList[1693](1),0)
sectionList[1820].connect(sectionList[1819](1),0)
sectionList[1821].connect(sectionList[1693](1),0)
...
sectionList[2102].connect(sectionList[1820](1),0)
...
sectionList[2369].connect(sectionList[1820](1),0)

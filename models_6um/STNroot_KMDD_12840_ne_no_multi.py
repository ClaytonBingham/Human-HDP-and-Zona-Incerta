...
sectionList = [h.Section() for i in range(2669)]
...
sectionList[2356].connect(sectionList[2070](1),0)
...
sectionList[2379].connect(sectionList[2376](1),0)
...
sectionList[2424].connect(sectionList[2378](1),0)
...
sectionList[2439].connect(sectionList[2378](1),0)
...
sectionList[2452].connect(sectionList[2423](1),0)
sectionList[2453].connect(sectionList[2452](1),0)
sectionList[2454].connect(sectionList[2423](1),0)
...
sectionList[2489].connect(sectionList[2453](1),0)
...
sectionList[2598].connect(sectionList[2453](1),0)

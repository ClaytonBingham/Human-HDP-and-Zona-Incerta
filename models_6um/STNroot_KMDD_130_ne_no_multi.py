...
sectionList = [h.Section() for i in range(3730)]
...
sectionList[1057].connect(sectionList[1054](1),0)
...
sectionList[1866].connect(sectionList[1056](1),0)
sectionList[1867].connect(sectionList[1866](1),0)
sectionList[1868].connect(sectionList[1056](1),0)
...
sectionList[2187].connect(sectionList[1867](1),0)
...
sectionList[2506].connect(sectionList[1867](1),0)
...
sectionList[3036].connect(sectionList[2838](1),0)
...
sectionList[3232].connect(sectionList[3058](1),0)
...
sectionList[3275].connect(sectionList[3238](1),0)
...
sectionList[3383].connect(sectionList[3333](1),0)
...
sectionList[3412].connect(sectionList[3382](1),0)
...
sectionList[3445].connect(sectionList[3382](1),0)
...
sectionList[3513].connect(sectionList[3475](1),0)
...
sectionList[3601].connect(sectionList[3565](1),0)

...
sectionList = [h.Section() for i in range(2719)]
...
sectionList[1727].connect(sectionList[887](1),0)
...
sectionList[1937].connect(sectionList[1833](1),0)
...
sectionList[1976].connect(sectionList[1973](1),0)
...
sectionList[1991].connect(sectionList[1975](1),0)
sectionList[1992].connect(sectionList[1991](1),0)
sectionList[1993].connect(sectionList[1975](1),0)
...
sectionList[2015].connect(sectionList[1992](1),0)
sectionList[2016].connect(sectionList[2015](1),0)
sectionList[2017].connect(sectionList[1992](1),0)
...
sectionList[2034].connect(sectionList[2016](1),0)
sectionList[2035].connect(sectionList[2034](1),0)
sectionList[2036].connect(sectionList[2016](1),0)
...
sectionList[2051].connect(sectionList[2035](1),0)
...
sectionList[2068].connect(sectionList[2035](1),0)
...
sectionList[2341].connect(sectionList[2067](1),0)
...
sectionList[2644].connect(sectionList[2067](1),0)
...
sectionList[2702].connect(sectionList[2658](1),0)

...
sectionList = [h.Section() for i in range(2799)]
...
sectionList[1780].connect(sectionList[952](1),0)
...
sectionList[1819].connect(sectionList[1816](1),0)
...
sectionList[2005].connect(sectionList[1818](1),0)
sectionList[2006].connect(sectionList[2005](1),0)
sectionList[2007].connect(sectionList[1818](1),0)
...
sectionList[2024].connect(sectionList[2006](1),0)
sectionList[2025].connect(sectionList[2024](1),0)
sectionList[2026].connect(sectionList[2006](1),0)
...
sectionList[2031].connect(sectionList[2025](1),0)
sectionList[2032].connect(sectionList[2031](1),0)
sectionList[2033].connect(sectionList[2025](1),0)
...
sectionList[2048].connect(sectionList[2032](1),0)
...
sectionList[2075].connect(sectionList[2032](1),0)
...
sectionList[2098].connect(sectionList[2047](1),0)
sectionList[2099].connect(sectionList[2098](1),0)
sectionList[2100].connect(sectionList[2047](1),0)
...
sectionList[2177].connect(sectionList[2099](1),0)
sectionList[2178].connect(sectionList[2177](1),0)
sectionList[2179].connect(sectionList[2099](1),0)
...
sectionList[2194].connect(sectionList[2178](1),0)
sectionList[2195].connect(sectionList[2194](1),0)
sectionList[2196].connect(sectionList[2178](1),0)
...
sectionList[2224].connect(sectionList[2195](1),0)
sectionList[2225].connect(sectionList[2224](1),0)
sectionList[2226].connect(sectionList[2195](1),0)
...
sectionList[2249].connect(sectionList[2225](1),0)
...
sectionList[2634].connect(sectionList[2225](1),0)

...
sectionList = [h.Section() for i in range(3144)]
...
sectionList[1381].connect(sectionList[1378](1),0)
...
sectionList[2172].connect(sectionList[1380](1),0)
...
sectionList[2345].connect(sectionList[1380](1),0)
...
sectionList[2372].connect(sectionList[2369](1),0)
...
sectionList[2467].connect(sectionList[2371](1),0)
...
sectionList[2484].connect(sectionList[2371](1),0)
...
sectionList[2771].connect(sectionList[2483](1),0)
sectionList[2772].connect(sectionList[2771](1),0)
sectionList[2773].connect(sectionList[2483](1),0)
...
sectionList[2797].connect(sectionList[2772](1),0)
...
sectionList[2842].connect(sectionList[2772](1),0)
...
sectionList[2871].connect(sectionList[2856](1),0)
...
sectionList[2888].connect(sectionList[2870](1),0)
sectionList[2889].connect(sectionList[2888](1),0)
sectionList[2890].connect(sectionList[2870](1),0)
...
sectionList[2929].connect(sectionList[2889](1),0)
sectionList[2930].connect(sectionList[2929](1),0)
sectionList[2931].connect(sectionList[2889](1),0)
...
sectionList[2946].connect(sectionList[2930](1),0)
...
sectionList[2962].connect(sectionList[2930](1),0)
...
sectionList[3034].connect(sectionList[2966](1),0)
...
sectionList[3097].connect(sectionList[3040](1),0)

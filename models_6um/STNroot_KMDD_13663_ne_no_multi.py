...
sectionList = [h.Section() for i in range(2803)]
...
sectionList[1930].connect(sectionList[1090](1),0)
...
sectionList[2129].connect(sectionList[2064](1),0)
...
sectionList[2152].connect(sectionList[2149](1),0)
...
sectionList[2373].connect(sectionList[2151](1),0)
sectionList[2374].connect(sectionList[2373](1),0)
sectionList[2375].connect(sectionList[2151](1),0)
...
sectionList[2394].connect(sectionList[2374](1),0)
sectionList[2395].connect(sectionList[2394](1),0)
sectionList[2396].connect(sectionList[2374](1),0)
...
sectionList[2421].connect(sectionList[2395](1),0)
...
sectionList[2451].connect(sectionList[2395](1),0)
...
sectionList[2504].connect(sectionList[2501](1),0)
...
sectionList[2511].connect(sectionList[2503](1),0)
sectionList[2512].connect(sectionList[2511](1),0)
sectionList[2513].connect(sectionList[2503](1),0)
...
sectionList[2518].connect(sectionList[2512](1),0)
sectionList[2519].connect(sectionList[2518](1),0)
sectionList[2520].connect(sectionList[2512](1),0)
...
sectionList[2530].connect(sectionList[2519](1),0)
sectionList[2531].connect(sectionList[2530](1),0)
sectionList[2532].connect(sectionList[2519](1),0)
...
sectionList[2541].connect(sectionList[2531](1),0)
...
sectionList[2552].connect(sectionList[2531](1),0)
...
sectionList[2581].connect(sectionList[2551](1),0)
...
sectionList[2638].connect(sectionList[2551](1),0)

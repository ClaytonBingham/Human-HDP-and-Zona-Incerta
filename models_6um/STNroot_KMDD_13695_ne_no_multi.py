...
sectionList = [h.Section() for i in range(2746)]
...
sectionList[1996].connect(sectionList[1168](1),0)
...
sectionList[2128].connect(sectionList[2125](1),0)
...
sectionList[2212].connect(sectionList[2127](1),0)
...
sectionList[2219].connect(sectionList[2127](1),0)
...
sectionList[2228].connect(sectionList[2225](1),0)
...
sectionList[2249].connect(sectionList[2227](1),0)
sectionList[2250].connect(sectionList[2249](1),0)
sectionList[2251].connect(sectionList[2227](1),0)
...
sectionList[2260].connect(sectionList[2250](1),0)
...
sectionList[2283].connect(sectionList[2250](1),0)
...
sectionList[2326].connect(sectionList[2323](1),0)
...
sectionList[2357].connect(sectionList[2325](1),0)
...
sectionList[2392].connect(sectionList[2325](1),0)
...
sectionList[2465].connect(sectionList[2462](1),0)
...
sectionList[2568].connect(sectionList[2464](1),0)
sectionList[2569].connect(sectionList[2568](1),0)
sectionList[2570].connect(sectionList[2464](1),0)
...
sectionList[2591].connect(sectionList[2569](1),0)
sectionList[2592].connect(sectionList[2591](1),0)
sectionList[2593].connect(sectionList[2569](1),0)
...
sectionList[2628].connect(sectionList[2592](1),0)
sectionList[2629].connect(sectionList[2628](1),0)
sectionList[2630].connect(sectionList[2592](1),0)
...
sectionList[2669].connect(sectionList[2629](1),0)
...
sectionList[2706].connect(sectionList[2629](1),0)

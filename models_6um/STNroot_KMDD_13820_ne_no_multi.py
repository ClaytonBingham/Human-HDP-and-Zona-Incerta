...
sectionList = [h.Section() for i in range(3036)]
...
sectionList[1905].connect(sectionList[1077](1),0)
...
sectionList[2170].connect(sectionList[2040](1),0)
...
sectionList[2202].connect(sectionList[2199](1),0)
...
sectionList[2522].connect(sectionList[2201](1),0)
...
sectionList[2543].connect(sectionList[2201](1),0)
...
sectionList[2558].connect(sectionList[2555](1),0)
...
sectionList[2565].connect(sectionList[2557](1),0)
sectionList[2566].connect(sectionList[2565](1),0)
sectionList[2567].connect(sectionList[2557](1),0)
...
sectionList[2583].connect(sectionList[2566](1),0)
...
sectionList[2600].connect(sectionList[2566](1),0)
...
sectionList[2630].connect(sectionList[2610](1),0)
...
sectionList[2672].connect(sectionList[2638](1),0)
sectionList[2673].connect(sectionList[2672](1),0)
sectionList[2674].connect(sectionList[2638](1),0)
...
sectionList[2683].connect(sectionList[2673](1),0)
sectionList[2684].connect(sectionList[2683](1),0)
sectionList[2685].connect(sectionList[2673](1),0)
...
sectionList[2692].connect(sectionList[2684](1),0)
sectionList[2693].connect(sectionList[2692](1),0)
sectionList[2694].connect(sectionList[2684](1),0)
...
sectionList[2713].connect(sectionList[2693](1),0)
sectionList[2714].connect(sectionList[2713](1),0)
sectionList[2715].connect(sectionList[2693](1),0)
...
sectionList[2744].connect(sectionList[2714](1),0)
...
sectionList[2843].connect(sectionList[2714](1),0)

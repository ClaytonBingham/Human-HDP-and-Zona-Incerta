...
sectionList = [h.Section() for i in range(2789)]
...
sectionList[913].connect(sectionList[910](1),0)
...
sectionList[1740].connect(sectionList[912](1),0)
...
sectionList[1793].connect(sectionList[912](1),0)
...
sectionList[1870].connect(sectionList[1792](1),0)
sectionList[1871].connect(sectionList[1870](1),0)
sectionList[1872].connect(sectionList[1792](1),0)
...
sectionList[2275].connect(sectionList[1871](1),0)
...
sectionList[2303].connect(sectionList[1871](1),0)
...
sectionList[2343].connect(sectionList[2340](1),0)
...
sectionList[2581].connect(sectionList[2342](1),0)
...
sectionList[2636].connect(sectionList[2342](1),0)
...
sectionList[2651].connect(sectionList[2648](1),0)
...
sectionList[2690].connect(sectionList[2650](1),0)
sectionList[2691].connect(sectionList[2690](1),0)
sectionList[2692].connect(sectionList[2650](1),0)
...
sectionList[2717].connect(sectionList[2691](1),0)
...
sectionList[2746].connect(sectionList[2691](1),0)

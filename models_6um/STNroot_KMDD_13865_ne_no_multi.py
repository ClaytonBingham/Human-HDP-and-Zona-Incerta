...
sectionList = [h.Section() for i in range(2816)]
...
sectionList[1953].connect(sectionList[1102](1),0)
...
sectionList[2061].connect(sectionList[2058](1),0)
...
sectionList[2242].connect(sectionList[2060](1),0)
sectionList[2243].connect(sectionList[2242](1),0)
sectionList[2244].connect(sectionList[2060](1),0)
...
sectionList[2748].connect(sectionList[2243](1),0)
...
sectionList[2779].connect(sectionList[2243](1),0)

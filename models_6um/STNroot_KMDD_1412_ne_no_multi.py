...
sectionList = [h.Section() for i in range(3685)]
...
sectionList[1757].connect(sectionList[958](1),0)
...
sectionList[1905].connect(sectionList[1845](1),0)
...
sectionList[1942].connect(sectionList[1904](1),0)
...
sectionList[2096].connect(sectionList[1904](1),0)
...
sectionList[2108].connect(sectionList[1941](1),0)
...
sectionList[2129].connect(sectionList[1941](1),0)
...
sectionList[2162].connect(sectionList[2107](1),0)
...
sectionList[2195].connect(sectionList[2107](1),0)
...
sectionList[2232].connect(sectionList[2128](1),0)
...
sectionList[2443].connect(sectionList[2128](1),0)
...
sectionList[2482].connect(sectionList[2231](1),0)
sectionList[2483].connect(sectionList[2482](1),0)
sectionList[2484].connect(sectionList[2231](1),0)
...
sectionList[2494].connect(sectionList[2483](1),0)
...
sectionList[2513].connect(sectionList[2483](1),0)
...
sectionList[2572].connect(sectionList[2481](1),0)
...
sectionList[2796].connect(sectionList[2481](1),0)
...
sectionList[3238].connect(sectionList[2806](1),0)
...
sectionList[3385].connect(sectionList[2493](1),0)
...
sectionList[3542].connect(sectionList[2493](1),0)

...
sectionList = [h.Section() for i in range(2988)]
...
sectionList[1919].connect(sectionList[1066](1),0)
...
sectionList[2045].connect(sectionList[2015](1),0)
...
sectionList[2135].connect(sectionList[2079](1),0)
...
sectionList[2226].connect(sectionList[2223](1),0)
...
sectionList[2273].connect(sectionList[2225](1),0)
...
sectionList[2295].connect(sectionList[2225](1),0)
...
sectionList[2330].connect(sectionList[2272](1),0)
sectionList[2331].connect(sectionList[2330](1),0)
sectionList[2332].connect(sectionList[2272](1),0)
...
sectionList[2384].connect(sectionList[2331](1),0)
sectionList[2385].connect(sectionList[2384](1),0)
sectionList[2386].connect(sectionList[2331](1),0)
...
sectionList[2405].connect(sectionList[2385](1),0)
sectionList[2406].connect(sectionList[2405](1),0)
sectionList[2407].connect(sectionList[2385](1),0)
...
sectionList[2454].connect(sectionList[2406](1),0)
...
sectionList[2501].connect(sectionList[2406](1),0)
...
sectionList[2566].connect(sectionList[2383](1),0)
...
sectionList[2727].connect(sectionList[2383](1),0)
...
sectionList[2975].connect(sectionList[2749](1),0)

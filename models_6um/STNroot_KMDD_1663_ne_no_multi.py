...
sectionList = [h.Section() for i in range(3561)]
...
sectionList[1099].connect(sectionList[1096](1),0)
...
sectionList[1908].connect(sectionList[1098](1),0)
sectionList[1909].connect(sectionList[1908](1),0)
sectionList[1910].connect(sectionList[1098](1),0)
...
sectionList[2097].connect(sectionList[1909](1),0)
sectionList[2098].connect(sectionList[2097](1),0)
sectionList[2099].connect(sectionList[1909](1),0)
...
sectionList[2288].connect(sectionList[2098](1),0)
...
sectionList[2485].connect(sectionList[2098](1),0)
...
sectionList[2692].connect(sectionList[2287](1),0)
sectionList[2693].connect(sectionList[2692](1),0)
sectionList[2694].connect(sectionList[2287](1),0)
...
sectionList[2739].connect(sectionList[2693](1),0)
...
sectionList[2766].connect(sectionList[2693](1),0)
...
sectionList[3021].connect(sectionList[2691](1),0)
sectionList[3022].connect(sectionList[3021](1),0)
sectionList[3023].connect(sectionList[2691](1),0)
...
sectionList[3344].connect(sectionList[3022](1),0)
...
sectionList[3373].connect(sectionList[3022](1),0)

...
sectionList = [h.Section() for i in range(4491)]
...
sectionList[1845].connect(sectionList[987](1),0)
...
sectionList[1996].connect(sectionList[1966](1),0)
...
sectionList[2011].connect(sectionList[1995](1),0)
...
sectionList[2562].connect(sectionList[1995](1),0)
...
sectionList[3118].connect(sectionList[2590](1),0)
...
sectionList[3692].connect(sectionList[3142](1),0)
...
sectionList[3755].connect(sectionList[3752](1),0)
...
sectionList[4216].connect(sectionList[3754](1),0)
sectionList[4217].connect(sectionList[4216](1),0)
sectionList[4218].connect(sectionList[3754](1),0)
...
sectionList[4241].connect(sectionList[4217](1),0)
...
sectionList[4280].connect(sectionList[4217](1),0)

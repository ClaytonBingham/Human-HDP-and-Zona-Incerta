...
sectionList = [h.Section() for i in range(2547)]
...
sectionList[1879].connect(sectionList[1876](1),0)
...
sectionList[2020].connect(sectionList[1878](1),0)
...
sectionList[2208].connect(sectionList[1878](1),0)

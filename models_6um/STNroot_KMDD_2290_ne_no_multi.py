...
sectionList = [h.Section() for i in range(2728)]
...
sectionList[873].connect(sectionList[870](1),0)
...
sectionList[1694].connect(sectionList[872](1),0)
...
sectionList[1936].connect(sectionList[872](1),0)
...
sectionList[2583].connect(sectionList[2080](1),0)
...
sectionList[2683].connect(sectionList[2619](1),0)

...
sectionList = [h.Section() for i in range(2833)]
...
sectionList[2576].connect(sectionList[2056](1),0)
...
sectionList[2601].connect(sectionList[2598](1),0)
...
sectionList[2638].connect(sectionList[2600](1),0)
sectionList[2639].connect(sectionList[2638](1),0)
sectionList[2640].connect(sectionList[2600](1),0)
...
sectionList[2689].connect(sectionList[2639](1),0)
...
sectionList[2730].connect(sectionList[2639](1),0)

...
sectionList = [h.Section() for i in range(2838)]
...
sectionList[1164].connect(sectionList[1161](1),0)
...
sectionList[1985].connect(sectionList[1163](1),0)
...
sectionList[2092].connect(sectionList[1163](1),0)
...
sectionList[2371].connect(sectionList[2227](1),0)
sectionList[2372].connect(sectionList[2371](1),0)
sectionList[2373].connect(sectionList[2227](1),0)
...
sectionList[2396].connect(sectionList[2372](1),0)
sectionList[2397].connect(sectionList[2396](1),0)
sectionList[2398].connect(sectionList[2372](1),0)
...
sectionList[2428].connect(sectionList[2397](1),0)
...
sectionList[2633].connect(sectionList[2397](1),0)
...
sectionList[2684].connect(sectionList[2681](1),0)
...
sectionList[2708].connect(sectionList[2683](1),0)
sectionList[2709].connect(sectionList[2708](1),0)
sectionList[2710].connect(sectionList[2683](1),0)
...
sectionList[2720].connect(sectionList[2709](1),0)
sectionList[2721].connect(sectionList[2720](1),0)
sectionList[2722].connect(sectionList[2709](1),0)
...
sectionList[2773].connect(sectionList[2721](1),0)
...
sectionList[2801].connect(sectionList[2721](1),0)

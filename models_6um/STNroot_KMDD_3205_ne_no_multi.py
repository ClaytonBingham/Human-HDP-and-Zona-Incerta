...
sectionList = [h.Section() for i in range(3304)]
...
sectionList[1864].connect(sectionList[1036](1),0)
...
sectionList[2257].connect(sectionList[2254](1),0)
...
sectionList[2374].connect(sectionList[2256](1),0)
...
sectionList[2425].connect(sectionList[2256](1),0)
...
sectionList[2458].connect(sectionList[2424](1),0)
...
sectionList[2568].connect(sectionList[2424](1),0)
...
sectionList[2631].connect(sectionList[2457](1),0)
...
sectionList[2654].connect(sectionList[2457](1),0)
...
sectionList[2690].connect(sectionList[2630](1),0)
...
sectionList[2765].connect(sectionList[2653](1),0)
...
sectionList[2826].connect(sectionList[2653](1),0)
...
sectionList[2899].connect(sectionList[2674](1),0)
...
sectionList[3045].connect(sectionList[2674](1),0)

...
sectionList = [h.Section() for i in range(2945)]
...
sectionList[1923].connect(sectionList[1125](1),0)
...
sectionList[2070].connect(sectionList[2037](1),0)
...
sectionList[2086].connect(sectionList[2069](1),0)
sectionList[2087].connect(sectionList[2086](1),0)
sectionList[2088].connect(sectionList[2069](1),0)
...
sectionList[2153].connect(sectionList[2087](1),0)
sectionList[2154].connect(sectionList[2153](1),0)
sectionList[2155].connect(sectionList[2087](1),0)
...
sectionList[2174].connect(sectionList[2154](1),0)
sectionList[2175].connect(sectionList[2174](1),0)
sectionList[2176].connect(sectionList[2154](1),0)
...
sectionList[2201].connect(sectionList[2175](1),0)
...
sectionList[2240].connect(sectionList[2175](1),0)
...
sectionList[2303].connect(sectionList[2152](1),0)
...
sectionList[2336].connect(sectionList[2152](1),0)
...
sectionList[2349].connect(sectionList[2239](1),0)
...
sectionList[2402].connect(sectionList[2239](1),0)
...
sectionList[2425].connect(sectionList[2401](1),0)
...
sectionList[2632].connect(sectionList[2401](1),0)
...
sectionList[2665].connect(sectionList[2424](1),0)
...
sectionList[2722].connect(sectionList[2424](1),0)
...
sectionList[2743].connect(sectionList[2664](1),0)
...
sectionList[2782].connect(sectionList[2664](1),0)
...
sectionList[2837].connect(sectionList[2721](1),0)
...
sectionList[2914].connect(sectionList[2721](1),0)

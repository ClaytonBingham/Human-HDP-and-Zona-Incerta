...
sectionList = [h.Section() for i in range(2626)]
...
sectionList[1918].connect(sectionList[1066](1),0)
...
sectionList[1985].connect(sectionList[1982](1),0)
...
sectionList[2497].connect(sectionList[1984](1),0)
sectionList[2498].connect(sectionList[2497](1),0)
sectionList[2499].connect(sectionList[1984](1),0)
...
sectionList[2524].connect(sectionList[2498](1),0)
...
sectionList[2579].connect(sectionList[2498](1),0)

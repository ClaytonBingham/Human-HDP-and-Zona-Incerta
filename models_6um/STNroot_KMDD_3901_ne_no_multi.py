...
sectionList = [h.Section() for i in range(2711)]
...
sectionList[1928].connect(sectionList[1089](1),0)
...
sectionList[2039].connect(sectionList[2036](1),0)
...
sectionList[2532].connect(sectionList[2038](1),0)
...
sectionList[2557].connect(sectionList[2038](1),0)
...
sectionList[2584].connect(sectionList[2581](1),0)
...
sectionList[2609].connect(sectionList[2583](1),0)
sectionList[2610].connect(sectionList[2609](1),0)
sectionList[2611].connect(sectionList[2583](1),0)
...
sectionList[2629].connect(sectionList[2610](1),0)
...
sectionList[2658].connect(sectionList[2610](1),0)

...
sectionList = [h.Section() for i in range(4660)]
...
sectionList[2327].connect(sectionList[1504](1),0)
...
sectionList[2614].connect(sectionList[2556](1),0)
...
sectionList[2639].connect(sectionList[2636](1),0)
...
sectionList[3010].connect(sectionList[2638](1),0)
sectionList[3011].connect(sectionList[3010](1),0)
sectionList[3012].connect(sectionList[2638](1),0)
...
sectionList[3048].connect(sectionList[3011](1),0)
...
sectionList[3087].connect(sectionList[3011](1),0)
...
sectionList[3138].connect(sectionList[3086](1),0)
...
sectionList[3255].connect(sectionList[3086](1),0)
...
sectionList[3290].connect(sectionList[3287](1),0)
...
sectionList[3587].connect(sectionList[3289](1),0)
...
sectionList[3670].connect(sectionList[3289](1),0)
...
sectionList[3705].connect(sectionList[3669](1),0)
...
sectionList[3952].connect(sectionList[3669](1),0)
...
sectionList[3971].connect(sectionList[3704](1),0)
sectionList[3972].connect(sectionList[3971](1),0)
sectionList[3973].connect(sectionList[3704](1),0)
...
sectionList[4354].connect(sectionList[3972](1),0)
...
sectionList[4441].connect(sectionList[3972](1),0)
...
sectionList[4505].connect(sectionList[4491](1),0)
...
sectionList[4581].connect(sectionList[4537](1),0)
...
sectionList[4625].connect(sectionList[4585](1),0)

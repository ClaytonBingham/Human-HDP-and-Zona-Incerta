...
sectionList = [h.Section() for i in range(2916)]
...
sectionList[1749].connect(sectionList[916](1),0)
...
sectionList[1952].connect(sectionList[1949](1),0)
...
sectionList[2005].connect(sectionList[1951](1),0)
...
sectionList[2042].connect(sectionList[1951](1),0)
...
sectionList[2239].connect(sectionList[2041](1),0)
sectionList[2240].connect(sectionList[2239](1),0)
sectionList[2241].connect(sectionList[2041](1),0)
...
sectionList[2616].connect(sectionList[2240](1),0)
...
sectionList[2783].connect(sectionList[2240](1),0)

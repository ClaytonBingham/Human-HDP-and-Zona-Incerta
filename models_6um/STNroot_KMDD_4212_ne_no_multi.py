...
sectionList = [h.Section() for i in range(3165)]
...
sectionList[1321].connect(sectionList[1318](1),0)
...
sectionList[2178].connect(sectionList[1320](1),0)
...
sectionList[2269].connect(sectionList[1320](1),0)
...
sectionList[2632].connect(sectionList[2268](1),0)
sectionList[2633].connect(sectionList[2632](1),0)
sectionList[2634].connect(sectionList[2268](1),0)
...
sectionList[3069].connect(sectionList[2633](1),0)
...
sectionList[3098].connect(sectionList[2633](1),0)

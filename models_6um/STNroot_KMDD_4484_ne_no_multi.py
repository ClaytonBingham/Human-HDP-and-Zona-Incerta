...
sectionList = [h.Section() for i in range(4226)]
...
sectionList[949].connect(sectionList[946](1),0)
...
sectionList[1806].connect(sectionList[948](1),0)
...
sectionList[1877].connect(sectionList[948](1),0)
...
sectionList[1950].connect(sectionList[1876](1),0)
...
sectionList[2243].connect(sectionList[1876](1),0)
...
sectionList[2778].connect(sectionList[1949](1),0)
sectionList[2779].connect(sectionList[2778](1),0)
sectionList[2780].connect(sectionList[1949](1),0)
...
sectionList[3081].connect(sectionList[2779](1),0)
sectionList[3082].connect(sectionList[3081](1),0)
sectionList[3083].connect(sectionList[2779](1),0)
...
sectionList[3142].connect(sectionList[3082](1),0)
...
sectionList[3201].connect(sectionList[3082](1),0)
...
sectionList[3275].connect(sectionList[3255](1),0)
...
sectionList[3496].connect(sectionList[3274](1),0)
...
sectionList[4171].connect(sectionList[3274](1),0)

...
sectionList = [h.Section() for i in range(2878)]
...
sectionList[2056].connect(sectionList[1204](1),0)
...
sectionList[2291].connect(sectionList[2288](1),0)
...
sectionList[2398].connect(sectionList[2290](1),0)
sectionList[2399].connect(sectionList[2398](1),0)
sectionList[2400].connect(sectionList[2290](1),0)
...
sectionList[2417].connect(sectionList[2399](1),0)
...
sectionList[2487].connect(sectionList[2399](1),0)

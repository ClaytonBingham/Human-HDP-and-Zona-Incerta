...
sectionList = [h.Section() for i in range(4038)]
...
sectionList[1924].connect(sectionList[1048](1),0)
...
sectionList[2546].connect(sectionList[2287](1),0)
...
sectionList[2660].connect(sectionList[2606](1),0)
...
sectionList[2699].connect(sectionList[2659](1),0)
...
sectionList[2750].connect(sectionList[2659](1),0)
...
sectionList[2831].connect(sectionList[2698](1),0)
sectionList[2832].connect(sectionList[2831](1),0)
sectionList[2833].connect(sectionList[2698](1),0)
...
sectionList[2884].connect(sectionList[2832](1),0)
...
sectionList[3089].connect(sectionList[2832](1),0)
...
sectionList[3116].connect(sectionList[2830](1),0)
...
sectionList[3235].connect(sectionList[2830](1),0)
...
sectionList[3342].connect(sectionList[3115](1),0)
...
sectionList[3429].connect(sectionList[3115](1),0)
...
sectionList[3476].connect(sectionList[3341](1),0)
...
sectionList[3597].connect(sectionList[3341](1),0)
...
sectionList[3923].connect(sectionList[3639](1),0)

...
sectionList = [h.Section() for i in range(2736)]
...
sectionList[1984].connect(sectionList[1162](1),0)
...
sectionList[2041].connect(sectionList[2038](1),0)
...
sectionList[2662].connect(sectionList[2040](1),0)
...
sectionList[2699].connect(sectionList[2040](1),0)

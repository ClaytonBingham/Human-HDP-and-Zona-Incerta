...
sectionList = [h.Section() for i in range(2475)]
...
sectionList[1726].connect(sectionList[886](1),0)
...
sectionList[1908].connect(sectionList[1856](1),0)
...
sectionList[2029].connect(sectionList[2026](1),0)
...
sectionList[2140].connect(sectionList[2028](1),0)
...
sectionList[2159].connect(sectionList[2028](1),0)
...
sectionList[2206].connect(sectionList[2180](1),0)
...
sectionList[2236].connect(sectionList[2232](1),0)

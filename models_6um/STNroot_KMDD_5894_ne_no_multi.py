...
sectionList = [h.Section() for i in range(3112)]
...
sectionList[1997].connect(sectionList[1150](1),0)
...
sectionList[2280].connect(sectionList[2277](1),0)
...
sectionList[2537].connect(sectionList[2279](1),0)
...
sectionList[2566].connect(sectionList[2279](1),0)
...
sectionList[2611].connect(sectionList[2565](1),0)
sectionList[2612].connect(sectionList[2611](1),0)
sectionList[2613].connect(sectionList[2565](1),0)
...
sectionList[2634].connect(sectionList[2612](1),0)
...
sectionList[2649].connect(sectionList[2612](1),0)
...
sectionList[2682].connect(sectionList[2648](1),0)
sectionList[2683].connect(sectionList[2682](1),0)
sectionList[2684].connect(sectionList[2648](1),0)
...
sectionList[2749].connect(sectionList[2683](1),0)
sectionList[2750].connect(sectionList[2749](1),0)
sectionList[2751].connect(sectionList[2683](1),0)
...
sectionList[2777].connect(sectionList[2750](1),0)
sectionList[2778].connect(sectionList[2777](1),0)
sectionList[2779].connect(sectionList[2750](1),0)
...
sectionList[2810].connect(sectionList[2778](1),0)
sectionList[2811].connect(sectionList[2810](1),0)
sectionList[2812].connect(sectionList[2778](1),0)
...
sectionList[2837].connect(sectionList[2811](1),0)
...
sectionList[2881].connect(sectionList[2811](1),0)
...
sectionList[2982].connect(sectionList[2836](1),0)
sectionList[2983].connect(sectionList[2982](1),0)
sectionList[2984].connect(sectionList[2836](1),0)
...
sectionList[2993].connect(sectionList[2983](1),0)
sectionList[2994].connect(sectionList[2993](1),0)
sectionList[2995].connect(sectionList[2983](1),0)
...
sectionList[3008].connect(sectionList[2994](1),0)
...
sectionList[3065].connect(sectionList[2994](1),0)

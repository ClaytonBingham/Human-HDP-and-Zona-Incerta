...
sectionList = [h.Section() for i in range(2837)]
...
sectionList[1768].connect(sectionList[946](1),0)
...
sectionList[1947].connect(sectionList[1944](1),0)
...
sectionList[1980].connect(sectionList[1946](1),0)
...
sectionList[2150].connect(sectionList[1946](1),0)
...
sectionList[2191].connect(sectionList[2188](1),0)
...
sectionList[2214].connect(sectionList[2190](1),0)
...
sectionList[2247].connect(sectionList[2190](1),0)
...
sectionList[2266].connect(sectionList[2213](1),0)
...
sectionList[2341].connect(sectionList[2213](1),0)
...
sectionList[2368].connect(sectionList[2265](1),0)
...
sectionList[2418].connect(sectionList[2265](1),0)
...
sectionList[2493].connect(sectionList[2367](1),0)
...
sectionList[2620].connect(sectionList[2367](1),0)
...
sectionList[2641].connect(sectionList[2417](1),0)
...
sectionList[2720].connect(sectionList[2417](1),0)

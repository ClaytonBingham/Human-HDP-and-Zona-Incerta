...
sectionList = [h.Section() for i in range(2794)]
...
sectionList[1990].connect(sectionList[1144](1),0)
...
sectionList[2086].connect(sectionList[2083](1),0)
...
sectionList[2149].connect(sectionList[2085](1),0)
...
sectionList[2186].connect(sectionList[2085](1),0)
...
sectionList[2215].connect(sectionList[2212](1),0)
...
sectionList[2312].connect(sectionList[2214](1),0)
sectionList[2313].connect(sectionList[2312](1),0)
sectionList[2314].connect(sectionList[2214](1),0)
...
sectionList[2341].connect(sectionList[2313](1),0)
sectionList[2342].connect(sectionList[2341](1),0)
sectionList[2343].connect(sectionList[2313](1),0)
...
sectionList[2396].connect(sectionList[2342](1),0)
...
sectionList[2441].connect(sectionList[2342](1),0)

...
sectionList = [h.Section() for i in range(3672)]
...
sectionList[1875].connect(sectionList[1041](1),0)
...
sectionList[1972].connect(sectionList[1969](1),0)
...
sectionList[2155].connect(sectionList[1971](1),0)
...
sectionList[2174].connect(sectionList[1971](1),0)
...
sectionList[2217].connect(sectionList[2154](1),0)
...
sectionList[2374].connect(sectionList[2154](1),0)
...
sectionList[2385].connect(sectionList[2216](1),0)
...
sectionList[2576].connect(sectionList[2216](1),0)
...
sectionList[2621].connect(sectionList[2384](1),0)
...
sectionList[2806].connect(sectionList[2384](1),0)
...
sectionList[2878].connect(sectionList[2620](1),0)
...
sectionList[3118].connect(sectionList[2620](1),0)
...
sectionList[3543].connect(sectionList[3157](1),0)
...
sectionList[3657].connect(sectionList[3587](1),0)

...
sectionList = [h.Section() for i in range(2508)]
...
sectionList[1835].connect(sectionList[1037](1),0)
...
sectionList[1921].connect(sectionList[1875](1),0)
...
sectionList[2025].connect(sectionList[1999](1),0)
sectionList[2026].connect(sectionList[2025](1),0)
sectionList[2027].connect(sectionList[1999](1),0)
...
sectionList[2088].connect(sectionList[2026](1),0)
...
sectionList[2187].connect(sectionList[2026](1),0)
...
sectionList[2300].connect(sectionList[2186](1),0)
...
sectionList[2471].connect(sectionList[2186](1),0)

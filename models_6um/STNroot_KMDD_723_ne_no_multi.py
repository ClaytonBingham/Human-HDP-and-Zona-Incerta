...
sectionList = [h.Section() for i in range(3733)]
...
sectionList[1076].connect(sectionList[1073](1),0)
...
sectionList[1939].connect(sectionList[1075](1),0)
sectionList[1940].connect(sectionList[1939](1),0)
sectionList[1941].connect(sectionList[1075](1),0)
...
sectionList[2310].connect(sectionList[1940](1),0)
...
sectionList[2694].connect(sectionList[1940](1),0)
...
sectionList[3084].connect(sectionList[3081](1),0)
...
sectionList[3535].connect(sectionList[3083](1),0)
...
sectionList[3556].connect(sectionList[3083](1),0)

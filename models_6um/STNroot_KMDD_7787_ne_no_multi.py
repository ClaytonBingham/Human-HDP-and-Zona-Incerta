...
sectionList = [h.Section() for i in range(3398)]
...
sectionList[2044].connect(sectionList[1216](1),0)
...
sectionList[2300].connect(sectionList[2297](1),0)
...
sectionList[2348].connect(sectionList[2299](1),0)
sectionList[2349].connect(sectionList[2348](1),0)
sectionList[2350].connect(sectionList[2299](1),0)
...
sectionList[2381].connect(sectionList[2349](1),0)
sectionList[2382].connect(sectionList[2381](1),0)
sectionList[2383].connect(sectionList[2349](1),0)
...
sectionList[2428].connect(sectionList[2382](1),0)
sectionList[2429].connect(sectionList[2428](1),0)
sectionList[2430].connect(sectionList[2382](1),0)
...
sectionList[2457].connect(sectionList[2429](1),0)
...
sectionList[2490].connect(sectionList[2429](1),0)
...
sectionList[2594].connect(sectionList[2489](1),0)
sectionList[2595].connect(sectionList[2594](1),0)
sectionList[2596].connect(sectionList[2489](1),0)
...
sectionList[2837].connect(sectionList[2595](1),0)
sectionList[2838].connect(sectionList[2837](1),0)
sectionList[2839].connect(sectionList[2595](1),0)
...
sectionList[3056].connect(sectionList[2838](1),0)
...
sectionList[3166].connect(sectionList[2838](1),0)

...
sectionList = [h.Section() for i in range(2749)]
...
sectionList[2044].connect(sectionList[1239](1),0)
...
sectionList[2135].connect(sectionList[2132](1),0)
...
sectionList[2170].connect(sectionList[2134](1),0)
sectionList[2171].connect(sectionList[2170](1),0)
sectionList[2172].connect(sectionList[2134](1),0)
...
sectionList[2209].connect(sectionList[2171](1),0)
sectionList[2210].connect(sectionList[2209](1),0)
sectionList[2211].connect(sectionList[2171](1),0)
...
sectionList[2254].connect(sectionList[2210](1),0)
sectionList[2255].connect(sectionList[2254](1),0)
sectionList[2256].connect(sectionList[2210](1),0)
...
sectionList[2305].connect(sectionList[2255](1),0)
sectionList[2306].connect(sectionList[2305](1),0)
sectionList[2307].connect(sectionList[2255](1),0)
...
sectionList[2354].connect(sectionList[2306](1),0)
...
sectionList[2439].connect(sectionList[2306](1),0)
...
sectionList[2552].connect(sectionList[2549](1),0)
...
sectionList[2579].connect(sectionList[2551](1),0)
...
sectionList[2597].connect(sectionList[2580](1),0)
sectionList[2598].connect(sectionList[2597](1),0)
sectionList[2599].connect(sectionList[2580](1),0)
...
sectionList[2634].connect(sectionList[2598](1),0)
...
sectionList[2670].connect(sectionList[2598](1),0)

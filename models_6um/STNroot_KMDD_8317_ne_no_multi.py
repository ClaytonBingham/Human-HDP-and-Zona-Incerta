...
sectionList = [h.Section() for i in range(2937)]
...
sectionList[1978].connect(sectionList[1078](1),0)
...
sectionList[2293].connect(sectionList[2290](1),0)
...
sectionList[2312].connect(sectionList[2292](1),0)
sectionList[2313].connect(sectionList[2312](1),0)
sectionList[2314].connect(sectionList[2292](1),0)
...
sectionList[2401].connect(sectionList[2313](1),0)
...
sectionList[2429].connect(sectionList[2313](1),0)
...
sectionList[2464].connect(sectionList[2428](1),0)
...
sectionList[2649].connect(sectionList[2428](1),0)
...
sectionList[2678].connect(sectionList[2675](1),0)
...
sectionList[2703].connect(sectionList[2677](1),0)
...
sectionList[2881].connect(sectionList[2677](1),0)

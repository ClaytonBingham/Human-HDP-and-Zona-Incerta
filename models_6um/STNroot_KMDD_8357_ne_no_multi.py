...
sectionList = [h.Section() for i in range(3158)]
...
sectionList[1291].connect(sectionList[1288](1),0)
...
sectionList[2094].connect(sectionList[1290](1),0)
...
sectionList[2211].connect(sectionList[1290](1),0)
...
sectionList[2354].connect(sectionList[2318](1),0)
...
sectionList[2461].connect(sectionList[2392](1),0)
...
sectionList[2525].connect(sectionList[2489](1),0)
...
sectionList[2536].connect(sectionList[2524](1),0)
...
sectionList[2577].connect(sectionList[2524](1),0)
...
sectionList[2702].connect(sectionList[2535](1),0)
sectionList[2703].connect(sectionList[2702](1),0)
sectionList[2704].connect(sectionList[2535](1),0)
...
sectionList[2735].connect(sectionList[2703](1),0)
sectionList[2736].connect(sectionList[2735](1),0)
sectionList[2737].connect(sectionList[2703](1),0)
...
sectionList[2783].connect(sectionList[2736](1),0)
...
sectionList[2819].connect(sectionList[2736](1),0)
...
sectionList[2862].connect(sectionList[2818](1),0)
...
sectionList[2941].connect(sectionList[2818](1),0)
...
sectionList[3052].connect(sectionList[2861](1),0)
...
sectionList[3119].connect(sectionList[2861](1),0)

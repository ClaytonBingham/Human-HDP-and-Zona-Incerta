...
sectionList = [h.Section() for i in range(2871)]
...
sectionList[2098].connect(sectionList[1228](1),0)
...
sectionList[2197].connect(sectionList[2194](1),0)
...
sectionList[2362].connect(sectionList[2196](1),0)
sectionList[2363].connect(sectionList[2362](1),0)
sectionList[2364].connect(sectionList[2196](1),0)
...
sectionList[2375].connect(sectionList[2363](1),0)
...
sectionList[2400].connect(sectionList[2363](1),0)
...
sectionList[2447].connect(sectionList[2399](1),0)
sectionList[2448].connect(sectionList[2447](1),0)
sectionList[2449].connect(sectionList[2399](1),0)
...
sectionList[2666].connect(sectionList[2448](1),0)
...
sectionList[2689].connect(sectionList[2448](1),0)

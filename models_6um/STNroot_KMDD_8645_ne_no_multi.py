...
sectionList = [h.Section() for i in range(2840)]
...
sectionList[2008].connect(sectionList[1216](1),0)
...
sectionList[2140].connect(sectionList[2098](1),0)
...
sectionList[2158].connect(sectionList[2141](1),0)
sectionList[2159].connect(sectionList[2158](1),0)
sectionList[2160].connect(sectionList[2141](1),0)
...
sectionList[2179].connect(sectionList[2159](1),0)
...
sectionList[2204].connect(sectionList[2159](1),0)
...
sectionList[2235].connect(sectionList[2139](1),0)
...
sectionList[2434].connect(sectionList[2139](1),0)
...
sectionList[2495].connect(sectionList[2234](1),0)
...
sectionList[2796].connect(sectionList[2234](1),0)

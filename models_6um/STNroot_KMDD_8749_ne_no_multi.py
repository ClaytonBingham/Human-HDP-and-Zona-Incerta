...
sectionList[2199].connect(sectionList[1377](1),0)
...
sectionList[2547].connect(sectionList[2395](1),0)
...
sectionList[2582].connect(sectionList[2579](1),0)
...
sectionList[2626].connect(sectionList[2581](1),0)
...
sectionList[2674].connect(sectionList[2581](1),0)
...
sectionList[2723].connect(sectionList[2625](1),0)
...
sectionList[2812].connect(sectionList[2625](1),0)

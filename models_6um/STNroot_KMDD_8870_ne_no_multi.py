...
sectionList[1684].connect(sectionList[885](1),0)
...
sectionList[1849].connect(sectionList[1846](1),0)
...
sectionList[1867].connect(sectionList[1848](1),0)
...
sectionList[1890].connect(sectionList[1848](1),0)
...
sectionList[2006].connect(sectionList[1866](1),0)
...
sectionList[2013].connect(sectionList[1866](1),0)

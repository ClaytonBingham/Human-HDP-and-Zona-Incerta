...
sectionList = [h.Section() for i in range(3217)]
...
sectionList[1093].connect(sectionList[1090](1),0)
...
sectionList[1932].connect(sectionList[1092](1),0)
sectionList[1933].connect(sectionList[1932](1),0)
sectionList[1934].connect(sectionList[1092](1),0)
...
sectionList[2627].connect(sectionList[1933](1),0)
...
sectionList[2964].connect(sectionList[1933](1),0)

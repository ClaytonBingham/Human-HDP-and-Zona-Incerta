...
sectionList = [h.Section() for i in range(2857)]
...
sectionList[1761].connect(sectionList[940](1),0)
...
sectionList[2042].connect(sectionList[2039](1),0)
...
sectionList[2069].connect(sectionList[2041](1),0)
sectionList[2070].connect(sectionList[2069](1),0)
sectionList[2071].connect(sectionList[2041](1),0)
...
sectionList[2143].connect(sectionList[2070](1),0)
...
sectionList[2160].connect(sectionList[2070](1),0)
...
sectionList[2297].connect(sectionList[2159](1),0)
...
sectionList[2313].connect(sectionList[2159](1),0)
...
sectionList[2340].connect(sectionList[2337](1),0)
...
sectionList[2374].connect(sectionList[2339](1),0)
...
sectionList[2449].connect(sectionList[2339](1),0)
...
sectionList[2506].connect(sectionList[2448](1),0)
sectionList[2507].connect(sectionList[2506](1),0)
sectionList[2508].connect(sectionList[2448](1),0)
...
sectionList[2521].connect(sectionList[2507](1),0)
...
sectionList[2544].connect(sectionList[2507](1),0)
...
sectionList[2593].connect(sectionList[2505](1),0)
...
sectionList[2618].connect(sectionList[2505](1),0)
...
sectionList[2695].connect(sectionList[2543](1),0)
...
sectionList[2738].connect(sectionList[2543](1),0)
...
sectionList[2800].connect(sectionList[2762](1),0)

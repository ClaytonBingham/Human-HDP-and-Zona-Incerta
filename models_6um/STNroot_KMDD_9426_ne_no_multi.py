...
sectionList = [h.Section() for i in range(3064)]
...
sectionList[1015].connect(sectionList[1012](1),0)
...
sectionList[1895].connect(sectionList[1014](1),0)
sectionList[1896].connect(sectionList[1895](1),0)
sectionList[1897].connect(sectionList[1014](1),0)
...
sectionList[2065].connect(sectionList[1896](1),0)
...
sectionList[2248].connect(sectionList[1896](1),0)
...
sectionList[2498].connect(sectionList[2438](1),0)
...
sectionList[3018].connect(sectionList[2530](1),0)

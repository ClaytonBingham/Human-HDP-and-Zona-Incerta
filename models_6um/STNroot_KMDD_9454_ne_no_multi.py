...
sectionList = [h.Section() for i in range(2530)]
...
sectionList[1816].connect(sectionList[988](1),0)
...
sectionList[1903].connect(sectionList[1900](1),0)
...
sectionList[1990].connect(sectionList[1902](1),0)
sectionList[1991].connect(sectionList[1990](1),0)
sectionList[1992].connect(sectionList[1902](1),0)
...
sectionList[2106].connect(sectionList[1991](1),0)
...
sectionList[2305].connect(sectionList[2166](1),0)

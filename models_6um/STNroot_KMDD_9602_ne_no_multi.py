...
sectionList = [h.Section() for i in range(2616)]
...
sectionList[1680].connect(sectionList[796](1),0)
...
sectionList[2300].connect(sectionList[1950](1),0)
...
sectionList[2321].connect(sectionList[2318](1),0)
...
sectionList[2394].connect(sectionList[2320](1),0)
sectionList[2395].connect(sectionList[2394](1),0)
sectionList[2396].connect(sectionList[2320](1),0)
...
sectionList[2449].connect(sectionList[2395](1),0)
...
sectionList[2569].connect(sectionList[2481](1),0)

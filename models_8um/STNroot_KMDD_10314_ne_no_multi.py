...
sectionList[1186].connect(sectionList[658](1),0)
...
sectionList[1440].connect(sectionList[1437](1),0)
...
sectionList[1501].connect(sectionList[1439](1),0)
...
sectionList[1510].connect(sectionList[1439](1),0)
...
sectionList[1696].connect(sectionList[1532](1),0)
...
sectionList[1750].connect(sectionList[1724](1),0)
...
sectionList[1787].connect(sectionList[1749](1),0)
...
sectionList[1810].connect(sectionList[1749](1),0)
...
sectionList[1821].connect(sectionList[1809](1),0)
...
sectionList[1913].connect(sectionList[1809](1),0)
...
sectionList[1970].connect(sectionList[1820](1),0)
...
sectionList[2007].connect(sectionList[1820](1),0)
...
sectionList[2018].connect(sectionList[1969](1),0)
...
sectionList[2043].connect(sectionList[1969](1),0)

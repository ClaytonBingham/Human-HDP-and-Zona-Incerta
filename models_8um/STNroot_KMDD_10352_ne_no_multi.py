...
sectionList = [h.Section() for i in range(2161)]
...
sectionList[1372].connect(sectionList[856](1),0)
...
sectionList[1631].connect(sectionList[1628](1),0)
...
sectionList[1686].connect(sectionList[1630](1),0)
sectionList[1687].connect(sectionList[1686](1),0)
sectionList[1688].connect(sectionList[1630](1),0)
...
sectionList[1703].connect(sectionList[1687](1),0)
...
sectionList[1748].connect(sectionList[1687](1),0)
...
sectionList[1781].connect(sectionList[1778](1),0)
...
sectionList[1788].connect(sectionList[1780](1),0)
sectionList[1789].connect(sectionList[1788](1),0)
sectionList[1790].connect(sectionList[1780](1),0)
...
sectionList[1803].connect(sectionList[1789](1),0)
...
sectionList[1858].connect(sectionList[1804](1),0)
sectionList[1859].connect(sectionList[1858](1),0)
sectionList[1860].connect(sectionList[1804](1),0)
...
sectionList[1905].connect(sectionList[1859](1),0)
...
sectionList[1958].connect(sectionList[1859](1),0)

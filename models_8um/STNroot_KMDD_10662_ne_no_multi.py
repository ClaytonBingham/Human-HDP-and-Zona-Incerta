...
sectionList = [h.Section() for i in range(2344)]
...
sectionList[1263].connect(sectionList[700](1),0)
...
sectionList[1400].connect(sectionList[1370](1),0)
...
sectionList[1407].connect(sectionList[1399](1),0)
...
sectionList[1556].connect(sectionList[1399](1),0)
...
sectionList[1579].connect(sectionList[1565](1),0)
...
sectionList[1591].connect(sectionList[1578](1),0)
sectionList[1592].connect(sectionList[1591](1),0)
sectionList[1593].connect(sectionList[1578](1),0)
...
sectionList[1648].connect(sectionList[1592](1),0)
...
sectionList[1663].connect(sectionList[1592](1),0)
...
sectionList[1710].connect(sectionList[1647](1),0)
...
sectionList[2019].connect(sectionList[1647](1),0)
...
sectionList[2202].connect(sectionList[1709](1),0)
...
sectionList[2269].connect(sectionList[1709](1),0)
...
sectionList[2293].connect(sectionList[2277](1),0)
...
sectionList[2302].connect(sectionList[2292](1),0)
...
sectionList[2337].connect(sectionList[2292](1),0)

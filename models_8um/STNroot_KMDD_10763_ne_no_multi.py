...
sectionList = [h.Section() for i in range(2093)]
...
sectionList[1270].connect(sectionList[754](1),0)
...
sectionList[1421].connect(sectionList[1418](1),0)
...
sectionList[1464].connect(sectionList[1420](1),0)
...
sectionList[1507].connect(sectionList[1420](1),0)
...
sectionList[1526].connect(sectionList[1506](1),0)
sectionList[1527].connect(sectionList[1526](1),0)
sectionList[1528].connect(sectionList[1506](1),0)
...
sectionList[1561].connect(sectionList[1527](1),0)
...
sectionList[1580].connect(sectionList[1527](1),0)
...
sectionList[1643].connect(sectionList[1525](1),0)
...
sectionList[1670].connect(sectionList[1525](1),0)
...
sectionList[1677].connect(sectionList[1579](1),0)
...
sectionList[1722].connect(sectionList[1579](1),0)
...
sectionList[1730].connect(sectionList[1676](1),0)
...
sectionList[1749].connect(sectionList[1676](1),0)
...
sectionList[1764].connect(sectionList[1729](1),0)
...
sectionList[1806].connect(sectionList[1729](1),0)
...
sectionList[1851].connect(sectionList[1763](1),0)
...
sectionList[1864].connect(sectionList[1763](1),0)
...
sectionList[1918].connect(sectionList[1882](1),0)
...
sectionList[1976].connect(sectionList[1932](1),0)
...
sectionList[2029].connect(sectionList[1991](1),0)

...
sectionList = [h.Section() for i in range(1985)]
...
sectionList[1252].connect(sectionList[706](1),0)
...
sectionList[1334].connect(sectionList[1331](1),0)
...
sectionList[1465].connect(sectionList[1333](1),0)
...
sectionList[1488].connect(sectionList[1333](1),0)
...
sectionList[1513].connect(sectionList[1510](1),0)
...
sectionList[1548].connect(sectionList[1512](1),0)
sectionList[1549].connect(sectionList[1548](1),0)
sectionList[1550].connect(sectionList[1512](1),0)
...
sectionList[1569].connect(sectionList[1549](1),0)
...
sectionList[1589].connect(sectionList[1549](1),0)
...
sectionList[1614].connect(sectionList[1547](1),0)
sectionList[1615].connect(sectionList[1614](1),0)
sectionList[1616].connect(sectionList[1547](1),0)
...
sectionList[1875].connect(sectionList[1615](1),0)
sectionList[1876].connect(sectionList[1875](1),0)
sectionList[1877].connect(sectionList[1615](1),0)
...
sectionList[1888].connect(sectionList[1876](1),0)
...
sectionList[1921].connect(sectionList[1876](1),0)
...
sectionList[1960].connect(sectionList[1957](1),0)
...
sectionList[1969].connect(sectionList[1959](1),0)
...
sectionList[1976].connect(sectionList[1959](1),0)

...
sectionList = [h.Section() for i in range(2315)]
...
sectionList[1234].connect(sectionList[658](1),0)
...
sectionList[1454].connect(sectionList[1451](1),0)
...
sectionList[1499].connect(sectionList[1453](1),0)
sectionList[1500].connect(sectionList[1499](1),0)
sectionList[1501].connect(sectionList[1453](1),0)
...
sectionList[1552].connect(sectionList[1500](1),0)
sectionList[1553].connect(sectionList[1552](1),0)
sectionList[1554].connect(sectionList[1500](1),0)
...
sectionList[1613].connect(sectionList[1553](1),0)
sectionList[1614].connect(sectionList[1613](1),0)
sectionList[1615].connect(sectionList[1553](1),0)
...
sectionList[1684].connect(sectionList[1614](1),0)
...
sectionList[1831].connect(sectionList[1614](1),0)
...
sectionList[1877].connect(sectionList[1683](1),0)
...
sectionList[1902].connect(sectionList[1683](1),0)
...
sectionList[1919].connect(sectionList[1876](1),0)
...
sectionList[2012].connect(sectionList[1876](1),0)
...
sectionList[2047].connect(sectionList[1918](1),0)
...
sectionList[2152].connect(sectionList[1918](1),0)

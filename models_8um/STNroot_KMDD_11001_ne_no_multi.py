...
sectionList[1348].connect(sectionList[802](1),0)
...
sectionList[1702].connect(sectionList[1398](1),0)
...
sectionList[1832].connect(sectionList[1726](1),0)
...
sectionList[1954].connect(sectionList[1868](1),0)

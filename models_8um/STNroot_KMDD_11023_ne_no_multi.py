...
sectionList = [h.Section() for i in range(2491)]
...
sectionList[1293].connect(sectionList[730](1),0)
...
sectionList[1962].connect(sectionList[1686](1),0)
...
sectionList[2266].connect(sectionList[1972](1),0)

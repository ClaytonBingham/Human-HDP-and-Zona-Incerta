...
sectionList = [h.Section() for i in range(2292)]
...
sectionList[1240].connect(sectionList[676](1),0)
...
sectionList[1726].connect(sectionList[1368](1),0)
...
sectionList[1744].connect(sectionList[1741](1),0)
...
sectionList[1753].connect(sectionList[1743](1),0)
sectionList[1754].connect(sectionList[1753](1),0)
sectionList[1755].connect(sectionList[1743](1),0)
...
sectionList[1770].connect(sectionList[1754](1),0)
sectionList[1771].connect(sectionList[1770](1),0)
sectionList[1772].connect(sectionList[1754](1),0)
...
sectionList[1781].connect(sectionList[1771](1),0)
sectionList[1782].connect(sectionList[1781](1),0)
sectionList[1783].connect(sectionList[1771](1),0)
...
sectionList[1794].connect(sectionList[1782](1),0)
sectionList[1795].connect(sectionList[1794](1),0)
sectionList[1796].connect(sectionList[1782](1),0)
...
sectionList[1811].connect(sectionList[1795](1),0)
sectionList[1812].connect(sectionList[1811](1),0)
sectionList[1813].connect(sectionList[1795](1),0)
...
sectionList[1832].connect(sectionList[1812](1),0)
...
sectionList[1849].connect(sectionList[1812](1),0)
...
sectionList[2047].connect(sectionList[1863](1),0)
...
sectionList[2265].connect(sectionList[2077](1),0)

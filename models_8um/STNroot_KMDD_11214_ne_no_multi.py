...
sectionList[1179].connect(sectionList[652](1),0)
...
sectionList[1842].connect(sectionList[1459](1),0)
...
sectionList[1967].connect(sectionList[1459](1),0)
...
sectionList[2045].connect(sectionList[1966](1),0)

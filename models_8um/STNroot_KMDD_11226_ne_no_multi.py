...
sectionList = [h.Section() for i in range(2543)]
...
sectionList[1240].connect(sectionList[712](1),0)
...
sectionList[1546].connect(sectionList[1374](1),0)
...
sectionList[1814].connect(sectionList[1628](1),0)
...
sectionList[1865].connect(sectionList[1862](1),0)
...
sectionList[2076].connect(sectionList[1864](1),0)
sectionList[2077].connect(sectionList[2076](1),0)
sectionList[2078].connect(sectionList[1864](1),0)
...
sectionList[2086].connect(sectionList[2077](1),0)
...
sectionList[2373].connect(sectionList[2077](1),0)

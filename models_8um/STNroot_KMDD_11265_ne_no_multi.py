...
sectionList = [h.Section() for i in range(2523)]
...
sectionList[1210].connect(sectionList[646](1),0)
...
sectionList[1598].connect(sectionList[1588](1),0)
...
sectionList[1633].connect(sectionList[1630](1),0)
...
sectionList[1671].connect(sectionList[1632](1),0)
sectionList[1672].connect(sectionList[1671](1),0)
sectionList[1673].connect(sectionList[1632](1),0)
...
sectionList[1708].connect(sectionList[1672](1),0)
sectionList[1709].connect(sectionList[1708](1),0)
sectionList[1710].connect(sectionList[1672](1),0)
...
sectionList[1743].connect(sectionList[1709](1),0)
sectionList[1744].connect(sectionList[1743](1),0)
sectionList[1745].connect(sectionList[1709](1),0)
...
sectionList[1799].connect(sectionList[1744](1),0)
sectionList[1800].connect(sectionList[1799](1),0)
sectionList[1801].connect(sectionList[1744](1),0)
...
sectionList[1868].connect(sectionList[1800](1),0)
...
sectionList[1955].connect(sectionList[1800](1),0)
...
sectionList[2045].connect(sectionList[1742](1),0)
...
sectionList[2068].connect(sectionList[1742](1),0)
...
sectionList[2081].connect(sectionList[1867](1),0)
...
sectionList[2100].connect(sectionList[1867](1),0)
...
sectionList[2119].connect(sectionList[2080](1),0)
...
sectionList[2146].connect(sectionList[2118](1),0)
...
sectionList[2199].connect(sectionList[2118](1),0)
...
sectionList[2214].connect(sectionList[2198](1),0)
...
sectionList[2229].connect(sectionList[2198](1),0)
...
sectionList[2246].connect(sectionList[2213](1),0)
sectionList[2247].connect(sectionList[2246](1),0)
sectionList[2248].connect(sectionList[2213](1),0)
...
sectionList[2269].connect(sectionList[2247](1),0)
sectionList[2270].connect(sectionList[2269](1),0)
sectionList[2271].connect(sectionList[2247](1),0)
...
sectionList[2312].connect(sectionList[2270](1),0)
sectionList[2313].connect(sectionList[2312](1),0)
sectionList[2314].connect(sectionList[2270](1),0)
...
sectionList[2377].connect(sectionList[2313](1),0)
...
sectionList[2390].connect(sectionList[2313](1),0)
...
sectionList[2425].connect(sectionList[2245](1),0)
...
sectionList[2450].connect(sectionList[2245](1),0)
...
sectionList[2489].connect(sectionList[2389](1),0)
...
sectionList[2502].connect(sectionList[2389](1),0)

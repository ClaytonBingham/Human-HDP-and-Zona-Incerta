...
sectionList = [h.Section() for i in range(2504)]
...
sectionList[571].connect(sectionList[568](1),0)
...
sectionList[1128].connect(sectionList[570](1),0)
...
sectionList[1425].connect(sectionList[570](1),0)
...
sectionList[1860].connect(sectionList[1853](1),0)
...
sectionList[1887].connect(sectionList[1859](1),0)
...
sectionList[1972].connect(sectionList[1859](1),0)
...
sectionList[2100].connect(sectionList[1886](1),0)
...
sectionList[2151].connect(sectionList[1886](1),0)
...
sectionList[2184].connect(sectionList[2099](1),0)
...
sectionList[2227].connect(sectionList[2099](1),0)
...
sectionList[2272].connect(sectionList[2226](1),0)
...
sectionList[2299].connect(sectionList[2226](1),0)
...
sectionList[2481].connect(sectionList[2339](1),0)

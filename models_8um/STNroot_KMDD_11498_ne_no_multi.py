...
sectionList = [h.Section() for i in range(2264)]
...
sectionList[1198].connect(sectionList[652](1),0)
...
sectionList[1235].connect(sectionList[1232](1),0)
...
sectionList[1746].connect(sectionList[1234](1),0)
sectionList[1747].connect(sectionList[1746](1),0)
sectionList[1748].connect(sectionList[1234](1),0)
sectionList[1749].connect(sectionList[1748](1),0)
sectionList[1750].connect(sectionList[1749](1),0)
sectionList[1751].connect(sectionList[1747](1),0)
sectionList[1752].connect(sectionList[1751](1),0)
sectionList[1753].connect(sectionList[1747](1),0)
...
sectionList[1763].connect(sectionList[1752](1),0)
sectionList[1764].connect(sectionList[1763](1),0)
sectionList[1765].connect(sectionList[1752](1),0)
...
sectionList[1776].connect(sectionList[1764](1),0)
...
sectionList[1815].connect(sectionList[1764](1),0)
...
sectionList[1861].connect(sectionList[1858](1),0)
...
sectionList[2054].connect(sectionList[1860](1),0)
sectionList[2055].connect(sectionList[2054](1),0)
sectionList[2056].connect(sectionList[1860](1),0)
...
sectionList[2085].connect(sectionList[2055](1),0)
...
sectionList[2106].connect(sectionList[2055](1),0)
...
sectionList[2127].connect(sectionList[2124](1),0)
...
sectionList[2152].connect(sectionList[2126](1),0)
...
sectionList[2199].connect(sectionList[2126](1),0)

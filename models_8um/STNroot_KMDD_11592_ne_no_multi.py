...
sectionList = [h.Section() for i in range(2203)]
...
sectionList[697].connect(sectionList[694](1),0)
...
sectionList[1254].connect(sectionList[696](1),0)
...
sectionList[1309].connect(sectionList[696](1),0)
...
sectionList[1410].connect(sectionList[1308](1),0)
...
sectionList[1668].connect(sectionList[1308](1),0)

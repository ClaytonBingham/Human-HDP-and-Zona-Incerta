...
sectionList = [h.Section() for i in range(2155)]
...
sectionList[1222].connect(sectionList[664](1),0)
...
sectionList[1409].connect(sectionList[1406](1),0)
...
sectionList[1492].connect(sectionList[1408](1),0)
...
sectionList[1518].connect(sectionList[1408](1),0)
...
sectionList[1539].connect(sectionList[1517](1),0)
sectionList[1540].connect(sectionList[1539](1),0)
sectionList[1541].connect(sectionList[1517](1),0)
...
sectionList[1574].connect(sectionList[1540](1),0)
sectionList[1575].connect(sectionList[1574](1),0)
sectionList[1576].connect(sectionList[1540](1),0)
...
sectionList[1591].connect(sectionList[1575](1),0)
...
sectionList[1664].connect(sectionList[1575](1),0)
...
sectionList[1675].connect(sectionList[1538](1),0)
...
sectionList[1706].connect(sectionList[1538](1),0)
...
sectionList[1743].connect(sectionList[1590](1),0)
...
sectionList[1762].connect(sectionList[1590](1),0)
...
sectionList[1777].connect(sectionList[1674](1),0)
...
sectionList[1963].connect(sectionList[1674](1),0)

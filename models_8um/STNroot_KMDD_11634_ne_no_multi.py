...
sectionList = [h.Section() for i in range(2267)]
...
sectionList[1384].connect(sectionList[825](1),0)
...
sectionList[1439].connect(sectionList[1436](1),0)
...
sectionList[1680].connect(sectionList[1438](1),0)
sectionList[1681].connect(sectionList[1680](1),0)
sectionList[1682].connect(sectionList[1438](1),0)
...
sectionList[1696].connect(sectionList[1681](1),0)
sectionList[1697].connect(sectionList[1696](1),0)
sectionList[1698].connect(sectionList[1681](1),0)
...
sectionList[1729].connect(sectionList[1697](1),0)
sectionList[1730].connect(sectionList[1729](1),0)
sectionList[1731].connect(sectionList[1697](1),0)
...
sectionList[1756].connect(sectionList[1730](1),0)
sectionList[1757].connect(sectionList[1756](1),0)
sectionList[1758].connect(sectionList[1730](1),0)
...
sectionList[1785].connect(sectionList[1757](1),0)
sectionList[1786].connect(sectionList[1785](1),0)
sectionList[1787].connect(sectionList[1757](1),0)
...
sectionList[1816].connect(sectionList[1786](1),0)
sectionList[1817].connect(sectionList[1816](1),0)
sectionList[1818].connect(sectionList[1786](1),0)
...
sectionList[1847].connect(sectionList[1817](1),0)
sectionList[1848].connect(sectionList[1847](1),0)
sectionList[1849].connect(sectionList[1817](1),0)
...
sectionList[1878].connect(sectionList[1848](1),0)
sectionList[1879].connect(sectionList[1878](1),0)
sectionList[1880].connect(sectionList[1848](1),0)
...
sectionList[1910].connect(sectionList[1879](1),0)
sectionList[1911].connect(sectionList[1910](1),0)
sectionList[1912].connect(sectionList[1879](1),0)
...
sectionList[1945].connect(sectionList[1911](1),0)
...
sectionList[1978].connect(sectionList[1911](1),0)

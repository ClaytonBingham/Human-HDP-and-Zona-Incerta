...
sectionList = [h.Section() for i in range(2411)]
...
sectionList[806].connect(sectionList[803](1),0)
...
sectionList[1351].connect(sectionList[805](1),0)
...
sectionList[2182].connect(sectionList[805](1),0)

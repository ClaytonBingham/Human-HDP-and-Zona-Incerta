...
sectionList = [h.Section() for i in range(2047)]
...
sectionList[1161].connect(sectionList[597](1),0)
...
sectionList[1402].connect(sectionList[1399](1),0)
...
sectionList[1413].connect(sectionList[1401](1),0)
sectionList[1414].connect(sectionList[1413](1),0)
sectionList[1415].connect(sectionList[1401](1),0)
...
sectionList[1430].connect(sectionList[1414](1),0)
...
sectionList[1443].connect(sectionList[1414](1),0)
...
sectionList[1450].connect(sectionList[1447](1),0)
...
sectionList[1455].connect(sectionList[1449](1),0)
...
sectionList[1460].connect(sectionList[1449](1),0)
...
sectionList[1475].connect(sectionList[1454](1),0)
...
sectionList[1512].connect(sectionList[1454](1),0)
...
sectionList[1575].connect(sectionList[1459](1),0)
sectionList[1576].connect(sectionList[1575](1),0)
sectionList[1577].connect(sectionList[1459](1),0)
...
sectionList[1630].connect(sectionList[1576](1),0)
sectionList[1631].connect(sectionList[1630](1),0)
sectionList[1632].connect(sectionList[1576](1),0)
...
sectionList[1647].connect(sectionList[1631](1),0)
sectionList[1648].connect(sectionList[1647](1),0)
sectionList[1649].connect(sectionList[1631](1),0)
...
sectionList[1682].connect(sectionList[1648](1),0)
...
sectionList[1769].connect(sectionList[1648](1),0)
...
sectionList[1850].connect(sectionList[1681](1),0)
...
sectionList[2002].connect(sectionList[1681](1),0)

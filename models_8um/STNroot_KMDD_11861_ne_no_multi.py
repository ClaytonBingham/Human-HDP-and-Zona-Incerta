...
sectionList = [h.Section() for i in range(2549)]
...
sectionList[1300].connect(sectionList[772](1),0)
...
sectionList[1343].connect(sectionList[1340](1),0)
...
sectionList[1854].connect(sectionList[1342](1),0)
...
sectionList[1875].connect(sectionList[1342](1),0)
...
sectionList[2025].connect(sectionList[1889](1),0)
...
sectionList[2038].connect(sectionList[2035](1),0)
...
sectionList[2187].connect(sectionList[2037](1),0)
sectionList[2188].connect(sectionList[2187](1),0)
sectionList[2189].connect(sectionList[2037](1),0)
...
sectionList[2210].connect(sectionList[2188](1),0)
...
sectionList[2235].connect(sectionList[2188](1),0)
...
sectionList[2286].connect(sectionList[2252](1),0)
...
sectionList[2336].connect(sectionList[2312](1),0)

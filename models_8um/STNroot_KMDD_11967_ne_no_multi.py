...
sectionList = [h.Section() for i in range(1950)]
...
sectionList[1277].connect(sectionList[760](1),0)
...
sectionList[1341].connect(sectionList[1338](1),0)
...
sectionList[1376].connect(sectionList[1340](1),0)
...
sectionList[1392].connect(sectionList[1340](1),0)
...
sectionList[1421].connect(sectionList[1375](1),0)
...
sectionList[1472].connect(sectionList[1375](1),0)
...
sectionList[1575].connect(sectionList[1572](1),0)
...
sectionList[1625].connect(sectionList[1574](1),0)
sectionList[1626].connect(sectionList[1625](1),0)
sectionList[1627].connect(sectionList[1574](1),0)
...
sectionList[1661].connect(sectionList[1626](1),0)
...
sectionList[1781].connect(sectionList[1679](1),0)
...
sectionList[1817].connect(sectionList[1785](1),0)

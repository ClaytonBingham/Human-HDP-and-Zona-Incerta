...
sectionList[607].connect(sectionList[604](1),0)
...
sectionList[1134].connect(sectionList[606](1),0)
sectionList[1135].connect(sectionList[1134](1),0)
sectionList[1136].connect(sectionList[606](1),0)
...
sectionList[1313].connect(sectionList[1135](1),0)
...
sectionList[1498].connect(sectionList[1135](1),0)
...
sectionList[2008].connect(sectionList[1686](1),0)
...
sectionList[2078].connect(sectionList[2050](1),0)
...
sectionList[2478].connect(sectionList[2114](1),0)

...
sectionList = [h.Section() for i in range(2059)]
...
sectionList[1228].connect(sectionList[694](1),0)
...
sectionList[1397].connect(sectionList[1394](1),0)
...
sectionList[1544].connect(sectionList[1396](1),0)
sectionList[1545].connect(sectionList[1544](1),0)
sectionList[1546].connect(sectionList[1396](1),0)
...
sectionList[1625].connect(sectionList[1545](1),0)
sectionList[1626].connect(sectionList[1625](1),0)
sectionList[1627].connect(sectionList[1545](1),0)
...
sectionList[1686].connect(sectionList[1626](1),0)
...
sectionList[1727].connect(sectionList[1626](1),0)
...
sectionList[1783].connect(sectionList[1726](1),0)
...
sectionList[1818].connect(sectionList[1803](1),0)
...
sectionList[1839].connect(sectionList[1803](1),0)

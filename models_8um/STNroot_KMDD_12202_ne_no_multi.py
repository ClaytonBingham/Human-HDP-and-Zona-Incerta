...
sectionList = [h.Section() for i in range(2358)]
...
sectionList[1330].connect(sectionList[832](1),0)
...
sectionList[1428].connect(sectionList[1360](1),0)
...
sectionList[1498].connect(sectionList[1427](1),0)
...
sectionList[1507].connect(sectionList[1427](1),0)
...
sectionList[1520].connect(sectionList[1497](1),0)
...
sectionList[1858].connect(sectionList[1497](1),0)
...
sectionList[2213].connect(sectionList[1506](1),0)
...
sectionList[2348].connect(sectionList[1506](1),0)

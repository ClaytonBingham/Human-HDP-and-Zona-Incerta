...
sectionList = [h.Section() for i in range(2208)]
...
sectionList[1242].connect(sectionList[702](1),0)
...
sectionList[1421].connect(sectionList[702](1),0)
...
sectionList[1664].connect(sectionList[1420](1),0)
...
sectionList[1679].connect(sectionList[1420](1),0)
...
sectionList[2001].connect(sectionList[1695](1),0)

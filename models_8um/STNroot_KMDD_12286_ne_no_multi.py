...
sectionList = [h.Section() for i in range(2519)]
...
sectionList[1414].connect(sectionList[856](1),0)
...
sectionList[1606].connect(sectionList[1594](1),0)
...
sectionList[1617].connect(sectionList[1605](1),0)
...
sectionList[2000].connect(sectionList[1605](1),0)
...
sectionList[2025].connect(sectionList[1616](1),0)
...
sectionList[2118].connect(sectionList[1616](1),0)
...
sectionList[2156].connect(sectionList[2124](1),0)
...
sectionList[2169].connect(sectionList[2155](1),0)
...
sectionList[2234].connect(sectionList[2155](1),0)
sectionList[2235].connect(sectionList[2234](1),0)
sectionList[2236].connect(sectionList[2235](1),0)
sectionList[2237].connect(sectionList[2168](1),0)
sectionList[2238].connect(sectionList[2237](1),0)
sectionList[2239].connect(sectionList[2168](1),0)
...
sectionList[2252].connect(sectionList[2238](1),0)
sectionList[2253].connect(sectionList[2252](1),0)
sectionList[2254].connect(sectionList[2238](1),0)
...
sectionList[2265].connect(sectionList[2253](1),0)
...
sectionList[2276].connect(sectionList[2253](1),0)
...
sectionList[2292].connect(sectionList[2236](1),0)
...
sectionList[2331].connect(sectionList[2236](1),0)
...
sectionList[2378].connect(sectionList[2330](1),0)
...
sectionList[2391].connect(sectionList[2330](1),0)
...
sectionList[2464].connect(sectionList[2422](1),0)

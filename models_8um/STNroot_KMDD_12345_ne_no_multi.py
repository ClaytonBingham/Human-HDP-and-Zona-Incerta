...
sectionList = [h.Section() for i in range(2029)]
...
sectionList[1228].connect(sectionList[670](1),0)
...
sectionList[1508].connect(sectionList[1354](1),0)
...
sectionList[1543].connect(sectionList[1540](1),0)
...
sectionList[1560].connect(sectionList[1542](1),0)
...
sectionList[1573].connect(sectionList[1542](1),0)
...
sectionList[1599].connect(sectionList[1591](1),0)
...
sectionList[1611].connect(sectionList[1591](1),0)
...
sectionList[1620].connect(sectionList[1610](1),0)
...
sectionList[1733].connect(sectionList[1610](1),0)
...
sectionList[1751].connect(sectionList[1748](1),0)
...
sectionList[1856].connect(sectionList[1750](1),0)
...
sectionList[1865].connect(sectionList[1750](1),0)
...
sectionList[1990].connect(sectionList[1875](1),0)

...
sectionList = [h.Section() for i in range(2061)]
...
sectionList[1320].connect(sectionList[1317](1),0)
...
sectionList[1525].connect(sectionList[1319](1),0)
sectionList[1526].connect(sectionList[1525](1),0)
sectionList[1527].connect(sectionList[1319](1),0)
...
sectionList[1554].connect(sectionList[1526](1),0)
sectionList[1555].connect(sectionList[1554](1),0)
sectionList[1556].connect(sectionList[1526](1),0)
...
sectionList[1583].connect(sectionList[1555](1),0)
...
sectionList[1618].connect(sectionList[1555](1),0)
...
sectionList[1645].connect(sectionList[1642](1),0)
...
sectionList[1666].connect(sectionList[1644](1),0)
sectionList[1667].connect(sectionList[1666](1),0)
sectionList[1668].connect(sectionList[1644](1),0)
...
sectionList[1678].connect(sectionList[1667](1),0)
sectionList[1679].connect(sectionList[1678](1),0)
sectionList[1680].connect(sectionList[1667](1),0)
...
sectionList[1691].connect(sectionList[1679](1),0)
sectionList[1692].connect(sectionList[1691](1),0)
sectionList[1693].connect(sectionList[1679](1),0)
...
sectionList[1700].connect(sectionList[1692](1),0)
sectionList[1701].connect(sectionList[1700](1),0)
sectionList[1702].connect(sectionList[1692](1),0)
...
sectionList[1733].connect(sectionList[1701](1),0)
...
sectionList[2010].connect(sectionList[1701](1),0)

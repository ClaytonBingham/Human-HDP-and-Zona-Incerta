...
sectionList = [h.Section() for i in range(2813)]
...
sectionList[1350].connect(sectionList[804](1),0)
sectionList[1351].connect(sectionList[1350](1),0)
sectionList[1352].connect(sectionList[804](1),0)
...
sectionList[1511].connect(sectionList[1351](1),0)
sectionList[1512].connect(sectionList[1511](1),0)
sectionList[1513].connect(sectionList[1351](1),0)
...
sectionList[1673].connect(sectionList[1512](1),0)
sectionList[1674].connect(sectionList[1673](1),0)
sectionList[1675].connect(sectionList[1512](1),0)
...
sectionList[1836].connect(sectionList[1674](1),0)
...
sectionList[1997].connect(sectionList[1674](1),0)
...
sectionList[2162].connect(sectionList[1996](1),0)
sectionList[2163].connect(sectionList[2162](1),0)
sectionList[2164].connect(sectionList[1996](1),0)
...
sectionList[2185].connect(sectionList[2163](1),0)
...
sectionList[2250].connect(sectionList[2163](1),0)
...
sectionList[2265].connect(sectionList[2249](1),0)
sectionList[2266].connect(sectionList[2265](1),0)
sectionList[2267].connect(sectionList[2249](1),0)
...
sectionList[2284].connect(sectionList[2266](1),0)
...
sectionList[2313].connect(sectionList[2266](1),0)
...
sectionList[2341].connect(sectionList[2312](1),0)
...
sectionList[2372].connect(sectionList[2312](1),0)
...
sectionList[2386].connect(sectionList[2380](1),0)
...
sectionList[2401].connect(sectionList[2398](1),0)
...
sectionList[2640].connect(sectionList[2400](1),0)
sectionList[2641].connect(sectionList[2640](1),0)
sectionList[2642].connect(sectionList[2400](1),0)
...
sectionList[2667].connect(sectionList[2641](1),0)
sectionList[2668].connect(sectionList[2667](1),0)
sectionList[2669].connect(sectionList[2641](1),0)
...
sectionList[2703].connect(sectionList[2668](1),0)
...
sectionList[2744].connect(sectionList[2668](1),0)

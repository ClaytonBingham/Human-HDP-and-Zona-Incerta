...
sectionList = [h.Section() for i in range(2283)]
...
sectionList[1240].connect(sectionList[700](1),0)
...
sectionList[1431].connect(sectionList[1428](1),0)
...
sectionList[1456].connect(sectionList[1430](1),0)
sectionList[1457].connect(sectionList[1456](1),0)
sectionList[1458].connect(sectionList[1430](1),0)
...
sectionList[1478].connect(sectionList[1457](1),0)
sectionList[1479].connect(sectionList[1478](1),0)
sectionList[1480].connect(sectionList[1457](1),0)
...
sectionList[1505].connect(sectionList[1479](1),0)
sectionList[1506].connect(sectionList[1505](1),0)
sectionList[1507].connect(sectionList[1479](1),0)
...
sectionList[1532].connect(sectionList[1506](1),0)
sectionList[1533].connect(sectionList[1532](1),0)
sectionList[1534].connect(sectionList[1506](1),0)
...
sectionList[1561].connect(sectionList[1533](1),0)
sectionList[1562].connect(sectionList[1561](1),0)
sectionList[1563].connect(sectionList[1533](1),0)
...
sectionList[1591].connect(sectionList[1562](1),0)
sectionList[1592].connect(sectionList[1591](1),0)
sectionList[1593].connect(sectionList[1562](1),0)
...
sectionList[1622].connect(sectionList[1592](1),0)
sectionList[1623].connect(sectionList[1622](1),0)
sectionList[1624].connect(sectionList[1592](1),0)
...
sectionList[1652].connect(sectionList[1623](1),0)
...
sectionList[1685].connect(sectionList[1623](1),0)
...
sectionList[1763].connect(sectionList[1760](1),0)
...
sectionList[1788].connect(sectionList[1762](1),0)
sectionList[1789].connect(sectionList[1788](1),0)
sectionList[1790].connect(sectionList[1762](1),0)
...
sectionList[1805].connect(sectionList[1789](1),0)
sectionList[1806].connect(sectionList[1805](1),0)
sectionList[1807].connect(sectionList[1789](1),0)
...
sectionList[1822].connect(sectionList[1806](1),0)
sectionList[1823].connect(sectionList[1822](1),0)
sectionList[1824].connect(sectionList[1806](1),0)
...
sectionList[1838].connect(sectionList[1823](1),0)
sectionList[1839].connect(sectionList[1838](1),0)
sectionList[1840].connect(sectionList[1823](1),0)
...
sectionList[1863].connect(sectionList[1839](1),0)
sectionList[1864].connect(sectionList[1863](1),0)
sectionList[1865].connect(sectionList[1839](1),0)
...
sectionList[1914].connect(sectionList[1864](1),0)
sectionList[1915].connect(sectionList[1914](1),0)
sectionList[1916].connect(sectionList[1864](1),0)
...
sectionList[1953].connect(sectionList[1915](1),0)
...
sectionList[2005].connect(sectionList[1915](1),0)
...
sectionList[2056].connect(sectionList[1787](1),0)
sectionList[2057].connect(sectionList[2056](1),0)
sectionList[2058].connect(sectionList[1787](1),0)
...
sectionList[2067].connect(sectionList[2057](1),0)
sectionList[2068].connect(sectionList[2067](1),0)
sectionList[2069].connect(sectionList[2057](1),0)
...
sectionList[2081].connect(sectionList[2068](1),0)
...
sectionList[2100].connect(sectionList[2068](1),0)
...
sectionList[2115].connect(sectionList[2080](1),0)
sectionList[2116].connect(sectionList[2115](1),0)
sectionList[2117].connect(sectionList[2080](1),0)
...
sectionList[2130].connect(sectionList[2116](1),0)
...
sectionList[2134].connect(sectionList[2116](1),0)
...
sectionList[2139].connect(sectionList[2136](1),0)
...
sectionList[2182].connect(sectionList[2138](1),0)
sectionList[2183].connect(sectionList[2182](1),0)
sectionList[2184].connect(sectionList[2138](1),0)
...
sectionList[2223].connect(sectionList[2183](1),0)
...
sectionList[2252].connect(sectionList[2183](1),0)

...
sectionList = [h.Section() for i in range(2195)]
...
sectionList[1258].connect(sectionList[724](1),0)
...
sectionList[1378].connect(sectionList[1375](1),0)
...
sectionList[1415].connect(sectionList[1377](1),0)
...
sectionList[1432].connect(sectionList[1377](1),0)
...
sectionList[1447].connect(sectionList[1444](1),0)
...
sectionList[1464].connect(sectionList[1446](1),0)
...
sectionList[1561].connect(sectionList[1446](1),0)
...
sectionList[1628].connect(sectionList[1560](1),0)
...
sectionList[1689].connect(sectionList[1560](1),0)
...
sectionList[1761].connect(sectionList[1729](1),0)
...
sectionList[1834].connect(sectionList[1788](1),0)
...
sectionList[1951].connect(sectionList[1833](1),0)
...
sectionList[2162].connect(sectionList[1833](1),0)

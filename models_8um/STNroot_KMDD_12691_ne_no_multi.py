...
sectionList[1234].connect(sectionList[670](1),0)
...
sectionList[1466].connect(sectionList[1463](1),0)
...
sectionList[1487].connect(sectionList[1465](1),0)
...
sectionList[1531].connect(sectionList[1465](1),0)
...
sectionList[1556].connect(sectionList[1486](1),0)
...
sectionList[1790].connect(sectionList[1486](1),0)
...
sectionList[1993].connect(sectionList[1555](1),0)
sectionList[1994].connect(sectionList[1993](1),0)
sectionList[1995].connect(sectionList[1555](1),0)
...
sectionList[2099].connect(sectionList[1994](1),0)
...
sectionList[2136].connect(sectionList[1994](1),0)

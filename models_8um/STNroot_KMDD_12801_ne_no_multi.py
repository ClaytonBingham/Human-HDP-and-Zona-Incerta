...
sectionList = [h.Section() for i in range(2234)]
...
sectionList[1105].connect(sectionList[582](1),0)
sectionList[1106].connect(sectionList[1105](1),0)
sectionList[1107].connect(sectionList[582](1),0)
...
sectionList[1232].connect(sectionList[1106](1),0)
sectionList[1233].connect(sectionList[1232](1),0)
sectionList[1234].connect(sectionList[1106](1),0)
...
sectionList[1515].connect(sectionList[1233](1),0)
...
sectionList[1782].connect(sectionList[1233](1),0)

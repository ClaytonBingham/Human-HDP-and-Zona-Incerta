...
sectionList = [h.Section() for i in range(2081)]
...
sectionList[1258].connect(sectionList[748](1),0)
...
sectionList[1387].connect(sectionList[1384](1),0)
...
sectionList[1682].connect(sectionList[1386](1),0)
...
sectionList[1715].connect(sectionList[1386](1),0)
...
sectionList[1744].connect(sectionList[1714](1),0)
sectionList[1745].connect(sectionList[1744](1),0)
sectionList[1746].connect(sectionList[1714](1),0)
...
sectionList[1771].connect(sectionList[1745](1),0)
...
sectionList[1786].connect(sectionList[1745](1),0)
...
sectionList[1813].connect(sectionList[1743](1),0)
...
sectionList[1850].connect(sectionList[1743](1),0)
...
sectionList[1895].connect(sectionList[1770](1),0)
...
sectionList[1904].connect(sectionList[1770](1),0)
...
sectionList[1911].connect(sectionList[1785](1),0)
sectionList[1912].connect(sectionList[1911](1),0)
sectionList[1913].connect(sectionList[1785](1),0)
...
sectionList[1978].connect(sectionList[1912](1),0)
sectionList[1979].connect(sectionList[1978](1),0)
sectionList[1980].connect(sectionList[1912](1),0)
...
sectionList[1988].connect(sectionList[1979](1),0)
...
sectionList[2017].connect(sectionList[1979](1),0)
...
sectionList[2056].connect(sectionList[1903](1),0)
...
sectionList[2067].connect(sectionList[1903](1),0)

...
sectionList = [h.Section() for i in range(2021)]
...
sectionList[1216].connect(sectionList[676](1),0)
...
sectionList[1708].connect(sectionList[1422](1),0)
...
sectionList[1731].connect(sectionList[1728](1),0)
...
sectionList[1776].connect(sectionList[1730](1),0)
...
sectionList[1791].connect(sectionList[1730](1),0)
...
sectionList[1804].connect(sectionList[1775](1),0)
sectionList[1805].connect(sectionList[1804](1),0)
sectionList[1806].connect(sectionList[1775](1),0)
...
sectionList[1841].connect(sectionList[1805](1),0)
...
sectionList[1950].connect(sectionList[1805](1),0)

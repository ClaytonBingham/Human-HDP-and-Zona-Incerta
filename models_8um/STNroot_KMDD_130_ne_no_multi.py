...
sectionList = [h.Section() for i in range(3082)]
...
sectionList[691].connect(sectionList[688](1),0)
...
sectionList[1218].connect(sectionList[690](1),0)
sectionList[1219].connect(sectionList[1218](1),0)
sectionList[1220].connect(sectionList[690](1),0)
...
sectionList[1539].connect(sectionList[1219](1),0)
...
sectionList[1858].connect(sectionList[1219](1),0)
...
sectionList[2388].connect(sectionList[2190](1),0)
...
sectionList[2584].connect(sectionList[2410](1),0)
...
sectionList[2627].connect(sectionList[2590](1),0)
...
sectionList[2735].connect(sectionList[2685](1),0)
...
sectionList[2764].connect(sectionList[2734](1),0)
...
sectionList[2797].connect(sectionList[2734](1),0)
...
sectionList[2865].connect(sectionList[2827](1),0)
...
sectionList[2953].connect(sectionList[2917](1),0)

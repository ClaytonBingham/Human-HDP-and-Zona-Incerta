...
sectionList = [h.Section() for i in range(2118)]
...
sectionList[1126].connect(sectionList[580](1),0)
...
sectionList[1336].connect(sectionList[1232](1),0)
...
sectionList[1375].connect(sectionList[1372](1),0)
...
sectionList[1390].connect(sectionList[1374](1),0)
sectionList[1391].connect(sectionList[1390](1),0)
sectionList[1392].connect(sectionList[1374](1),0)
...
sectionList[1414].connect(sectionList[1391](1),0)
sectionList[1415].connect(sectionList[1414](1),0)
sectionList[1416].connect(sectionList[1391](1),0)
...
sectionList[1433].connect(sectionList[1415](1),0)
sectionList[1434].connect(sectionList[1433](1),0)
sectionList[1435].connect(sectionList[1415](1),0)
...
sectionList[1450].connect(sectionList[1434](1),0)
...
sectionList[1467].connect(sectionList[1434](1),0)
...
sectionList[1740].connect(sectionList[1466](1),0)
...
sectionList[2043].connect(sectionList[1466](1),0)
...
sectionList[2101].connect(sectionList[2057](1),0)

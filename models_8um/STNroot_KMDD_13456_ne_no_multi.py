...
sectionList = [h.Section() for i in range(2181)]
...
sectionList[1162].connect(sectionList[622](1),0)
...
sectionList[1201].connect(sectionList[1198](1),0)
...
sectionList[1387].connect(sectionList[1200](1),0)
sectionList[1388].connect(sectionList[1387](1),0)
sectionList[1389].connect(sectionList[1200](1),0)
...
sectionList[1406].connect(sectionList[1388](1),0)
sectionList[1407].connect(sectionList[1406](1),0)
sectionList[1408].connect(sectionList[1388](1),0)
...
sectionList[1413].connect(sectionList[1407](1),0)
sectionList[1414].connect(sectionList[1413](1),0)
sectionList[1415].connect(sectionList[1407](1),0)
...
sectionList[1457].connect(sectionList[1414](1),0)
...
sectionList[1480].connect(sectionList[1429](1),0)
sectionList[1481].connect(sectionList[1480](1),0)
sectionList[1482].connect(sectionList[1429](1),0)
...
sectionList[1559].connect(sectionList[1481](1),0)
sectionList[1560].connect(sectionList[1559](1),0)
sectionList[1561].connect(sectionList[1481](1),0)
...
sectionList[1576].connect(sectionList[1560](1),0)
sectionList[1577].connect(sectionList[1576](1),0)
sectionList[1578].connect(sectionList[1560](1),0)
...
sectionList[1606].connect(sectionList[1577](1),0)
sectionList[1607].connect(sectionList[1606](1),0)
sectionList[1608].connect(sectionList[1577](1),0)
...
sectionList[1631].connect(sectionList[1607](1),0)
...
sectionList[2016].connect(sectionList[1607](1),0)

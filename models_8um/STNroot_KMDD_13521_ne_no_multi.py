...
sectionList = [h.Section() for i in range(2388)]
...
sectionList[901].connect(sectionList[898](1),0)
...
sectionList[1416].connect(sectionList[900](1),0)
...
sectionList[1589].connect(sectionList[900](1),0)
...
sectionList[1616].connect(sectionList[1613](1),0)
...
sectionList[1711].connect(sectionList[1615](1),0)
...
sectionList[1728].connect(sectionList[1615](1),0)
...
sectionList[2015].connect(sectionList[1727](1),0)
sectionList[2016].connect(sectionList[2015](1),0)
sectionList[2017].connect(sectionList[1727](1),0)
...
sectionList[2041].connect(sectionList[2016](1),0)
...
sectionList[2086].connect(sectionList[2016](1),0)
...
sectionList[2115].connect(sectionList[2100](1),0)
...
sectionList[2132].connect(sectionList[2114](1),0)
sectionList[2133].connect(sectionList[2132](1),0)
sectionList[2134].connect(sectionList[2114](1),0)
...
sectionList[2173].connect(sectionList[2133](1),0)
sectionList[2174].connect(sectionList[2173](1),0)
sectionList[2175].connect(sectionList[2133](1),0)
...
sectionList[2190].connect(sectionList[2174](1),0)
...
sectionList[2206].connect(sectionList[2174](1),0)
...
sectionList[2278].connect(sectionList[2210](1),0)
...
sectionList[2341].connect(sectionList[2284](1),0)

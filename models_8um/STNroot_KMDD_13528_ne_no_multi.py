...
sectionList = [h.Section() for i in range(2692)]
...
sectionList[1399].connect(sectionList[876](1),0)
...
sectionList[1583].connect(sectionList[876](1),0)
...
sectionList[1785].connect(sectionList[1782](1),0)
...
sectionList[1832].connect(sectionList[1784](1),0)
...
sectionList[1858].connect(sectionList[1784](1),0)
...
sectionList[1881].connect(sectionList[1857](1),0)
...
sectionList[1920].connect(sectionList[1857](1),0)
...
sectionList[1925].connect(sectionList[1880](1),0)
...
sectionList[2002].connect(sectionList[1880](1),0)
...
sectionList[2109].connect(sectionList[1919](1),0)
...
sectionList[2146].connect(sectionList[1919](1),0)
...
sectionList[2233].connect(sectionList[1924](1),0)
...
sectionList[2280].connect(sectionList[1924](1),0)
...
sectionList[2311].connect(sectionList[2279](1),0)
...
sectionList[2318].connect(sectionList[2279](1),0)
...
sectionList[2333].connect(sectionList[2317](1),0)
...
sectionList[2346].connect(sectionList[2317](1),0)
...
sectionList[2363].connect(sectionList[2332](1),0)
...
sectionList[2412].connect(sectionList[2332](1),0)
...
sectionList[2480].connect(sectionList[2362](1),0)
sectionList[2481].connect(sectionList[2480](1),0)
sectionList[2482].connect(sectionList[2362](1),0)
...
sectionList[2525].connect(sectionList[2481](1),0)
sectionList[2526].connect(sectionList[2525](1),0)
sectionList[2527].connect(sectionList[2481](1),0)
...
sectionList[2540].connect(sectionList[2526](1),0)
...
sectionList[2555].connect(sectionList[2526](1),0)
...
sectionList[2571].connect(sectionList[2524](1),0)
sectionList[2572].connect(sectionList[2571](1),0)
sectionList[2573].connect(sectionList[2524](1),0)
...
sectionList[2600].connect(sectionList[2572](1),0)
sectionList[2601].connect(sectionList[2600](1),0)
sectionList[2602].connect(sectionList[2572](1),0)
...
sectionList[2615].connect(sectionList[2601](1),0)
...
sectionList[2631].connect(sectionList[2601](1),0)

...
sectionList = [h.Section() for i in range(2131)]
...
sectionList[1258].connect(sectionList[712](1),0)
...
sectionList[1457].connect(sectionList[1392](1),0)
...
sectionList[1480].connect(sectionList[1477](1),0)
...
sectionList[1701].connect(sectionList[1479](1),0)
sectionList[1702].connect(sectionList[1701](1),0)
sectionList[1703].connect(sectionList[1479](1),0)
...
sectionList[1722].connect(sectionList[1702](1),0)
sectionList[1723].connect(sectionList[1722](1),0)
sectionList[1724].connect(sectionList[1702](1),0)
...
sectionList[1749].connect(sectionList[1723](1),0)
...
sectionList[1779].connect(sectionList[1723](1),0)
...
sectionList[1832].connect(sectionList[1829](1),0)
...
sectionList[1839].connect(sectionList[1831](1),0)
sectionList[1840].connect(sectionList[1839](1),0)
sectionList[1841].connect(sectionList[1831](1),0)
...
sectionList[1846].connect(sectionList[1840](1),0)
sectionList[1847].connect(sectionList[1846](1),0)
sectionList[1848].connect(sectionList[1840](1),0)
...
sectionList[1858].connect(sectionList[1847](1),0)
sectionList[1859].connect(sectionList[1858](1),0)
sectionList[1860].connect(sectionList[1847](1),0)
...
sectionList[1869].connect(sectionList[1859](1),0)
...
sectionList[1880].connect(sectionList[1859](1),0)
...
sectionList[1909].connect(sectionList[1879](1),0)
...
sectionList[1966].connect(sectionList[1879](1),0)

...
sectionList = [h.Section() for i in range(2050)]
...
sectionList[1300].connect(sectionList[760](1),0)
...
sectionList[1432].connect(sectionList[1429](1),0)
...
sectionList[1516].connect(sectionList[1431](1),0)
...
sectionList[1523].connect(sectionList[1431](1),0)
...
sectionList[1532].connect(sectionList[1529](1),0)
...
sectionList[1553].connect(sectionList[1531](1),0)
sectionList[1554].connect(sectionList[1553](1),0)
sectionList[1555].connect(sectionList[1531](1),0)
...
sectionList[1564].connect(sectionList[1554](1),0)
...
sectionList[1587].connect(sectionList[1554](1),0)
...
sectionList[1630].connect(sectionList[1627](1),0)
...
sectionList[1661].connect(sectionList[1629](1),0)
...
sectionList[1696].connect(sectionList[1629](1),0)
...
sectionList[1769].connect(sectionList[1766](1),0)
...
sectionList[1872].connect(sectionList[1768](1),0)
sectionList[1873].connect(sectionList[1872](1),0)
sectionList[1874].connect(sectionList[1768](1),0)
...
sectionList[1895].connect(sectionList[1873](1),0)
sectionList[1896].connect(sectionList[1895](1),0)
sectionList[1897].connect(sectionList[1873](1),0)
...
sectionList[1932].connect(sectionList[1896](1),0)
sectionList[1933].connect(sectionList[1932](1),0)
sectionList[1934].connect(sectionList[1896](1),0)
...
sectionList[1973].connect(sectionList[1933](1),0)
...
sectionList[2010].connect(sectionList[1933](1),0)

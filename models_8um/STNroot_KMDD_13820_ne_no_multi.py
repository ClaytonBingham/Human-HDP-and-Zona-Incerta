...
sectionList = [h.Section() for i in range(2371)]
...
sectionList[1505].connect(sectionList[1375](1),0)
...
sectionList[1537].connect(sectionList[1534](1),0)
...
sectionList[1857].connect(sectionList[1536](1),0)
...
sectionList[1878].connect(sectionList[1536](1),0)
...
sectionList[1893].connect(sectionList[1890](1),0)
...
sectionList[1900].connect(sectionList[1892](1),0)
sectionList[1901].connect(sectionList[1900](1),0)
sectionList[1902].connect(sectionList[1892](1),0)
...
sectionList[1918].connect(sectionList[1901](1),0)
...
sectionList[1935].connect(sectionList[1901](1),0)
...
sectionList[1965].connect(sectionList[1945](1),0)
...
sectionList[1974].connect(sectionList[1971](1),0)
...
sectionList[2007].connect(sectionList[1973](1),0)
sectionList[2008].connect(sectionList[2007](1),0)
sectionList[2009].connect(sectionList[1973](1),0)
...
sectionList[2018].connect(sectionList[2008](1),0)
sectionList[2019].connect(sectionList[2018](1),0)
sectionList[2020].connect(sectionList[2008](1),0)
...
sectionList[2027].connect(sectionList[2019](1),0)
sectionList[2028].connect(sectionList[2027](1),0)
sectionList[2029].connect(sectionList[2019](1),0)
...
sectionList[2048].connect(sectionList[2028](1),0)
sectionList[2049].connect(sectionList[2048](1),0)
sectionList[2050].connect(sectionList[2028](1),0)
...
sectionList[2079].connect(sectionList[2049](1),0)
...
sectionList[2178].connect(sectionList[2049](1),0)

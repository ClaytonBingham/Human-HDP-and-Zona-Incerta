...
sectionList[595].connect(sectionList[592](1),0)
...
sectionList[1134].connect(sectionList[594](1),0)
...
sectionList[1187].connect(sectionList[594](1),0)
...
sectionList[1264].connect(sectionList[1186](1),0)
sectionList[1265].connect(sectionList[1264](1),0)
sectionList[1266].connect(sectionList[1186](1),0)
...
sectionList[1669].connect(sectionList[1265](1),0)
...
sectionList[1697].connect(sectionList[1265](1),0)
...
sectionList[1737].connect(sectionList[1734](1),0)
...
sectionList[1975].connect(sectionList[1736](1),0)
...
sectionList[2030].connect(sectionList[1736](1),0)
...
sectionList[2045].connect(sectionList[2042](1),0)
...
sectionList[2084].connect(sectionList[2044](1),0)
sectionList[2085].connect(sectionList[2084](1),0)
sectionList[2086].connect(sectionList[2044](1),0)
...
sectionList[2111].connect(sectionList[2085](1),0)
...
sectionList[2140].connect(sectionList[2085](1),0)

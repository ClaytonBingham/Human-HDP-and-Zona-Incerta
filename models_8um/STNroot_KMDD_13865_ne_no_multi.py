...
sectionList = [h.Section() for i in range(2133)]
...
sectionList[1270].connect(sectionList[718](1),0)
...
sectionList[1559].connect(sectionList[1377](1),0)
sectionList[1560].connect(sectionList[1559](1),0)
sectionList[1561].connect(sectionList[1377](1),0)
...
sectionList[2065].connect(sectionList[1560](1),0)
...
sectionList[2096].connect(sectionList[1560](1),0)

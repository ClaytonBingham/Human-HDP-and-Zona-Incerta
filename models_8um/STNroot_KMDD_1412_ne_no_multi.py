...
sectionList = [h.Section() for i in range(3072)]
...
sectionList[1144].connect(sectionList[622](1),0)
...
sectionList[1292].connect(sectionList[1232](1),0)
...
sectionList[1329].connect(sectionList[1291](1),0)
...
sectionList[1483].connect(sectionList[1291](1),0)
...
sectionList[1495].connect(sectionList[1328](1),0)
...
sectionList[1516].connect(sectionList[1328](1),0)
...
sectionList[1549].connect(sectionList[1494](1),0)
...
sectionList[1582].connect(sectionList[1494](1),0)
...
sectionList[1619].connect(sectionList[1515](1),0)
...
sectionList[1830].connect(sectionList[1515](1),0)
...
sectionList[1869].connect(sectionList[1618](1),0)
sectionList[1870].connect(sectionList[1869](1),0)
sectionList[1871].connect(sectionList[1618](1),0)
...
sectionList[1881].connect(sectionList[1870](1),0)
...
sectionList[1900].connect(sectionList[1870](1),0)
...
sectionList[1959].connect(sectionList[1868](1),0)
...
sectionList[2183].connect(sectionList[1868](1),0)
...
sectionList[2625].connect(sectionList[2193](1),0)
...
sectionList[2772].connect(sectionList[1880](1),0)
...
sectionList[2929].connect(sectionList[1880](1),0)

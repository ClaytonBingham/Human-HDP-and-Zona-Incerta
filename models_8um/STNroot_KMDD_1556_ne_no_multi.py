...
sectionList = [h.Section() for i in range(2321)]
...
sectionList[1252].connect(sectionList[694](1),0)
...
sectionList[1378].connect(sectionList[1348](1),0)
...
sectionList[1468].connect(sectionList[1412](1),0)
...
sectionList[1559].connect(sectionList[1556](1),0)
...
sectionList[1606].connect(sectionList[1558](1),0)
...
sectionList[1628].connect(sectionList[1558](1),0)
...
sectionList[1665].connect(sectionList[1605](1),0)
...
sectionList[1717].connect(sectionList[1664](1),0)
sectionList[1718].connect(sectionList[1717](1),0)
sectionList[1719].connect(sectionList[1664](1),0)
...
sectionList[1738].connect(sectionList[1718](1),0)
sectionList[1739].connect(sectionList[1738](1),0)
sectionList[1740].connect(sectionList[1718](1),0)
...
sectionList[1787].connect(sectionList[1739](1),0)
...
sectionList[1834].connect(sectionList[1739](1),0)
...
sectionList[1899].connect(sectionList[1716](1),0)
...
sectionList[2060].connect(sectionList[1716](1),0)
...
sectionList[2308].connect(sectionList[2082](1),0)

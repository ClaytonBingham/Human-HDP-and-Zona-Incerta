...
sectionList = [h.Section() for i in range(2895)]
...
sectionList[715].connect(sectionList[712](1),0)
...
sectionList[1242].connect(sectionList[714](1),0)
sectionList[1243].connect(sectionList[1242](1),0)
sectionList[1244].connect(sectionList[714](1),0)
...
sectionList[1431].connect(sectionList[1243](1),0)
sectionList[1432].connect(sectionList[1431](1),0)
sectionList[1433].connect(sectionList[1243](1),0)
...
sectionList[1622].connect(sectionList[1432](1),0)
...
sectionList[1819].connect(sectionList[1432](1),0)
...
sectionList[2026].connect(sectionList[1621](1),0)
sectionList[2027].connect(sectionList[2026](1),0)
sectionList[2028].connect(sectionList[1621](1),0)
...
sectionList[2073].connect(sectionList[2027](1),0)
...
sectionList[2100].connect(sectionList[2027](1),0)
...
sectionList[2355].connect(sectionList[2025](1),0)
sectionList[2356].connect(sectionList[2355](1),0)
sectionList[2357].connect(sectionList[2025](1),0)
...
sectionList[2678].connect(sectionList[2356](1),0)
...
sectionList[2707].connect(sectionList[2356](1),0)

...
sectionList = [h.Section() for i in range(3844)]
...
sectionList[1198].connect(sectionList[640](1),0)
...
sectionList[1349].connect(sectionList[1319](1),0)
...
sectionList[1364].connect(sectionList[1348](1),0)
...
sectionList[1915].connect(sectionList[1348](1),0)
...
sectionList[2471].connect(sectionList[1943](1),0)
...
sectionList[3045].connect(sectionList[2495](1),0)
...
sectionList[3108].connect(sectionList[3105](1),0)
...
sectionList[3569].connect(sectionList[3107](1),0)
sectionList[3570].connect(sectionList[3569](1),0)
sectionList[3571].connect(sectionList[3107](1),0)
...
sectionList[3594].connect(sectionList[3570](1),0)
...
sectionList[3633].connect(sectionList[3570](1),0)

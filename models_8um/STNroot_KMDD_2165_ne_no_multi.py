...
sectionList = [h.Section() for i in range(1962)]
...
sectionList[1107].connect(sectionList[580](1),0)
...
sectionList[1294].connect(sectionList[1291](1),0)
...
sectionList[1435].connect(sectionList[1293](1),0)
...
sectionList[1623].connect(sectionList[1293](1),0)

...
sectionList[1104].connect(sectionList[570](1),0)
...
sectionList[1346].connect(sectionList[570](1),0)
...
sectionList[1993].connect(sectionList[1490](1),0)
...
sectionList[2093].connect(sectionList[2029](1),0)

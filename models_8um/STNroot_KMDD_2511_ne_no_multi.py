...
sectionList = [h.Section() for i in range(1758)]
...
sectionList[1120].connect(sectionList[586](1),0)
...
sectionList[1315].connect(sectionList[1171](1),0)
...
sectionList[1701].connect(sectionList[1337](1),0)

...
sectionList = [h.Section() for i in range(2167)]
...
sectionList[1910].connect(sectionList[1390](1),0)
...
sectionList[1935].connect(sectionList[1932](1),0)
...
sectionList[1972].connect(sectionList[1934](1),0)
sectionList[1973].connect(sectionList[1972](1),0)
sectionList[1974].connect(sectionList[1934](1),0)
...
sectionList[2023].connect(sectionList[1973](1),0)
...
sectionList[2064].connect(sectionList[1973](1),0)

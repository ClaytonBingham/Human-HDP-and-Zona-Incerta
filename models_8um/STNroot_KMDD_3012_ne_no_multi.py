...
sectionList = [h.Section() for i in range(2143)]
...
sectionList[757].connect(sectionList[754](1),0)
...
sectionList[1290].connect(sectionList[756](1),0)
...
sectionList[1397].connect(sectionList[756](1),0)
...
sectionList[1533].connect(sectionList[1530](1),0)
...
sectionList[1676].connect(sectionList[1532](1),0)
sectionList[1677].connect(sectionList[1676](1),0)
sectionList[1678].connect(sectionList[1532](1),0)
...
sectionList[1701].connect(sectionList[1677](1),0)
sectionList[1702].connect(sectionList[1701](1),0)
sectionList[1703].connect(sectionList[1677](1),0)
...
sectionList[1733].connect(sectionList[1702](1),0)
...
sectionList[1938].connect(sectionList[1702](1),0)
...
sectionList[1989].connect(sectionList[1986](1),0)
...
sectionList[2013].connect(sectionList[1988](1),0)
sectionList[2014].connect(sectionList[2013](1),0)
sectionList[2015].connect(sectionList[1988](1),0)
...
sectionList[2025].connect(sectionList[2014](1),0)
sectionList[2026].connect(sectionList[2025](1),0)
sectionList[2027].connect(sectionList[2014](1),0)
...
sectionList[2078].connect(sectionList[2026](1),0)
...
sectionList[2106].connect(sectionList[2026](1),0)

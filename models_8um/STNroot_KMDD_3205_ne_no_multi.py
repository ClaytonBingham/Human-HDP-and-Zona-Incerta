...
sectionList = [h.Section() for i in range(2652)]
...
sectionList[1212].connect(sectionList[672](1),0)
...
sectionList[1722].connect(sectionList[1604](1),0)
...
sectionList[1773].connect(sectionList[1604](1),0)
...
sectionList[1806].connect(sectionList[1772](1),0)
...
sectionList[1916].connect(sectionList[1772](1),0)
...
sectionList[1979].connect(sectionList[1805](1),0)
...
sectionList[2002].connect(sectionList[1805](1),0)
...
sectionList[2023].connect(sectionList[1978](1),0)
...
sectionList[2038].connect(sectionList[1978](1),0)
...
sectionList[2113].connect(sectionList[2001](1),0)
...
sectionList[2174].connect(sectionList[2001](1),0)
...
sectionList[2247].connect(sectionList[2022](1),0)
...
sectionList[2393].connect(sectionList[2022](1),0)

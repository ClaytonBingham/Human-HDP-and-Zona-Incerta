...
sectionList = [h.Section() for i in range(2273)]
...
sectionList[1251].connect(sectionList[730](1),0)
...
sectionList[1398].connect(sectionList[1365](1),0)
...
sectionList[1414].connect(sectionList[1397](1),0)
sectionList[1415].connect(sectionList[1414](1),0)
sectionList[1416].connect(sectionList[1397](1),0)
...
sectionList[1481].connect(sectionList[1415](1),0)
sectionList[1482].connect(sectionList[1481](1),0)
sectionList[1483].connect(sectionList[1415](1),0)
...
sectionList[1502].connect(sectionList[1482](1),0)
sectionList[1503].connect(sectionList[1502](1),0)
sectionList[1504].connect(sectionList[1482](1),0)
...
sectionList[1529].connect(sectionList[1503](1),0)
...
sectionList[1568].connect(sectionList[1503](1),0)
...
sectionList[1631].connect(sectionList[1480](1),0)
...
sectionList[1664].connect(sectionList[1480](1),0)
...
sectionList[1677].connect(sectionList[1567](1),0)
...
sectionList[1730].connect(sectionList[1567](1),0)
...
sectionList[1753].connect(sectionList[1729](1),0)
...
sectionList[1960].connect(sectionList[1729](1),0)
...
sectionList[1993].connect(sectionList[1752](1),0)
...
sectionList[2050].connect(sectionList[1752](1),0)
...
sectionList[2071].connect(sectionList[1992](1),0)
...
sectionList[2110].connect(sectionList[1992](1),0)
...
sectionList[2165].connect(sectionList[2049](1),0)
...
sectionList[2242].connect(sectionList[2049](1),0)

...
sectionList = [h.Section() for i in range(1960)]
...
sectionList[1319].connect(sectionList[1316](1),0)
...
sectionList[1831].connect(sectionList[1318](1),0)
sectionList[1832].connect(sectionList[1831](1),0)
sectionList[1833].connect(sectionList[1318](1),0)
...
sectionList[1858].connect(sectionList[1832](1),0)
...
sectionList[1913].connect(sectionList[1832](1),0)

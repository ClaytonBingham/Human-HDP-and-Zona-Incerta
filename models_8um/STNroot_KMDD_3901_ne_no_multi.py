...
sectionList = [h.Section() for i in range(2035)]
...
sectionList[1856].connect(sectionList[1362](1),0)
...
sectionList[1881].connect(sectionList[1362](1),0)
...
sectionList[1908].connect(sectionList[1905](1),0)
...
sectionList[1933].connect(sectionList[1907](1),0)
sectionList[1934].connect(sectionList[1933](1),0)
sectionList[1935].connect(sectionList[1907](1),0)
...
sectionList[1953].connect(sectionList[1934](1),0)
...
sectionList[1982].connect(sectionList[1934](1),0)

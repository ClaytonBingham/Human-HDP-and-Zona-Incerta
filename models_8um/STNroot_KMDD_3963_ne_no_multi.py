...
sectionList = [h.Section() for i in range(3848)]
...
sectionList[1515].connect(sectionList[976](1),0)
...
sectionList[1802].connect(sectionList[1744](1),0)
...
sectionList[1827].connect(sectionList[1824](1),0)
...
sectionList[2198].connect(sectionList[1826](1),0)
sectionList[2199].connect(sectionList[2198](1),0)
sectionList[2200].connect(sectionList[1826](1),0)
...
sectionList[2236].connect(sectionList[2199](1),0)
...
sectionList[2275].connect(sectionList[2199](1),0)
...
sectionList[2326].connect(sectionList[2274](1),0)
...
sectionList[2443].connect(sectionList[2274](1),0)
...
sectionList[2478].connect(sectionList[2475](1),0)
...
sectionList[2775].connect(sectionList[2477](1),0)
...
sectionList[2858].connect(sectionList[2477](1),0)
...
sectionList[2893].connect(sectionList[2857](1),0)
...
sectionList[3140].connect(sectionList[2857](1),0)
...
sectionList[3159].connect(sectionList[2892](1),0)
sectionList[3160].connect(sectionList[3159](1),0)
sectionList[3161].connect(sectionList[2892](1),0)
...
sectionList[3542].connect(sectionList[3160](1),0)
...
sectionList[3629].connect(sectionList[3160](1),0)
...
sectionList[3693].connect(sectionList[3679](1),0)
...
sectionList[3769].connect(sectionList[3725](1),0)
...
sectionList[3813].connect(sectionList[3773](1),0)

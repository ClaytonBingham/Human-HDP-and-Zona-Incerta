...
sectionList = [h.Section() for i in range(2305)]
...
sectionList[1138].connect(sectionList[598](1),0)
...
sectionList[1394].connect(sectionList[1340](1),0)
...
sectionList[1431].connect(sectionList[1340](1),0)
...
sectionList[1628].connect(sectionList[1430](1),0)
sectionList[1629].connect(sectionList[1628](1),0)
sectionList[1630].connect(sectionList[1430](1),0)
...
sectionList[2005].connect(sectionList[1629](1),0)
...
sectionList[2172].connect(sectionList[1629](1),0)

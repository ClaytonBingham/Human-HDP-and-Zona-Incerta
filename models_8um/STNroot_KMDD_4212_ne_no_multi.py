...
sectionList = [h.Section() for i in range(2403)]
...
sectionList[859].connect(sectionList[856](1),0)
...
sectionList[1416].connect(sectionList[858](1),0)
...
sectionList[1507].connect(sectionList[858](1),0)
...
sectionList[1870].connect(sectionList[1506](1),0)
sectionList[1871].connect(sectionList[1870](1),0)
sectionList[1872].connect(sectionList[1506](1),0)
...
sectionList[2307].connect(sectionList[1871](1),0)
...
sectionList[2336].connect(sectionList[1871](1),0)

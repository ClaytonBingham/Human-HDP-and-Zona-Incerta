...
sectionList = [h.Section() for i in range(3596)]
...
sectionList[619].connect(sectionList[616](1),0)
...
sectionList[1176].connect(sectionList[618](1),0)
...
sectionList[1247].connect(sectionList[618](1),0)
...
sectionList[1320].connect(sectionList[1246](1),0)
...
sectionList[1613].connect(sectionList[1246](1),0)
...
sectionList[2148].connect(sectionList[1319](1),0)
sectionList[2149].connect(sectionList[2148](1),0)
sectionList[2150].connect(sectionList[1319](1),0)
...
sectionList[2451].connect(sectionList[2149](1),0)
sectionList[2452].connect(sectionList[2451](1),0)
sectionList[2453].connect(sectionList[2149](1),0)
...
sectionList[2512].connect(sectionList[2452](1),0)
...
sectionList[2571].connect(sectionList[2452](1),0)
...
sectionList[2645].connect(sectionList[2625](1),0)
...
sectionList[2866].connect(sectionList[2644](1),0)
...
sectionList[3541].connect(sectionList[2644](1),0)

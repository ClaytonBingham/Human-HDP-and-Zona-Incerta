...
sectionList = [h.Section() for i in range(2163)]
...
sectionList[1341].connect(sectionList[784](1),0)
...
sectionList[1576].connect(sectionList[1573](1),0)
...
sectionList[1683].connect(sectionList[1575](1),0)
sectionList[1684].connect(sectionList[1683](1),0)
sectionList[1685].connect(sectionList[1575](1),0)
...
sectionList[1702].connect(sectionList[1684](1),0)
...
sectionList[1772].connect(sectionList[1684](1),0)

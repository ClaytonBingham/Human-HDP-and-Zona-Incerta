...
sectionList = [h.Section() for i in range(3595)]
...
sectionList[1264].connect(sectionList[712](1),0)
...
sectionList[1363].connect(sectionList[1360](1),0)
...
sectionList[1543].connect(sectionList[1362](1),0)
sectionList[1544].connect(sectionList[1543](1),0)
sectionList[1545].connect(sectionList[1362](1),0)
...
sectionList[1574].connect(sectionList[1544](1),0)
sectionList[1575].connect(sectionList[1574](1),0)
sectionList[1576].connect(sectionList[1544](1),0)
...
sectionList[1618].connect(sectionList[1575](1),0)
sectionList[1619].connect(sectionList[1618](1),0)
sectionList[1620].connect(sectionList[1575](1),0)
...
sectionList[1667].connect(sectionList[1619](1),0)
sectionList[1668].connect(sectionList[1667](1),0)
sectionList[1669].connect(sectionList[1619](1),0)
...
sectionList[1698].connect(sectionList[1668](1),0)
...
sectionList[1743].connect(sectionList[1668](1),0)
...
sectionList[1786].connect(sectionList[1742](1),0)
sectionList[1787].connect(sectionList[1786](1),0)
sectionList[1788].connect(sectionList[1742](1),0)
...
sectionList[2439].connect(sectionList[1787](1),0)
...
sectionList[2458].connect(sectionList[1787](1),0)
...
sectionList[2493].connect(sectionList[1785](1),0)
sectionList[2494].connect(sectionList[2493](1),0)
sectionList[2495].connect(sectionList[1785](1),0)
...
sectionList[3180].connect(sectionList[2494](1),0)
...
sectionList[3223].connect(sectionList[2494](1),0)
...
sectionList[3286].connect(sectionList[2492](1),0)
sectionList[3287].connect(sectionList[3286](1),0)
sectionList[3288].connect(sectionList[2492](1),0)
...
sectionList[3515].connect(sectionList[3287](1),0)
...
sectionList[3554].connect(sectionList[3287](1),0)

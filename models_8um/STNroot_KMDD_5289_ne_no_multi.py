...
sectionList = [h.Section() for i in range(3366)]
...
sectionList[1252].connect(sectionList[682](1),0)
...
sectionList[1874].connect(sectionList[1615](1),0)
...
sectionList[1988].connect(sectionList[1934](1),0)
...
sectionList[2027].connect(sectionList[1987](1),0)
...
sectionList[2078].connect(sectionList[1987](1),0)
...
sectionList[2159].connect(sectionList[2026](1),0)
sectionList[2160].connect(sectionList[2159](1),0)
sectionList[2161].connect(sectionList[2026](1),0)
...
sectionList[2212].connect(sectionList[2160](1),0)
...
sectionList[2417].connect(sectionList[2160](1),0)
...
sectionList[2444].connect(sectionList[2158](1),0)
...
sectionList[2563].connect(sectionList[2158](1),0)
...
sectionList[2670].connect(sectionList[2443](1),0)
...
sectionList[2757].connect(sectionList[2443](1),0)
...
sectionList[2804].connect(sectionList[2669](1),0)
...
sectionList[2925].connect(sectionList[2669](1),0)
...
sectionList[3251].connect(sectionList[2967](1),0)

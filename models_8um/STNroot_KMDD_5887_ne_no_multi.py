...
sectionList = [h.Section() for i in range(1869)]
...
sectionList[1120].connect(sectionList[574](1),0)
...
sectionList[1302].connect(sectionList[1250](1),0)
...
sectionList[1423].connect(sectionList[1420](1),0)
...
sectionList[1534].connect(sectionList[1422](1),0)
...
sectionList[1553].connect(sectionList[1422](1),0)
...
sectionList[1600].connect(sectionList[1574](1),0)
...
sectionList[1630].connect(sectionList[1626](1),0)

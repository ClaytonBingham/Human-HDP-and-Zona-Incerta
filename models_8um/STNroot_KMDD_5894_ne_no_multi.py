...
sectionList = [h.Section() for i in range(2415)]
...
sectionList[1300].connect(sectionList[748](1),0)
...
sectionList[1583].connect(sectionList[1580](1),0)
...
sectionList[1840].connect(sectionList[1582](1),0)
...
sectionList[1869].connect(sectionList[1582](1),0)
...
sectionList[1914].connect(sectionList[1868](1),0)
sectionList[1915].connect(sectionList[1914](1),0)
sectionList[1916].connect(sectionList[1868](1),0)
...
sectionList[1937].connect(sectionList[1915](1),0)
...
sectionList[1952].connect(sectionList[1915](1),0)
...
sectionList[1985].connect(sectionList[1951](1),0)
sectionList[1986].connect(sectionList[1985](1),0)
sectionList[1987].connect(sectionList[1951](1),0)
...
sectionList[2052].connect(sectionList[1986](1),0)
sectionList[2053].connect(sectionList[2052](1),0)
sectionList[2054].connect(sectionList[1986](1),0)
...
sectionList[2080].connect(sectionList[2053](1),0)
sectionList[2081].connect(sectionList[2080](1),0)
sectionList[2082].connect(sectionList[2053](1),0)
...
sectionList[2113].connect(sectionList[2081](1),0)
sectionList[2114].connect(sectionList[2113](1),0)
sectionList[2115].connect(sectionList[2081](1),0)
...
sectionList[2140].connect(sectionList[2114](1),0)
...
sectionList[2184].connect(sectionList[2114](1),0)
...
sectionList[2285].connect(sectionList[2139](1),0)
sectionList[2286].connect(sectionList[2285](1),0)
sectionList[2287].connect(sectionList[2139](1),0)
...
sectionList[2296].connect(sectionList[2286](1),0)
sectionList[2297].connect(sectionList[2296](1),0)
sectionList[2298].connect(sectionList[2286](1),0)
...
sectionList[2311].connect(sectionList[2297](1),0)
...
sectionList[2368].connect(sectionList[2297](1),0)

...
sectionList = [h.Section() for i in range(2219)]
...
sectionList[1150].connect(sectionList[616](1),0)
...
sectionList[1329].connect(sectionList[1326](1),0)
...
sectionList[1532].connect(sectionList[1328](1),0)
...
sectionList[1573].connect(sectionList[1570](1),0)
...
sectionList[1596].connect(sectionList[1572](1),0)
...
sectionList[1629].connect(sectionList[1572](1),0)
...
sectionList[1648].connect(sectionList[1595](1),0)
...
sectionList[1723].connect(sectionList[1595](1),0)
...
sectionList[1750].connect(sectionList[1647](1),0)
...
sectionList[1800].connect(sectionList[1647](1),0)
...
sectionList[1875].connect(sectionList[1749](1),0)
...
sectionList[2002].connect(sectionList[1749](1),0)
...
sectionList[2023].connect(sectionList[1799](1),0)
...
sectionList[2102].connect(sectionList[1799](1),0)

...
sectionList = [h.Section() for i in range(2098)]
...
sectionList[1294].connect(sectionList[742](1),0)
...
sectionList[1390].connect(sectionList[1387](1),0)
...
sectionList[1453].connect(sectionList[1389](1),0)
...
sectionList[1490].connect(sectionList[1389](1),0)
...
sectionList[1519].connect(sectionList[1516](1),0)
...
sectionList[1616].connect(sectionList[1518](1),0)
sectionList[1617].connect(sectionList[1616](1),0)
sectionList[1618].connect(sectionList[1518](1),0)
...
sectionList[1645].connect(sectionList[1617](1),0)
sectionList[1646].connect(sectionList[1645](1),0)
sectionList[1647].connect(sectionList[1617](1),0)
...
sectionList[1745].connect(sectionList[1646](1),0)

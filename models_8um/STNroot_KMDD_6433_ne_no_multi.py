...
sectionList = [h.Section() for i in range(3018)]
...
sectionList[1221].connect(sectionList[676](1),0)
...
sectionList[1318].connect(sectionList[1315](1),0)
...
sectionList[1501].connect(sectionList[1317](1),0)
...
sectionList[1520].connect(sectionList[1317](1),0)
...
sectionList[1563].connect(sectionList[1500](1),0)
...
sectionList[1720].connect(sectionList[1500](1),0)
...
sectionList[1731].connect(sectionList[1562](1),0)
...
sectionList[1922].connect(sectionList[1562](1),0)
...
sectionList[1967].connect(sectionList[1730](1),0)
...
sectionList[2152].connect(sectionList[1730](1),0)
...
sectionList[2224].connect(sectionList[1966](1),0)
...
sectionList[2464].connect(sectionList[1966](1),0)
...
sectionList[2889].connect(sectionList[2503](1),0)
...
sectionList[3003].connect(sectionList[2933](1),0)

...
sectionList = [h.Section() for i in range(1871)]
...
sectionList[1198].connect(sectionList[676](1),0)
...
sectionList[1284].connect(sectionList[1238](1),0)
...
sectionList[1388].connect(sectionList[1362](1),0)
sectionList[1389].connect(sectionList[1388](1),0)
sectionList[1390].connect(sectionList[1362](1),0)
...
sectionList[1451].connect(sectionList[1389](1),0)
...
sectionList[1550].connect(sectionList[1389](1),0)
...
sectionList[1663].connect(sectionList[1549](1),0)
...
sectionList[1834].connect(sectionList[1549](1),0)

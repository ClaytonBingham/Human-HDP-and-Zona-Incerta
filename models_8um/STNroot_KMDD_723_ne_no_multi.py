...
sectionList = [h.Section() for i in range(3060)]
...
sectionList[703].connect(sectionList[700](1),0)
...
sectionList[1266].connect(sectionList[702](1),0)
sectionList[1267].connect(sectionList[1266](1),0)
sectionList[1268].connect(sectionList[702](1),0)
...
sectionList[1637].connect(sectionList[1267](1),0)
...
sectionList[2021].connect(sectionList[1267](1),0)
...
sectionList[2411].connect(sectionList[2408](1),0)
...
sectionList[2862].connect(sectionList[2410](1),0)
...
sectionList[2883].connect(sectionList[2410](1),0)

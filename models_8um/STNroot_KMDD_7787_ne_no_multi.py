...
sectionList = [h.Section() for i in range(2684)]
...
sectionList[1330].connect(sectionList[790](1),0)
...
sectionList[1586].connect(sectionList[1583](1),0)
...
sectionList[1634].connect(sectionList[1585](1),0)
sectionList[1635].connect(sectionList[1634](1),0)
sectionList[1636].connect(sectionList[1585](1),0)
...
sectionList[1667].connect(sectionList[1635](1),0)
sectionList[1668].connect(sectionList[1667](1),0)
sectionList[1669].connect(sectionList[1635](1),0)
...
sectionList[1714].connect(sectionList[1668](1),0)
sectionList[1715].connect(sectionList[1714](1),0)
sectionList[1716].connect(sectionList[1668](1),0)
...
sectionList[1743].connect(sectionList[1715](1),0)
...
sectionList[1776].connect(sectionList[1715](1),0)
...
sectionList[1880].connect(sectionList[1775](1),0)
sectionList[1881].connect(sectionList[1880](1),0)
sectionList[1882].connect(sectionList[1775](1),0)
...
sectionList[2123].connect(sectionList[1881](1),0)
sectionList[2124].connect(sectionList[2123](1),0)
sectionList[2125].connect(sectionList[1881](1),0)
...
sectionList[2342].connect(sectionList[2124](1),0)
...
sectionList[2452].connect(sectionList[2124](1),0)

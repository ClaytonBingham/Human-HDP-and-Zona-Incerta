...
sectionList = [h.Section() for i in range(2040)]
...
sectionList[1335].connect(sectionList[807](1),0)
...
sectionList[1461].connect(sectionList[1425](1),0)
sectionList[1462].connect(sectionList[1461](1),0)
sectionList[1463].connect(sectionList[1425](1),0)
...
sectionList[1500].connect(sectionList[1462](1),0)
sectionList[1501].connect(sectionList[1500](1),0)
sectionList[1502].connect(sectionList[1462](1),0)
...
sectionList[1545].connect(sectionList[1501](1),0)
sectionList[1546].connect(sectionList[1545](1),0)
sectionList[1547].connect(sectionList[1501](1),0)
...
sectionList[1596].connect(sectionList[1546](1),0)
sectionList[1597].connect(sectionList[1596](1),0)
sectionList[1598].connect(sectionList[1546](1),0)
...
sectionList[1645].connect(sectionList[1597](1),0)
...
sectionList[1730].connect(sectionList[1597](1),0)
...
sectionList[1843].connect(sectionList[1840](1),0)
...
sectionList[1870].connect(sectionList[1842](1),0)
sectionList[1871].connect(sectionList[1870](1),0)
sectionList[1872].connect(sectionList[1842](1),0)
...
sectionList[1888].connect(sectionList[1871](1),0)
sectionList[1889].connect(sectionList[1888](1),0)
sectionList[1890].connect(sectionList[1871](1),0)
...
sectionList[1925].connect(sectionList[1889](1),0)
...
sectionList[1961].connect(sectionList[1889](1),0)

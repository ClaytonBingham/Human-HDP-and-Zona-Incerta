...
sectionList = [h.Section() for i in range(2247)]
...
sectionList[1288].connect(sectionList[700](1),0)
...
sectionList[1603].connect(sectionList[1600](1),0)
...
sectionList[1622].connect(sectionList[1602](1),0)
sectionList[1623].connect(sectionList[1622](1),0)
sectionList[1624].connect(sectionList[1602](1),0)
...
sectionList[1711].connect(sectionList[1623](1),0)
...
sectionList[1739].connect(sectionList[1623](1),0)
...
sectionList[1774].connect(sectionList[1738](1),0)
...
sectionList[1959].connect(sectionList[1738](1),0)
...
sectionList[1988].connect(sectionList[1985](1),0)
...
sectionList[2013].connect(sectionList[1987](1),0)
...
sectionList[2191].connect(sectionList[1987](1),0)

...
sectionList = [h.Section() for i in range(2426)]
...
sectionList[841].connect(sectionList[838](1),0)
...
sectionList[1362].connect(sectionList[840](1),0)
...
sectionList[1479].connect(sectionList[840](1),0)
...
sectionList[1622].connect(sectionList[1586](1),0)
...
sectionList[1729].connect(sectionList[1660](1),0)
...
sectionList[1793].connect(sectionList[1757](1),0)
...
sectionList[1804].connect(sectionList[1792](1),0)
...
sectionList[1845].connect(sectionList[1792](1),0)
...
sectionList[1970].connect(sectionList[1803](1),0)
sectionList[1971].connect(sectionList[1970](1),0)
sectionList[1972].connect(sectionList[1803](1),0)
...
sectionList[2003].connect(sectionList[1971](1),0)
sectionList[2004].connect(sectionList[2003](1),0)
sectionList[2005].connect(sectionList[1971](1),0)
...
sectionList[2051].connect(sectionList[2004](1),0)
...
sectionList[2087].connect(sectionList[2004](1),0)
...
sectionList[2130].connect(sectionList[2086](1),0)
...
sectionList[2209].connect(sectionList[2086](1),0)
...
sectionList[2320].connect(sectionList[2129](1),0)
...
sectionList[2387].connect(sectionList[2129](1),0)

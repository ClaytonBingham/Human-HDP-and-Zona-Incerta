...
sectionList = [h.Section() for i in range(2145)]
...
sectionList[1372].connect(sectionList[802](1),0)
...
sectionList[1471].connect(sectionList[1468](1),0)
...
sectionList[1636].connect(sectionList[1470](1),0)
sectionList[1637].connect(sectionList[1636](1),0)
sectionList[1638].connect(sectionList[1470](1),0)
...
sectionList[1649].connect(sectionList[1637](1),0)
...
sectionList[1674].connect(sectionList[1637](1),0)
...
sectionList[1721].connect(sectionList[1673](1),0)
sectionList[1722].connect(sectionList[1721](1),0)
sectionList[1723].connect(sectionList[1673](1),0)
...
sectionList[1940].connect(sectionList[1722](1),0)
...
sectionList[1963].connect(sectionList[1722](1),0)

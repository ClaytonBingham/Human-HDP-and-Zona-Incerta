...
sectionList = [h.Section() for i in range(2138)]
...
sectionList[1306].connect(sectionList[790](1),0)
...
sectionList[1438].connect(sectionList[1396](1),0)
sectionList[1439].connect(sectionList[1438](1),0)
sectionList[1440].connect(sectionList[1396](1),0)
...
sectionList[1456].connect(sectionList[1439](1),0)
sectionList[1457].connect(sectionList[1456](1),0)
sectionList[1458].connect(sectionList[1439](1),0)
...
sectionList[1477].connect(sectionList[1457](1),0)
...
sectionList[1502].connect(sectionList[1457](1),0)
...
sectionList[1533].connect(sectionList[1437](1),0)
...
sectionList[1732].connect(sectionList[1437](1),0)
...
sectionList[1793].connect(sectionList[1532](1),0)
...
sectionList[2094].connect(sectionList[1532](1),0)

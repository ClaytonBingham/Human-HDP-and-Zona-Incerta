...
sectionList = [h.Section() for i in range(2311)]
...
sectionList[1432].connect(sectionList[897](1),0)
...
sectionList[1780].connect(sectionList[1628](1),0)
...
sectionList[1815].connect(sectionList[1812](1),0)
...
sectionList[1859].connect(sectionList[1814](1),0)
...
sectionList[1907].connect(sectionList[1814](1),0)
...
sectionList[1956].connect(sectionList[1858](1),0)
...
sectionList[2045].connect(sectionList[1858](1),0)

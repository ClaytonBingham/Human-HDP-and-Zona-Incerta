...
sectionList = [h.Section() for i in range(1942)]
...
sectionList[1096].connect(sectionList[574](1),0)
...
sectionList[1261].connect(sectionList[1258](1),0)
...
sectionList[1279].connect(sectionList[1260](1),0)
...
sectionList[1302].connect(sectionList[1260](1),0)
...
sectionList[1418].connect(sectionList[1278](1),0)
...
sectionList[1425].connect(sectionList[1278](1),0)

...
sectionList = [h.Section() for i in range(2539)]
...
sectionList[709].connect(sectionList[706](1),0)
...
sectionList[1254].connect(sectionList[708](1),0)
sectionList[1255].connect(sectionList[1254](1),0)
sectionList[1256].connect(sectionList[708](1),0)
...
sectionList[1949].connect(sectionList[1255](1),0)
...
sectionList[2286].connect(sectionList[1255](1),0)

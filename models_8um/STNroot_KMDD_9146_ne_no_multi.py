...
sectionList[1145].connect(sectionList[611](1),0)
...
sectionList[1426].connect(sectionList[1423](1),0)
...
sectionList[1453].connect(sectionList[1425](1),0)
sectionList[1454].connect(sectionList[1453](1),0)
sectionList[1455].connect(sectionList[1425](1),0)
...
sectionList[1527].connect(sectionList[1454](1),0)
...
sectionList[1544].connect(sectionList[1454](1),0)
...
sectionList[1681].connect(sectionList[1543](1),0)
...
sectionList[1697].connect(sectionList[1543](1),0)
...
sectionList[1724].connect(sectionList[1721](1),0)
...
sectionList[1758].connect(sectionList[1723](1),0)
...
sectionList[1833].connect(sectionList[1723](1),0)
...
sectionList[1890].connect(sectionList[1832](1),0)
sectionList[1891].connect(sectionList[1890](1),0)
sectionList[1892].connect(sectionList[1832](1),0)
...
sectionList[1905].connect(sectionList[1891](1),0)
...
sectionList[1928].connect(sectionList[1891](1),0)
...
sectionList[1977].connect(sectionList[1889](1),0)
...
sectionList[2002].connect(sectionList[1889](1),0)
...
sectionList[2079].connect(sectionList[1927](1),0)
...
sectionList[2122].connect(sectionList[1927](1),0)
...
sectionList[2184].connect(sectionList[2146](1),0)

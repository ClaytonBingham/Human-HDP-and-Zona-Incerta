...
sectionList = [h.Section() for i in range(2404)]
...
sectionList[661].connect(sectionList[658](1),0)
...
sectionList[1235].connect(sectionList[660](1),0)
sectionList[1236].connect(sectionList[1235](1),0)
sectionList[1237].connect(sectionList[660](1),0)
...
sectionList[1405].connect(sectionList[1236](1),0)
...
sectionList[1588].connect(sectionList[1236](1),0)
...
sectionList[1838].connect(sectionList[1778](1),0)
...
sectionList[2358].connect(sectionList[1870](1),0)

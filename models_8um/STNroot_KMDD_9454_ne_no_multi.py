...
sectionList = [h.Section() for i in range(1900)]
...
sectionList[1186].connect(sectionList[646](1),0)
...
sectionList[1273].connect(sectionList[1270](1),0)
...
sectionList[1360].connect(sectionList[1272](1),0)
sectionList[1361].connect(sectionList[1360](1),0)
sectionList[1362].connect(sectionList[1272](1),0)
...
sectionList[1399].connect(sectionList[1361](1),0)
...
sectionList[1476].connect(sectionList[1361](1),0)
...
sectionList[1675].connect(sectionList[1536](1),0)

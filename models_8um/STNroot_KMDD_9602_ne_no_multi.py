...
sectionList = [h.Section() for i in range(2032)]
...
sectionList[1096].connect(sectionList[520](1),0)
...
sectionList[1716].connect(sectionList[1366](1),0)
...
sectionList[1810].connect(sectionList[1736](1),0)
sectionList[1811].connect(sectionList[1810](1),0)
sectionList[1812].connect(sectionList[1736](1),0)
...
sectionList[1837].connect(sectionList[1811](1),0)
...
sectionList[1865].connect(sectionList[1811](1),0)
...
sectionList[1985].connect(sectionList[1897](1),0)
